...
\begin{table}[htbp]
\centering
\caption{Table 1. The Four-Model Architecture}
\label{tab:four-models}
\small
\renewcommand{\arraystretch}{1.4}
\begin{tabular}{>{\raggedright}p{3.5cm} X X}
\toprule
...
\begin{table}[htbp]
\centering
\caption{Table 2. Independent Convergence on Criticality}
\label{tab:criticality-convergence}
\small
\renewcommand{\arraystretch}{1.4}
\begin{tabular}{>{\raggedright}p{1.5cm} X >{\raggedright\arraybackslash}p{3.5cm}}
\toprule
...
\begin{table}[htbp]
\centering
\caption{Table 3. Consciousness States and Criticality}
\label{tab:consciousness-states}
\small
\renewcommand{\arraystretch}{1.4}
\begin{tabular}{>{\raggedright}p{1.9cm} >{\raggedright}p{1.7cm} >{\raggedright}p{3.2cm} X >{\raggedright\arraybackslash}p{2cm}}
\toprule
...
\begin{table}[htbp]
\centering
\caption{Table 4. Theory Comparison Across Eight Requirements}
\label{tab:comparison}
\small
\renewcommand{\arraystretch}{1.4}
\begin{tabular}{>{\raggedright}p{2cm} c c c c c c c}
\toprule
