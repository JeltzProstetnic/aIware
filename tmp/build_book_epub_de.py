...
COVER_IMAGE = "/home/jeltz/aIware/pop-sci/cover-kindle-de.jpg"
OUTPUT_DIR = "/home/jeltz/aIware/pop-sci"
OUTPUT_FILE = os.path.join(OUTPUT_DIR, "book-manuscript-de.epub")

# Image paths used in the manuscript (relative to pop-sci/) -> flat copy name
IMAGE_MAP = {
    "../figures/figure2-real-virtual-split-simple-de.png": "figure2-real-virtual-split-simple-de.png",
    "../figures/book/homunculi.de.png": "homunculi-de.png",
    "../figures/figure-five-layer-stack-bw-de.png": "figure-five-layer-stack-bw-de.png",
    "../figures/figure1-four-model-architecture-bw-de.png": "figure1-four-model-architecture-bw-de.png",
}
...
def generate_metadata_yaml(tmp_dir):
    ...
    yaml_content = """\
---
title: "Die Simulation namens Ich"
subtitle: "Die Architektur von Bewusstsein, Berechnung und Kosmos"
creator:
  - role: author
    text: Matthias Gruber
language: de
date: "2026"
rights: "© 2026 Matthias Gruber. Alle Rechte vorbehalten."
description: "Eine einheitliche Theorie des Bewusstseins, die das Schwierige Problem auflöst, die Phänomenologie psychedelischer Zustände erklärt und einen konkreten Bauplan für eine bewusste Maschine liefert."
subject:
  - Bewusstsein
  - Neurowissenschaft
...
def main():
    print("=" * 60)
    print("Building EPUB: Die Simulation namens Ich")
    print("=" * 60)
    ...
    # Copy cover image
    cover_dst = os.path.join(tmp_dir, "cover-kindle-de.jpg")
    ...
    win_path = "/mnt/c/Users/Matthias/Desktop/book-manuscript-de.epub"
    try:
