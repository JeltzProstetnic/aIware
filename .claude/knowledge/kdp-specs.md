...
- **Translation editions — KDP-assigned 979-8 ISBNs (collecting S264, MG feeds them in):**

  | Edition | Paperback ISBN | Hardcover ISBN |
  |---------|----------------|----------------|
  | JA | 9798187422272 | — **no hardcover** (KDP doesn't support JA hardcover) |
  | FR | 9798187423101 | 9798187423439 |
  | ES | 9798187424801 | 9798187425044 |
  | IT | 9798187425297 | 9798187425426 |
  | PT | 9798187423941 | 9798187424252 |
  | ZH | TBD | TBD |

  **MG decision (S264): bake the ISBN barcode INTO the translation covers** (like EN/DE), rather than leaving
  the blank white box for KDP to fill — Amazon's auto-barcode placement doesn't match the reserved white
  box and looks awkward. Once ALL translation ISBNs are collected (MG will signal "done"), **re-make every
  affected translation cover** (`tmp/build_translation_covers_print.py`) with the real barcode generated
  from the ISBN + positioned to look clean, then re-run AIW-60 visual QA. Tracked: AIW-116.
