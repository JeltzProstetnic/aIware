...
- [ ] [P1] `AIW-07` **Full FMT paper to journal**: PLREV REJECTED 2026-03-18 (not a Target Review, author credentials, philosophy scope). Next: NBSR (package ready in `tmp/nbsr-submission/`). If declined → C&C. Paper revised v4: definition framing, 9→4 predictions + convergence, AI declaration.
- [ ] [P1] `AIW-27` **"Standard Model of Consciousness" wiki at fmt.matthiasgruber.com**: 100-article knowledge base covering FMT + RIM. Structure: `docs/wiki-structure-proposal.md`. Stack: MkDocs Material + GitHub Pages. DNS handled by infrastructure project. Figures: ~60 Mermaid (inline), ~25 new custom SVGs, ~10 AI-generated (muse). Figures: (1) ALL diagrams fresh (Mermaid/SVG), (2) anatomical pictures from original source material (`sources/book-2015/`), (3) AI-generated art (muse) for hero/conceptual images. No PDF extraction, no reuse of `figures/book/` extractions. Sub-tasks: (a) MkDocs scaffolding + GitHub repo, (b) content creation (17 sections, 100 articles), (c) figure creation, (d) deploy. Multi-session effort.
