...
**From a theory of consciousness to an architecture for artificial minds.**
...
Consciousness is not a thing the brain *has*. It is a thing the brain *does*: it runs a real-time self-simulation.

The theory identifies four nested models:
...
This dissolves the hard problem. It doesn't explain it away (illusionism) or punt it to fundamental physics (panpsychism). It relocates it: experience is constitutively virtual, and within the simulation, qualia are simply what self-perception produces.
...
The field of consciousness studies is in a pre-paradigm state. After decades of work:
- IIT and GNW both failed full confirmation in the COGITATE adversarial collaboration (Nature, 2025)
- No theory passes all eight requirements for a complete solution
- 124 scholars signed an open letter calling IIT "pseudoscience"
- Cambridge declared in December 2025 that we "may never be able to tell" if AI becomes conscious
...
**[Matthias Gruber](https://matthiasgruber.com)** — Computer scientist, biomedical informatics and AI specialist, court-certified software expert. Author of [*Die Emergenz des Bewusstseins*](https://www.amazon.com/Emergenz-Bewusstseins-German-Matthias-Gruber/dp/1326652079) — the underlying theory.

**Claude** (Anthropic) — Research partner for theory validation, stress-testing, and formalization. All challenge sessions are logged verbatim.

## License

Research content. License TBD.
