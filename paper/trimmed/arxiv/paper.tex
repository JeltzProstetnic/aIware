...
Recent developments have deepened the crisis. The COGITATE adversarial collaboration---whose protocol was pre-registered by \citet{Melloni2023} and whose results were published by the \citet{COGITATE2025}---produced equivocal results: neither IIT nor GNW was fully confirmed. A letter signed by over 100 researchers declared IIT pseudoscientific \citep{IITConcerned2025,NatNeuro2025IIT}, provoking fierce rebuttals \citep{TononiAlbantakis2025} and calls for more nuanced framing \citep{GomezMarin2025}.
...
The theory's criticality requirement was derived from Wolfram's computational framework in 2015 \citep{Gruber2015}---independently of, though not prior to, the empirical criticality program initiated by \citet{Beggs2003}---and the same conclusion was subsequently consolidated through \citeauthor{HengenShew2025}'s (\citeyear{HengenShew2025}) meta-analysis of 140 datasets and \citeauthor{AlgomShriki2026}'s (\citeyear{AlgomShriki2026}) ConCrit framework. This convergence from a theoretical derivation and large-scale empirical synthesis provides notable support.
