...
Table~4 presents an assessment of how each theory addresses the eight requirements. All ratings reflect the present author's judgment. \textit{Addresses} = substantive account; \textit{Partial} = relevant but incomplete; \textit{Minimal} = touches on; \textit{Silent} = not addressed; \textit{N/A} = not applicable given ontological commitments.
...
\midrule
Hard Problem & Addresses$^*$ & Addresses$^\dagger$ & Silent$^\ddagger$ & Partial & Silent$^\ddagger$ & Partial & Silent \\
Explan.\ Gap & Addresses$^*$ & Addresses$^\dagger$ & Silent$^\ddagger$ & Partial & Silent$^\ddagger$ & Partial & Silent \\
...
Combination & Addresses & Minimal$^{\dagger\dagger}$ & N/A & N/A & N/A & N/A & N/A \\
...
$^*$\,Dissolution via virtual qualia. \enspace
$^{**}$\,Epiphenomenal. \enspace
