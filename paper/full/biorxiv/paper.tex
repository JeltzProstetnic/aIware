...
A theory is only as valuable as the predictions it generates. The Four-Model Theory yields nine novel predictions and two theoretical implications. Predictions 1--6 and 8--9 are testable with current or near-term methods. The two theoretical implications (Sections~8.7 and 8.10) follow from the theory's commitments but are not currently testable---\hspace{0pt}they are separated to maintain clarity about the theory's empirical reach.
