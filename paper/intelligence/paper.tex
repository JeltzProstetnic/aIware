...
This paper proposes that intelligence---understood as \emph{learning ability} (Lernf\"ahigkeit)---is constituted by three interacting components:
...
This is precisely the failure mode predicted by a model in which intelligence is a recursive system requiring all three components. Remove Motivation, and you have a system with vast Knowledge and Performance that nevertheless fails to exhibit the self-reinforcing developmental trajectory characteristic of intelligence.
...
None of this is entirely new. Progressive educators have advocated for many of these practices on intuitive and empirical grounds. What the recursive model adds is a \emph{structural explanation} for why these practices work: they target the components of the recursive loop that are both most learnable and most consequential for long-term intellectual development. The model transforms what might otherwise appear to be soft pedagogical preferences into hard predictions about the dynamics of a formal system.

\section{Discussion}

\subsection{Relation to Established Intelligence Models}

This proposal does not require abandoning existing intelligence models. The CHC taxonomy remains a useful descriptive framework for the cognitive components of intelligence. Cattell's investment theory remains a useful account of the Gf-to-Gc developmental trajectory. What is proposed here is that these models are \emph{incomplete}---they describe the Performance and Knowledge components of intelligence with considerable precision while systematically excluding the Motivation component that drives the developmental dynamics.
