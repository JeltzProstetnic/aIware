...
\midrule
\textbf{V1} & ~1° & Edge detection, spatial frequency, orientation columns \\
[6pt]
\textbf{V2} & ~2-4° & Contour integration, texture segmentation, border ownership, illusory contours \\
[6pt]
\textbf{V3} & ~4-8° & Global form processing, dynamic shape, motion boundaries \\
[6pt]
\textbf{V4} & ~8-16° & Color, curvature, complex texture, fractal-scale processing \\
[6pt]
\textbf{V5/\allowbreak{}MT} & Large, motion-tuned & Motion perception, optic flow, speed and direction coding \\
[6pt]
\textbf{Fusiform gyrus (IT)} & Very large, object-centered & Face recognition (FFA), word forms, fine-grained object discrimination \\
[6pt]
\textbf{Anterior IT} & Whole visual field & Semantic categories, scene construction, object-invariant recognition \\
[6pt]
\bottomrule
\end{tabularx}
}
...
\midrule
\textbf{V1} & Phosphenes, Klüver form constants, breathing/\allowbreak{}shimmering surfaces \\
[6pt]
\textbf{V2} & Tessellations, repeating geometric patterns, enhanced texture perception \\
[6pt]
\textbf{V3} & Flowing, morphing geometric structures \\
[6pt]
\textbf{V4} & Colored fractals, kaleidoscopic patterns, saturated/\allowbreak{}impossible colors \\
[6pt]
\textbf{V5/\allowbreak{}MT} & Rotation, drifting, and rhythmic movement of all visual patterns \\
[6pt]
\textbf{Fusiform gyrus (IT)} & Faces, figures, entities --- often distorted or morphing \\
[6pt]
\textbf{Anterior IT} & Full narrative hallucinations, complex scenes, dreamlike sequences \\
[6pt]
\bottomrule
\end{tabularx}
}
