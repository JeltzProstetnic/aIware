...
\section*{Prediction 2: Psychedelic Visuals Reveal the Brain's Processing Layers}
...
In the SB-HC4A framework, the Big Rip has a natural interpretation. The singularity boundary, which normally sits at the cosmological horizon, comfortably far away, propagates \textit{inward}. It doesn't wait for you at the edge of the observable universe. It comes to you. It fragments the computational domain into smaller and smaller regions, each one saturating its own Bekenstein bound, each one becoming its own information-impermeable boundary. Instead of one grand singularity at the end of time, you get a fractal explosion of singularities, propagating inward at every scale simultaneously.
...
\begin{tabularx}{\linewidth}{X X X X}
\toprule
\textbf{Area} & \textbf{Brodmann area} & \textbf{Receptive field} & \textbf{Normal function} \\
\midrule
\textbf{V1} (primary visual cortex) & BA 17 & ~1° & Edge detection, spatial frequency, orientation columns \\
[6pt]
\textbf{V2} & BA 18 & ~2-4° & Contour integration, texture segmentation, border ownership, illusory contours \\
[6pt]
\textbf{V3} & BA 19 (part) & ~4-8° & Global form processing, dynamic shape, motion boundaries \\
[6pt]
\textbf{V4} & BA 19 (part) & ~8-16° & Color, curvature, complex texture, fractal-scale processing \\
[6pt]
\textbf{V5/MT} & BA 19/37 & Large, motion-tuned & Motion perception, optic flow, speed and direction coding \\
[6pt]
\textbf{Fusiform gyrus (IT)} & BA 37 & Very large, object-centered & Face recognition (Fusiform Face Area), word forms, fine-grained object discrimination \\
[6pt]
\textbf{Anterior IT} & BA 20/21 & Whole visual field & Semantic categories, scene construction, object-invariant recognition \\
[6pt]
\bottomrule
\end{tabularx}
}
...
\midrule
\textbf{V1} (primary visual cortex) & Phosphenes, Klüver form constants (tunnels, spirals, lattices), breathing/shimmering surfaces \\
[6pt]
...
\midrule
1 --- Static & Class 1 & Same \\[4pt]
2 --- Periodic & Class 2 & Same \\[4pt]
3 --- Fractal & Class 3 (part) & Split out from Wolfram's Class 3 \\[4pt]
4 --- Complex & Class 4 & Same \\[4pt]
5 --- Random & Class 3 (part) & Split out from Wolfram's Class 3 \\[4pt]
\bottomrule
\end{tabularx}
}
...
\midrule
1 --- Static & Finite & 1 & None & Trivially & No \\[4pt]
2 --- Periodic & Finite & Finite & Repeating & Yes & No \\[4pt]
3 --- Fractal & Finite & Quasi-infinite, self-similar & Self-similar & Yes & No \\[4pt]
4 --- Complex & Finite & Quasi-infinite, self-similar & Self-similar + persistent interacting structures & No & \textbf{Yes} \\[4pt]
5 --- Random & Inexpressible & Truly infinite & \textbf{Unknown} & N/A & N/A \\[4pt]
\bottomrule
\end{tabularx}
}
