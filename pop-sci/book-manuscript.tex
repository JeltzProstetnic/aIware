...
\begin{figure}[htbp]
  \centering
  \includegraphics[width=0.85\textwidth]{../figures/figure1-four-model-architecture-bw.png}
...
\begin{figure}[htbp]
  \centering
  \includegraphics[width=0.85\textwidth]{../figures/figure-penfield-homunculus-bw.png}
...
\begin{figure}[htbp]
  \centering
  \includegraphics[width=0.85\textwidth]{../figures/figure-five-layer-stack-bw.png}
...
\begin{figure}[htbp]
  \centering
  \includegraphics[width=0.85\textwidth]{../figures/figure2-real-virtual-split-bw.png}
  \caption{The real/virtual split. The substrate (real side) stores knowledge in synaptic weights --- physical, structural, unconscious. The simulation (virtual side) generates experience in real time --- transient, dynamic, conscious. Everything you have ever experienced lives on the right side of this line.}
\end{figure}
...
\begin{figure}[htbp]
  \centering
  \includegraphics[width=0.85\textwidth]{../figures/figure3-phenomenological-content-bw.png}
  \caption{Phenomenological Content Through a Morning. ESM updates produce peaks in phenomenological content. Routine activities lead to low content (autopilot). Salient events (threats, social signals) produce high content. Consciousness tracks what matters, not everything.}
...
Ketamine & Past critical ($\uparrow$ entropy) & EWM/ESM on wrong input & Present, disconnected \\
Psychedelics & At/past critical & All active, $\uparrow$ permeability & Present, altered \\
...
4 --- Complex & Finite & Quasi-infinite, self-similar & Self-similar + persistent interacting structures & No & \textbf{Yes} \\
5 --- Random & Inexpressible & Truly infinite & \textbf{Unknown} & N/A & N/A \\
\bottomrule
\end{tabularx}
}
