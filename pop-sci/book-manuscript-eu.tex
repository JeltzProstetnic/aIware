...
% Trim size: 15.5 x 23 cm (European trade paperback)
\usepackage[
...
\vspace{0.5cm}
\noindent Second European edition, 2026\par
\vspace{0.5cm}
...
\begin{figure}[htbp]
  ...
  \caption{The real/virtual split. The substrate (real side) stores knowledge in synaptic weights --- physical, structural, unconscious. The simulation (virtual side) generates experience in real time --- transient, dynamic, conscious.}
\end{figure}
...
V5/MT & Motion processing & Rotation and movement of patterns \\[4pt]
Fusiform/IT & Faces, objects, word forms & Faces, figures, entities \\[4pt]
...
REM sleep & Near-critical & EWM/ESM on internal input & Degraded (dream) \\[4pt]
Deep NREM & Subcritical & EWM/ESM collapsed & Absent \\[4pt]
Propofol & Forced subcritical & EWM/ESM suppressed & Absent \\[4pt]
Ketamine & Past critical ($\uparrow$ entropy) & EWM/ESM on wrong input & Present, disconnected \\[4pt]
Psychedelics & At/past critical & All active, $\uparrow$ permeability & Present, altered \\[4pt]
...
\textbf{Are the implicit models virtual too?} (or to what degree) The IWM and ISM are ``models,'' but models of what, exactly? I've drawn a clean line between the real substrate and the virtual simulation, but the implicit models sit right on that line. If they're also virtual in some sense, then what constitutes the truly ``real'' bottom? The theory assumes a clean real/virtual divide, but reality might be messier than my diagrams. This is a foundational question I don't have a final answer to.
...
\textit{Full references, with URLs and annotations, are available in the scientific paper and at github.com/JeltzProstetnic/aIware/blob/main/references.md. What follows are chapter-specific notes for readers who wish to go deeper.}
...
\begin{itemize}
  ...
  \item \textbf{V5/MT (middle temporal area)} --- Visual area specialized for motion processing. Large receptive fields. Responsible for the rotation and movement of patterns seen under psychedelics (Chapter 6).
...
[6pt]
\textbf{V5/MT} & Large, motion-tuned & Motion perception, optic flow, speed and direction coding \\
[6pt]
...
\midrule
\textbf{V1} & Phosphenes, Klüver form constants, breathing/shimmering surfaces \\
[6pt]
...
[6pt]
\textbf{V4} & Colored fractals, kaleidoscopic patterns, saturated/impossible colors \\
[6pt]
\textbf{V5/MT} & Rotation, drifting, and rhythmic movement of all visual patterns \\
[6pt]
...
\textbf{Notes:}
\begin{itemize}
  \item The fusiform gyrus straddles the V4/IT border and is part of the inferotemporal cortex (IT). It contains the Fusiform Face Area (FFA), identified by Kanwisher et al. (1997), which is selectively activated by faces.
  ...
  \item The brain also uses these areas for fractal/scale-invariant processing (V2-V4), which serves scale measurement and texture analysis in normal vision. Under psychedelics, this machinery running without external input produces the characteristic fractal patterns (see Appendix C).
\end{itemize}
...
3 & Random/chaotic & Rule 30 & Apparent randomness. No obvious repeating structure. \\[4pt]
...
5 & Inexpressible & Truly infinite & \textbf{Unknown} & N/A & N/A \\[4pt]
\bottomrule
\end{tabularx}
}
...
\begin{itemize}
  ...
  \item \textbf{Class 3} (fractal/scale-invariant processing): Texture analysis, scale-invariant object recognition, efficient neural encoding. Primarily V2-V4 visual processing, where multi-scale comparison is the core operation. Under psychedelics, when this machinery runs without external input, you \textit{see} the fractal processing itself, which is why fractal patterns are among the most consistent features of psychedelic experience (see Chapter 6).
