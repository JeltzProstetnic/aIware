...
% Black background
\fill[black] (0,0) rectangle (12.918844in, 9.25in);

% Background image
\node[inner sep=0pt, outer sep=0pt] at (6.459422in, 4.625in) {
  \includegraphics[width=12.918844in, height=9.25in]{cover-wrap-de.jpg}
};
