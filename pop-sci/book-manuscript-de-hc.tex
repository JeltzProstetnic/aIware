...
\textit{Gerichtet an alle, die sich je gefragt haben, warum wir unser Selbst wahrnehmen können, warum sich Dinge nach etwas anfühlen, warum wir uns gedanklich alles Mögliche vorstellen können, und wie dieses Kino im Kopf zustandekommt.}
...
\begin{itemize}
  \item Vorwort
  \item Der Autor
  \item Kapitel 1: Das schwerste Problem der Wissenschaft
  \item Kapitel 2: Die vier Modelle
  \item Kapitel 3: Die virtuelle Seite
  \item Kapitel 4: Warum sich etwas nach etwas anfühlt (und warum das die falsche Frage ist)
  \item Kapitel 5: Am Rand des Chaos
  \item Kapitel 6: Was Psychedelika enthüllen
  \item Kapitel 7: Was passiert, wenn die Lichter ausgehen
  \item Kapitel 8: Der klinische Spiegel
  \item Kapitel 9: Zwei Bewusstseine in einem Gehirn
  \item Kapitel 10: Die Tierfrage
  \item Kapitel 11: Neun Vorhersagen
  \item Kapitel 12: Von Maschinen zu Bewusstsein
  \item Kapitel 13: Was es bedeutet
  \item Kapitel 14: Dasselbe Muster, überall
  \item Kapitel 15: Die Architektur von allem
  \item Kapitel 16: Der tiefste Spiegel
  \item Koda
  \item Danksagungen
  \item Anmerkungen und Referenzen
  \item Anhang A: Grundlagen der Neurologie -- Ein Nachschlagewerk
  \item Anhang B: Das Intelligenzmodell
  \item Anhang C: Fünf Klassen der Berechnung
  \item Anhang D: Wie man luzid träumt
  \item Anhang E: Warum „vier'' Modelle? -- Eine Anmerkung für Neurowissenschaftler
\end{itemize}
...
\chapter{Kapitel 1: Das schwierigste Problem der Wissenschaft}
...
\chapter{Kapitel 2: Die vier Modelle}
...
\begin{figure}[htbp]
  \centering
  \includegraphics[width=0.95\textwidth]{../figures/figure2-real-virtual-split-simple-de.png}
...
\chapter{Kapitel 3: Die virtuelle Seite}
...
\chapter{Kapitel 4: Warum es sich wie etwas anfühlt (und warum das die falsche Frage ist)}
...
\chapter{Kapitel 5: Am Rand des Chaos}
...
\chapter{Kapitel 6: Was Psychedelika offenbaren}
...
\chapter{Kapitel 7: Was passiert, wenn die Lichter ausgehen}
...
\chapter{Kapitel 8: Der klinische Spiegel}
...
\chapter{Kapitel 9: Zwei Bewusstsein in einem Gehirn}
...
\chapter{Kapitel 10: Die Frage der Tiere}
...
\chapter{Kapitel 11: Neun Vorhersagen}
...
\chapter{Kapitel 12: Von Maschinen zu Bewusstsein}
...
\chapter{Kapitel 13: Was es bedeutet}
...
\chapter{Kapitel 14: Dasselbe Muster, überall}
...
\chapter{Kapitel 15: Die Architektur von Allem}
...
\chapter{Kapitel 16: Der tiefste Spiegel}
...
\begin{tabularx}{\linewidth}{X X X X}
\toprule
\textbf{Areal} & \textbf{Rezeptives Feld} & \textbf{Normale Funktion} & \textbf{Psychedelische Signatur} \\
\midrule
\textbf{V1} & ~1° & Kantenerkennung, räumliche Frequenz, Orientierungssäulen & Phosphene, Klüver-Formkonstanten, atmende/schimmernde Oberflächen \\[4pt]
\textbf{V2} & ~2-4° & Konturintegration, Textursegmentierung, Randbesitz, illusorische Konturen & Tessellationen, sich wiederholende geometrische Muster, verstärkte Texturwahrnehmung \\[4pt]
\textbf{V3} & ~4-8° & Globale Formverarbeitung, dynamische Form, Bewegungsgrenzen & Fließende, sich wandelnde geometrische Strukturen \\[4pt]
\textbf{V4} & ~8-16° & Farbe, Krümmung, komplexe Textur, fraktale Skalenverarbeitung & Farbige Fraktale, kaleidoskopische Muster, gesättigte/unmögliche Farben \\[4pt]
\textbf{V5/MT} & Groß, bewegungsabgestimmt & Bewegungswahrnehmung, optischer Fluss, Geschwindigkeits- und Richtungskodierung & Rotation, Driften und rhythmische Bewegung aller visuellen Muster \\[4pt]
\textbf{Fusiformer Gyrus (IT)} & Sehr groß, objektzentriert & Gesichtserkennung (FFA), Wortformen, feinkörnige Objektunterscheidung & Gesichter, Figuren, Entitäten --- oft verzerrt oder sich wandelnd \\[4pt]
\textbf{Anteriorer IT} & Ganzes Sichtfeld & Semantische Kategorien, Szenenkonstruktion, objektinvariante Erkennung & Vollständige narrative Halluzinationen, komplexe Szenen, traumartige Sequenzen \\[4pt]
\bottomrule
\end{tabularx}
}
