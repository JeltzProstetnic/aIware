...
Kehr jetzt zu jener Lücke zurück, mit der Architektur in der Hand. Der Instinkt der meisten Menschen sagt: Änderte sich alles am inneren Leben über Nacht, wäre „Ich`` weg und jemand anderes hätte übernommen. Aber die Vier-Modelle-Theorie sagt etwas Beunruhigenderes: Das \textit{passiert bereits}, unmerklich, Tag für Tag. Jede Nacht bricht das Explizite Selbstmodell zusammen, und der Tiefschlaf löscht die laufende Simulation. Jeden Morgen fährt sie wieder hoch und baut „dich'' aus dem Impliziten Selbstmodell neu --- dem langsamen, gespeicherten Selbst, das der Schlaf zurücklässt. Aber das Substrat hat sich über Nacht verändert: Träume, an die keine Erinnerung bleibt, haben synaptische Gewichte verschoben, Konsolidierung hat Erinnerungen umgeordnet. Wer aufwacht, ist nicht ganz dieselbe Person, die eingeschlafen ist. Der Unterschied ist normalerweise so gering, dass er nie auffällt --- aber er ist da, jeden einzelnen Tag.

Zwei Dinge halten „dich`` über diese Drift hinweg durchgehend: das Implizite Selbstmodell, das sich nur langsam ändert, und der Schlaf, der die Veränderung verbirgt, indem er die Simulation offline nimmt, während sie geschieht. Triebe man die Drift weit genug --- das ISM über Nacht umbauen, die Erinnerungen austauschen, die Persönlichkeitsstruktur umformen ---, verschwände das alte „Ich'' nicht. Es würde \textit{aufgesogen}. Das morgendliche ESM setzt aus dem, was überlebt hat, eine durchgehende Erzählung zusammen und webt Altes und Neues nahtlos in eine einzige Geschichte, ohne je die Naht zu bemerken. Das ESM macht keine sauberen Brüche --- es näht immer. Nur vollständige Löschung reißt den Faden; solange etwas bleibt, schreibt das „Ich`` von morgen das „Ich'' von heute leise in seine Geschichte und nennt das Ganze ein Leben.
...
Das ist wichtig, weil es zeigt: Bewusstsein braucht kein \textit{korrektes} Selbstmodell. Es braucht nur \textit{ein} Selbstmodell. Die Architektur läuft weiter, so oder so. Das Explizite Selbstmodell schaltet sich nicht ab, wenn es absurden Input bekommt -- es baut das beste Selbst, das es kann, aus den verfügbaren Signalen. Dasselbe Prinzip zeigt sich beim Cotard-Wahn (das ESM arbeitet mit fehlenden interozeptiven Signalen: ``Ich muss tot sein''), beim Anton-Syndrom (das ESM generiert Sehen aus Erinnerung, wenn die Augen versagen) und bei der Konversionsstörung (das ESM modelliert eine Lähmung, die das Substrat gar nicht hat). Das Selbstmodell ist ein zwanghafter Konstrukteur. Es hört nie auf zu bauen. Es erklärt nie, die Daten seien unzureichend. Es baut einfach und glaubt.
...
\begin{itemize}
  \item \textbf{Neugeborenes (erste Wochen):} Basales Bewusstsein --- ein rudimentäres EWM mit minimalem ESM. Es gibt \textit{etwas, wie es ist}, ein Neugeborenes zu sein, aber das Selbst in dieser Erfahrung ist fast nicht existent. Überwiegend sensorisch, undifferenziert.
\end{itemize}
...
Und dann war da noch das eine Mal, als ich ein animiertes vierdimensionales Fraktal war. Auf die Umstände gehe ich lieber nicht ein. Was mich störte, war nicht, ein Fraktal zu sein --- das war mir egal. Was mich störte, war, dass seine Bewegungen mit meinem propriozeptiven Sinn in Konflikt standen. Ich konnte fühlen, wie mein Körper das eine tat, während das Fraktal das andere tat. Der sensorische Konflikt war belastend. Die ontologische Absurdität nicht. Das ESM kümmert sich nicht darum, \textit{was} es modelliert. Es kümmert sich darum, dass die Signale zusammenpassen.
...
\textit{Vollständige Literaturangaben mit URLs und Anmerkungen finden sich im wissenschaftlichen Paper sowie unter github.com/JeltzProstetnic/aIware/references.md. Was folgt, sind kapitelweise Anmerkungen für Leser, die tiefer einsteigen möchten.}

\textbf{Kapitel 1}: Chalmers (1995), ``Facing Up to the Problem of Consciousness'', ist die grundlegende Formulierung des Schwierigen Problems. Die COGITATE-Ergebnisse erschienen in Nature (2025). Die Kontroverse um IIT als Pseudowissenschaft ist in Nature Neuroscience (2025) dokumentiert.
...
\textbf{Kapitel 7}: Casali et al. (2013) zum PCI. Alkire et al. (2000) zu Propofol. Schartner et al. (2015) zur Ketamin-Entropie. Die Vorhersage erhöhter EEG-Komplexität bei luzidem Träumen wurde hier erstmals formuliert.
...
\textbf{Kapitel 13}: Libet (1979, 1985) und Schurger et al. (2012) zum freien Willen. Kuhn \& Brass (2009) zur retrospektiven Konstruktion des Urteils über freie Wahl. Wegner (2002, 2003), \textit{The Illusion of Conscious Will} --- das ``I Spy''-Maus-Experiment dort ausführlich beschrieben. Das Kaffee/Zucker-Gedankenexperiment, das Amnesie-enthüllt-Determinismus-Argument und das Zufallszahlensequenz-Argument stammen aus Gruber (2015). Das 40/20-Hz-Verarbeitungs-Framework, die ``keine Rückdatierung nötig''-Neuinterpretation von Libet und das Kampfkunst-Frequenz-Beispiel wurden ebenfalls dort entwickelt. Die Uhr-Analogie für Epiphänomenalismus, die Neuformulierung ``Wille ist real, aber nur teilweise bekannt'' und das ``Drei-Diskrepanzen''-Selbstwissens-Modell gehen auf dieselbe Quelle zurück. Die persönliche Anekdote über das Hören innerer ``Stimmen'' bei extremer Erschöpfung ist autobiographisch. Das Zombie-Argument wird über Kirk (2019) und Chalmers (1996) adressiert. Marys Zimmer: Jackson (1982, 1986). Der Abschnitt zu offenen Fragen folgt dem von Popper (1963) empfohlenen Ansatz ehrlicher Grenzziehung.
...
\addcontentsline{toc}{chapter}{Anhang A: Grundlagen der Neurologie}
\markboth{Anhang A: Grundlagen der Neurologie}{}
...
Sie belegen also, unabhängig voneinander und mit Daten, \textit{dass} Motivation ins Innere der Intelligenz gehört. Mein Modell sagt \textit{warum} und \textit{wie}: Sie ist einer der multiplikativen Faktoren --- Wissen × Leistung × Motivation. Setze sie auf null, und du dimmst die Intelligenz nicht nur, du bringst sie zum Einsturz. Ihre Zahlen, aus ganz eigenen Gründen erhoben, landen genau dort, wo das Modell es vorhergesagt hat.
...
\addcontentsline{toc}{chapter}{Anhang E: Warum ``vier'' Modelle?}
\markboth{Anhang E: Warum ``vier'' Modelle?}{}
