...
\vspace{0.5cm}
\noindent Primera edición, 2026\par
\vspace{0.5cm}
...
Es hora de concretar algo que quizá todavía se sienta abstracto. He estado hablando de que el córtex necesita operar en el borde del caos, en dinámicas de Clase 4. Pero ¿qué \textit{es} el sistema de Clase 4? No es una fuerza misteriosa que flota sobre el cerebro. Es el patrón mismo del disparo neuronal.
...
Con dosis psicodélicas altas, esta entrada se altera. El modelo del yo no muere: se \textit{redirige}. Privado de su entrada autorreferencial normal, se aferra a la entrada que sea dominante.
...
Si la teoría es buena, entonces el daño a modelos concretos debería producir déficits concretos y predecibles. No vaguedades del tipo «la conciencia está afectada», sino predicciones precisas: desactiva este componente y obtienes \textit{aquel} síndrome. Mantén otro en marcha sin su input normal y obtienes \textit{este} otro síndrome. La literatura clínica está llena de afecciones que resultan profundamente desconcertantes bajo los modelos habituales de la conciencia, pero que encajan con naturalidad cuando dispones de una distinción real/virtual y de cuatro modelos que interactúan entre sí.
...
\textbf{La salvedad del malestar --- y por qué importa más que la ingeniería.} Y ahora viene la parte que no he visto a nadie discutir con honestidad, y es la que más me inquieta.
...
\textbf{La ética de crear mentes.} Si una mente copiada es consciente, tiene experiencias. Puede sufrir. Puede sentir confusión, miedo, soledad, pavor existencial. Imagina despertar y que te digan que eres una copia: que tu «verdadero» yo sigue caminando por ahí en un cuerpo biológico, viviendo tu vida, mientras tú existes como una réplica digital sin identidad legal, sin vínculos sociales y sin un propósito claro. Eso anuncia un sufrimiento a una escala para la que no tenemos marco alguno. Cualquier programa serio de «mind uploading» debe afrontar esto \textit{antes} de que se haga la primera copia, no después.
...
\textbf{El libre albedrío, y los tres experimentos mentales más difíciles.} Piensa en un reloj. El tren de engranajes lo impulsa todo --- el escape marca el tictac, los resortes se destensan, las relaciones de transmisión entre los engranajes determinan la marcha. Las agujas y la esfera no causan nada. No empujan engranajes. No almacenan energía. Pero quítalas y ya no tienes un reloj. Tienes una caja de metal que gira. La indicación es lo que hace del mecanismo un \textit{reloj} --- lo que da sentido a todo el conjunto. La conciencia es la indicación. Tus modelos virtuales (el Modelo Explícito del Mundo y el Modelo Explícito del Yo) no empujan neuronas de un lado a otro. Del empuje se encarga el sustrato. Pero sin la simulación, el sustrato no tiene manera de observar las consecuencias de sus propias acciones, ni de ensayar escenarios futuros, ni de adaptarse del modo que te ha mantenido con vida hasta ahora. El lado virtual es la manera que tiene el mecanismo de ser \textit{para} algo.
...
Y si las singularidades son transformadoras de información ---si no destruyen la computación, sino que la reinician---, entonces el Big Rip no produce un reinicio. Produce \textit{muchos}. Potencialmente, infinitos. Cada fragmento del dominio computacional hecho añicos podría sembrar su propia nueva expansión, su propia nueva descompresión, su propio nuevo universo. El Big Rip, en este marco, es un generador de multiversos.
...
\begin{itemize}
  ...
  \item \textbf{Áreas de Brodmann} --- Regiones numeradas del córtex, cartografiadas por el anatomista Korbinian Brodmann a partir de la estructura celular. V1 = área 17 de Brodmann.
  \item \textbf{Cuerpo calloso} --- El enorme haz de fibras que conecta los dos hemisferios cerebrales.
  \item \textbf{Columnas corticales} --- Módulos verticales de neuronas en el córtex, de unos 0,5 mm de diámetro, considerados unidades básicas de procesamiento.
  ...
  \item \textbf{Colículo superior} --- Una estructura del mesencéfalo implicada en los movimientos oculares y en la vía visual rápida que evita el córtex.
  ...
  \item \textbf{Tálamo} --- La estación de relevo del cerebro, que encamina la información sensorial hacia el córtex.
  ...
  \item \textbf{Córtex visual} --- La región de la parte posterior del cerebro que procesa la información visual, organizada como una jerarquía de lo simple a lo complejo (V1 $\rightarrow$ V2 $\rightarrow$ V3 $\rightarrow$ V4 $\rightarrow$ V5 $\rightarrow$ IT).
\end{itemize}
...
\textbf{Notas:}
\begin{itemize}
  \item El giro fusiforme se extiende sobre el límite entre V4 e IT y forma parte del córtex inferotemporal (IT). Contiene el Área Fusiforme de Rostros (FFA), identificada por Kanwisher et al. (1997), que se activa selectivamente ante los rostros.
...
Aquí es donde el modelo de la inteligencia vuelve a conectar con la Teoría de los Cuatro Modelos que constituye el corazón de este libro. El ciclo recursivo de la inteligencia no solo \textit{se beneficia de} la conciencia: la \textit{requiere}.
