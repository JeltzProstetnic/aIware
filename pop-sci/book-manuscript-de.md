...
Die Bewusstseinsliteratur ist über Philosophie, Neurowissenschaft, Psychologie und Informatik verstreut. Keine einzelne Disziplin ist allein für die Frage zuständig. In ansonsten todernster Fachliteratur tauchen ständig Sätze auf wie „wir werden vielleicht nie verstehen, wie Bewusstsein entsteht." Aus einer determinismus- und logikbasierten Perspektive liegt der Schluss nahe: Wenn die Physik die ersten drei Minuten nach dem Urknall beschreiben kann, gibt es keinen prinzipiellen Grund, warum Bewusstsein dauerhaft jenseits der Erklärung sein sollte. Es ist nur noch nicht erklärt *worden*.

Dieses Buch beschreibt eine Theorie, die genau das versucht — die Vier-Modelle-Theorie. Sie entstand aus einer breiten Recherche über Disziplingrenzen hinweg: Philosophie des Geistes, Kognitionswissenschaft, Neuroanatomie, künstliche Intelligenz, Evolutionsbiologie, Simulations- und Modellierungstheorie, Zelluläre Automaten. Die Teile ordneten sich zu einer Architektur, die nicht nur Bewusstsein erklärt, sondern auch die Grenze zwischen bewusster und unbewusster Verarbeitung, die Natur der Qualia, die Rolle des Schlafs, die Wirkung von Psychedelika und die Möglichkeit künstlichen Bewusstseins — und, weitergedacht, sogar Implikationen für die Kosmologie.

Die erste Version erschien 2015 — auf Deutsch, 300 Seiten, selbst verlegt und technisch. Ein Jahrzehnt später bestätigte die Neurowissenschaft die Kritikalitäts-Vorhersage der Theorie. Die KI-Entwicklung bestätigte die beschriebenen Beschränkungen. Die COGITATE adversariale Kollaboration (2025, *Nature*) zeigte, dass weder IIT noch GNW Bewusstsein vollständig erklären konnten — genau wie die Theorie es für jedes Rahmenwerk vorhersagt, dem die Vier-Modelle-Struktur fehlt.

Dieses Buch ist die überarbeitete Version: kürzer, für ein breiteres Publikum, begleitet von einer begutachteten wissenschaftlichen Arbeit. Die meisten Bewusstseinstheorien leben in ein oder zwei Disziplinen. Diese hier versucht, sie alle zusammenzubinden — was, wenn man darüber nachdenkt, genau das ist, was das Gehirn selbst tut. Es nimmt unterschiedliche Informationsströme aus völlig verschiedenen Quellen und webt sie zu einer einzigen kohärenten Erfahrung. Wenn eine Theorie des Bewusstseins nicht dasselbe über Disziplingrenzen hinweg leisten kann, ist das ein Grund zur Skepsis.

Wenn das, was folgt, richtig ist, gilt zweierlei. Erstens: Das zentrale Mysterium des Bewusstseins (das „Schwierige Problem") ist eigentlich nicht schwierig. Es ist ein Kategorienfehler, der sich auflöst, sobald man ihn sieht — wie eine optische Täuschung, die nicht mehr funktioniert, nachdem der Trick durchschaut ist. Zweitens, und folgenreicher: Es sollte möglich sein, eine wirklich bewusste Maschine zu bauen. Keinen Chatbot, der Bewusstsein nachahmt. Eine Maschine, die Bewusstsein *hat*.

Wenn die Theorie falsch liegt, reiht sich dieses Buch in die lange Reihe ambitionierter Fehlschläge in der Philosophie ein. Aber die Beweise sprechen dafür, und sie werden so klar wie möglich dargelegt.

---

## Der Autor

**Matthias Gruber** studierte Medizinische Informatik und Biomedizinische Informatik (UMIT, Hall in Tirol) und forschte an der TU Wien im Bereich simulationsbasierter Optimierung. Seine berufliche Laufbahn umfasst Forschungspositionen in Simulation und Semantik, Softwareentwicklung und Prozessmanagement in der Messtechnik und die Leitung der KI-Transformation bei Ivoclar AG in Liechtenstein. Er ist gerichtlich beeideter Sachverständiger für Softwareentwicklung und agiles Projektmanagement.

Bruno J. Gruber, Quantenmechaniker und Symmetrieforscher, ist eine große Inspiration für die theoretische Arbeit hinter diesem Buch.
...
Leibniz' Gesetz ist der Grund, warum philosophische Zombies – Wesen, die genau wie bewusste Menschen handeln, aber nicht bewusst sind – inkohärent sind. Wenn der Zombie funktional identisch mit einem bewussten Wesen ist, dann hat er dieselbe Vier-Modelle-Architektur, dieselbe laufende Simulation, dieselbe Selbstreferenz.

Diese drei Prinzipien – Einfachheit, Nicht-Exzeptionalismus und Identität durch Eigenschaften – sind nicht bloß ästhetische Präferenzen. Sie sind die intellektuellen Werkzeuge, mit denen sich ein Weg durch Jahrhunderte der Verwirrung bahnen lässt, um zu einer Theorie zu gelangen, die tatsächlich funktioniert. Die Vier-Modelle-Theorie ist das Ergebnis, wenn man diese Prinzipien ernst nimmt und auf das schwierigste Problem der Wissenschaft anwendet.
...
Das folgende Gedankenexperiment geht tiefer, als es zunächst scheint. Was, wenn man morgen mit anderen Erinnerungen aufwachte, einer anderen Persönlichkeit, einem anderen Körpergefühl? Wäre das noch „dieselbe Person"?

Der Instinkt der meisten Menschen sagt nein – natürlich, wenn sich alles am inneren Leben änderte, wäre „Ich" weg und jemand anderes hätte übernommen. Aber die Vier-Modelle-Theorie sagt etwas Beunruhigenderes: Das *passiert bereits*, unmerklich, Tag für Tag.
...
Das sagt uns, dass Identität keine feste Eigenschaft des Substrats ist. Sie ist eine *Rekonstruktion*, jeden Morgen frisch aus dem gespeicherten Selbstmodell zusammengesetzt. Die Kontinuität des Selbst im Lauf der Zeit stützt sich auf zwei Dinge: die Stabilität des Impliziten Selbstmodells (das sich nur langsam ändert) und den Schlaf (der verhindert, dass die schleichende Drift auffällt). Könnte jemand das ISM über Nacht radikal umbauen – die Erinnerungen austauschen, die Persönlichkeitsstruktur umformen –, würde das alte „Ich" nicht verschwinden. Es würde aufgesogen. Das neue Explizite Selbstmodell würde aus den verbliebenen Erinnerungen eine durchgehende Erzählung zusammensetzen und alte und neue Persona in eine einzige Geschichte einweben. Genau das tut das Gehirn bereits jede Nacht in kleinerem Maßstab: Das Substrat ändert sich im Schlaf, und das ESM, das morgens hochfährt, konfabuliert sich nahtlos als dieselbe Person, die zu Bett ging. Der einzige Unterschied ist das Ausmaß der Veränderung. Das ESM macht keine sauberen Brüche – es näht normalerweise *immer* eine durchgehende Erzählung zurecht. Nur wenn die alten Erinnerungen vollständig gelöscht wären, risse der Faden ganz. Solange etwas bleibt, wird das neue „Ich" das alte „Ich" in seine Geschichte einfügen, nahtlos, ohne auch nur die Naht zu bemerken.
...
**Beziehung 1: Ein holografisches Substrat produziert Klasse-4-Dynamiken.** So arbeitet vermutlich das Gehirn. Neuronale Netzwerke sind lokal holografisch – Karl Lashley zeigte vor Jahrzehnten, dass man große Teile des Kortex zerstören kann und die Erinnerungen bleiben erhalten, degradiert, aber vollständig, genau wie ein halbiertes Hologramm das ganze Bild in niedrigerer Auflösung liefert. Und dieses holografische Substrat produziert, an Kritikalität arbeitend, die Klasse-4-Dynamiken, die Bewusstsein verlangt. Gut belegt, gründlich dokumentiert und – man verzeihe mir – die langweilige Variante.
...
Therapie verdrahtet die impliziten Modelle um. Das ist der Mechanismus. Jedes Mal, wenn ein katastrophaler Gedanke hinterfragt wird und die Welt nicht untergeht, aktualisieren sich IWM und ISM. Wird eine gefürchtete Situation durchgestanden, schreiben sich neue Daten ins Substrat. Die virtuellen Modelle ändern sich, weil die realen Modelle sich zuerst ändern.
...
Hier zeigt sich die Aufspaltungs-Eigenschaft aus Kapitel 3. Ein Substrat, multiple virtuelle Konfigurationen, jede ein vollständiges, aber eigenständiges Selbstmodell. Die Theorie erklärt DID nicht bloß – sie sagt genau diese Art von Architektur vorher. Vorhersage 9 in Kapitel 11 macht den Test explizit: Die gezielte Störung des neuronalen Substrats, das das ESM einer Teilpersönlichkeit aufrechterhält, sollte einen Wechsel zu einer anderen auslösen.
...
Eine Theorie, die alles erklärt und nichts vorhersagt, ist keine Theorie, sondern eine Geschichte. Die Vier-Modelle-Theorie macht neun spezifische, testbare Vorhersagen, von denen sich mehrere mit heutiger Technologie prüfen lassen.
...
Die Vorhersage ergibt ein 2×2-Muster. Welt- gegen Selbstaufgaben. Implizit gegen explizit. Vier Quadranten, vier verschiedene neuronale Signaturen. Taucht dieses Muster nicht auf, stimmt etwas mit der Theorie nicht.
...
Unter Psychedelika sollte der visuelle Inhalt die Verarbeitungshierarchie des Gehirns in einer bestimmten Reihenfolge durchlaufen, abhängig von der Dosis.

Bei niedrigen Dosen zeigen sich Phosphene — kleine Funken und geometrische Formen, die bei geschlossenen Augen auftauchen. Das ist V1, die früheste visuelle Verarbeitungsstufe, die ins Bewusstsein durchsickert. Bei höherer Dosis entstehen komplexere geometrische Muster — die berühmten „Formkonstanten", die kulturübergreifend und substanzunabhängig auftreten. Das sind V2 und V3, die sich zuschalten. Bei noch höheren Dosen erscheinen Gesichter, Figuren und komplexe Szenen. Bei den höchsten Dosen entstehen vollständige narrative, traumartige Erfahrungen, komplett mit Bedeutung und Handlung.

Die Vorhersage: Das ist kein Zufall. Es ist eine dosisabhängige, geordnete Progression die visuelle Hierarchie hinauf. Mit zunehmender implizit-expliziter Durchlässigkeit werden immer tiefere Schichten der visuellen Verarbeitung bewusst. Der interne Schaltplan des Gehirns wird in der Erfahrung sichtbar.
...
Der Mechanismus ist einfach. Das Explizite Selbstmodell speist sich normalerweise aus dem Impliziten Selbstmodell. Unter hochdosierten Psychedelika wird diese Verbindung gestört. Das ESM läuft weiter, versucht weiter „Selbst" zu modellieren, hat aber seinen gewohnten Input verloren. Also klammert es sich an das, was gerade dominiert.
...
Aber die Vier-Modelle-Theorie sagt: Sie alle müssen dasselbe mit dem Bewusstsein machen — die Dynamik des Gehirns unter die Kritikalitätsschwelle drücken. Weil Kritikalität die physische Voraussetzung für Bewusstsein ist. Wie sie gestört wird, spielt keine Rolle. Unterhalb der Schwelle geht das Licht aus.
...
Der Grund: Die Theorie besagt, dass Information im Gehirn holographisch gespeichert ist, verteilt über das gesamte Substrat. Verbindungen zu kappen trennt nicht sauber zwei vorbestehende Geister. Es verschlechtert zwei *Kopien* derselben Information, die jeweils auf der Hälfte der ursprünglichen Hardware laufen.

Es gibt bereits Hinweise darauf — eine Studie von Pinto und Kollegen aus dem Jahr 2017 zeigte, dass Split-Brain-Patienten deutlich integrierteres Verhalten zeigen, als die klassischen Experimente vermuten ließen. Aber die Theorie liefert den *Mechanismus* und sagt das spezifische Muster voraus: beidseitige Verschlechterung statt hemisphärischer Spezialisierung.
...
2. **Einschlafen sollte ein stufenartiger Übergang sein, kein allmähliches Verlöschen.** Kritikalitätsmaße sollten beim Einschlafen einen abrupten Abfall zeigen, der den digitalen Kollaps des Automaten widerspiegelt.
...
All das lässt sich mit vorhandener Schlaflabor-Technologie testen. Und wenn es standhält, heißt das: Schlaf ist nicht bloß „Ruhe", sondern das Wartungsprotokoll des Substrats für die Berechnungsschicht, die Bewusstsein ermöglicht.

### Vorhersage 9: Jede Teilpersönlichkeit bei Dissoziativer Identitätsstörung hat ihren eigenen neuronalen Fingerabdruck

Die Dissoziative Identitätsstörung (DIS) — multiple eigenständige Identitäten, sogenannte Teilpersönlichkeiten, in einer einzigen Person — ist umstritten, und das zu Recht. Wie unterscheidet man echte eigenständige Identitäten von jemandem, der Rollen spielt, bewusst oder unbewusst?

Die Vier-Modelle-Theorie liefert einen Test. Wenn Teilpersönlichkeiten real sind — also tatsächlich verschiedene Konfigurationen des Expliziten Selbstmodells auf demselben Substrat —, dann sollte jede Teilpersönlichkeit eine unterscheidbare, messbare neuronale Signatur haben. Nicht nur anderes Verhalten. Nicht nur andere Selbstberichte. Andere *Gehirnaktivierungsmuster*.

Die Vorhersage ist konkret. Man zeichne die Gehirnaktivität eines DIS-Patienten auf (fMRI oder EEG), während verschiedene Teilpersönlichkeiten präsent sind. Man vergleiche die Variabilität zwischen den Teilpersönlichkeiten mit der Variabilität innerhalb derselben Teilpersönlichkeit über die Zeit. Die Theorie sagt voraus, dass die Variabilität zwischen den Teilpersönlichkeiten signifikant größer sein wird als die innerhalb einer Teilpersönlichkeit. Und die Unterschiede sollten konsistent sein: Das neuronale Muster von Teilpersönlichkeit A sollte jedes Mal erkennbar Teilpersönlichkeit A sein, kein zufälliges Rauschen.
...
Es gibt ein paar Neuroimaging-Studien zu DIS, aber die Vier-Modelle-Theorie liefert die theoretische Grundlage für *konsistente, für einzelne Teilpersönlichkeiten spezifische neuronale Signaturen* statt bloß „Unterschiede". Bestätigt sich die Vorhersage, wäre das der Nachweis, dass Teilpersönlichkeiten nicht bloß psychologisch sind, sondern verschiedene funktionale Konfigurationen auf neuronaler Ebene — was unser Verständnis und die Behandlung der Störung grundlegend verändern würde.
...
Das rekursive Intelligenzmodell lässt sich an einem einfachen Beobachtungsmuster festmachen: Wissen, Leistung und Motivation schaukeln sich gegenseitig hoch. Hier wird das Modell nun sauber aufgebaut: Was sind die Komponenten, wie greifen sie ineinander, warum erzeugt ihre Wechselwirkung genau die Dynamiken, die man beobachtet — und was folgt daraus für Bildung, künstliche Intelligenz und die Verbindung zum Bewusstsein?
