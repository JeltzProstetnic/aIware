...
Bevor ich hier irgendetwas zu erklären beginne, ein kleines Experiment. Es dauert nur ein paar Sekunden.

Sieh die beiden Markierungen unten an: links ein **X**, rechts ein **ausgefüllter Punkt**.

![Zwei Markierungen für einen Blinder-Fleck-Test: links auf der Seite ein fettes X, rechts ein ausgefüllter schwarzer Punkt, über die volle Breite des Textes voneinander getrennt.](../figures/blind-spot-test.png)

Halte das Buch mit ausgestrecktem Arm weg. Schließe das **linke** Auge. Fixiere mit dem rechten Auge das X – nur das X. Nicht schummeln, nicht zum Punkt hinüberschielen; man spürt ihn dort am Rand des Blickfelds sitzen, und das genügt. Und jetzt führe das Buch, während dein Blick fest auf dem X bleibt, langsam auf deine Augen zu.

Irgendwo etwa dreißig Zentimeter vor deinem Gesicht verschwindet der Punkt einfach.

Er ist weg.

Nicht verschwommen. Nicht verblasst. *Weg* – und hier lohnt es sich innezuhalten: Da ist kein Loch, wo er war. Keine Lücke, kein dunkler Schmierfleck, keine leere Stelle. Die Seite ist einfach, nahtlos, durchgehend weiß über genau der Stelle, an der ein fetter schwarzer Punkt auf ihr gedruckt steht, vor deinem offenen, funktionierenden Auge. Dein Auge zielt direkt darauf. Und du kannst ihn nicht sehen, weil dein Gehirn ihn stillschweigend mit Weiß übermalt hat.

Was soeben geschehen ist: Jedes Auge hat einen blinden Fleck – eine Stelle der Netzhaut, genau dort, wo der Sehnerv zum Gehirn durchbricht, die überhaupt keine lichtempfindlichen Zellen besitzt. Es gibt ein Loch in deinem Sehen, groß genug, um neun Vollmonde zu verschlucken, in jedem Auge, die ganze Zeit. Du hast es nie ein einziges Mal bemerkt. Nicht weil es klein wäre – es ist riesig –, sondern weil dein Gehirn dir das Loch nie zeigt. Es liest, was die Lücke umgibt, und *fabriziert* die Mitte: erfindet das Weiß der Seite, erfindet die Tapete, erfindet, was auch immer dort sein sollte, und reicht dir das fertige Bild, als wäre es die rohe Wahrheit.
...
Dieses Gefühl, das du vielleicht gerade spürst – halt es fest. Die betrügerische Maschinerie, die es erzeugt, ist das ganze Thema dieses Buches.
...
Ich sollte erwähnen, wer diese Behauptungen aufstellt. Ich gehöre keiner Universität an. Ich habe keinen Doktortitel – nur einen Master in Bioinformatik. Ich hatte nie ein Forschungsstipendium und habe nie in einem neurowissenschaftlichen Labor gearbeitet. Wer Qualifikationen prüft, bevor er einem Argument traut – und das ist ein berechtigter Instinkt –, wird hier vielleicht das Buch weglegen. Was ich stattdessen habe, ist die Vorgeschichte eines autodidaktischen Außenseiters: Jahrzehnte des Lesens, das nie gelernt hat, die Grenzen zwischen den Fächern zu respektieren. Diese Theorie existiert nur, weil mir nie jemand gesagt hat, welche Disziplinen einander nicht berühren durften. Die meisten Bewusstseinstheorien leben in ein oder zwei Welten; diese hier versucht, sie alle zusammenzubinden – was ja auch genau das ist, was das Gehirn tut. Meine Theorie ist ein Produkt derselben rekursiven Schleife, die sie beschreibt. Ob die Theorie etwas taugt, muss jeder selbst beurteilen.

Bruno J. Gruber, theoretischer Physiker (Quantenmechanik und Symmetrien), hat die Denkweise hinter diesem Buch tief geprägt.
...
Das ist keine Übertreibung. (Obwohl fairerweise gesagt sei, dass die Mathematik Probleme kennt, die ich für noch schwieriger halte – aber die halten die meisten Menschen nachts nicht wach.) Die Physik hat das Standardmodell, die Biologie Evolution und Genetik, die Chemie das Periodensystem. Aber Bewusstsein – die Tatsache, dass es sich „irgendwie anfühlt“, man selbst zu sein – hat keine etablierte Theorie, keine allgemein akzeptierte Erklärung.
...
Das ist der Ausgangspunkt der Vier-Modelle-Theorie – die Tatsache, die du dir selbst bewiesen hast, noch bevor dieses Buch richtig begonnen hatte. Du hast in deinem ganzen Leben die Realität nie direkt erfahren. Der Punkt, den du von der Seite wegradiert hast, war kein Trick des Papiers; es war dein Gehirn, das ein Loch in der Netzhaut mit fabriziertem Inhalt füllte – so, wie es jedes Loch füllt, bei jedem Blick, so nahtlos, dass du nie den geringsten Verdacht schöpftest. Das ist keine Außenseiterbehauptung: Dass Wahrnehmung konstruiert und nicht direkt ist, ist gängige Neurowissenschaft, akzeptiert von praktisch jedem Forscher auf dem Gebiet. Was die Vier-Modelle-Theorie hinzufügt, ist der Schritt, den fast niemand geht – dass diese eine Tatsache, konsequent zu Ende verfolgt, das Schwierige Problem auflöst.

### Ein Rasiermesser

Ich habe die Theorie unter einer einzigen sichtbaren Disziplin gebaut: **Ockhams Rasiermesser.** Keine neue Physik, keine Quantenmagie in den Mikrotubuli, kein Proto-Bewusstsein, das in der Materie verstreut liegt – nur Zutaten, die wir bereits haben (neuronale Netzwerke, Lernen, Simulation, Selbstreferenz), in der richtigen Architektur angeordnet. Zwei weitere alte Prinzipien verrichten im Hintergrund ihre stille Arbeit, und statt sie jetzt an dir vorbeimarschieren zu lassen, bringe ich jedes genau dort ins Spiel, wo es zubeißt: das eine, wenn wir zu den Tieren kommen, das andere, wenn wir zu Zombies und dem freien Willen kommen. Hier genügt eine Klinge.

Jetzt ist es Zeit, sich die vier Modelle anzusehen.

---
## Kapitel 2: Die vier Modelle

Stellen wir uns vor, wir betrachten einen Apfel.
...
Schon einfache neuronale Netzwerke mit nur drei Schichten können lernen, ihre Eingabe zu modellieren – zeigt man ihnen genug Beispiele, bauen sie interne Repräsentationen der Muster auf, denen sie begegnen. Das Gehirn macht genau das, aber in einem weitaus größeren Maßstab. Es baut nicht ein Modell, sondern viele – vom Sehfeld bis zur Position der Gliedmaßen, vom Klang einer Stimme bis zum Druck der Füße auf dem Boden. Diese Modelle umfassen sowohl die Welt außerhalb als auch den eigenen Körper und verknüpfen alle verfügbaren sensorischen Eingaben zu kohärenten Repräsentationen.

Die Neurowissenschaft kennt diese Modelle seit über einem Jahrhundert. Im motorischen und im somatosensorischen Kortex ist der Körper buchstäblich als verzerrte Karte dargestellt – Hände und Lippen grotesk vergrößert, weil sie mehr Nervenenden haben, Rumpf und Beine auf ein Minimum zusammengestaucht. Diese kortikalen Karten, *Homunculi* genannt, wurden erstmals von Wilder Penfield in den 1930er Jahren durch direkte elektrische Stimulation während Hirnoperationen kartiert. Sie sind nur die anschaulichsten Beispiele; das Gehirn unterhält ähnliche Karten und Modelle in seiner gesamten Architektur. (Siehe Anhang A für mehr zur kortikalen Organisation.)

![](../figures/book/homunculi.de.png)
...
Nun zur Schlüsseleinsicht. Diese impliziten Modelle sitzen nicht einfach nur da. Sie *erzeugen* etwas. In der Technik ist ein **digitaler Zwilling** eine virtuelle Echtzeitkopie eines physischen Systems – ein Düsentriebwerk, ein Stromnetz, eine Fabrikhalle –, kontinuierlich mit Sensordaten aktualisiert, damit Ingenieure das System überwachen, mit ihm interagieren, es zu Testzwecken manipulieren oder echte Situationen nachstellen und analysieren können, ohne es direkt anzufassen. Die impliziten Modelle tun genau das. Sie produzieren eine virtuelle Echtzeit-Simulation der Welt und eine virtuelle Echtzeit-Simulation von einem selbst. Das sind die **expliziten Modelle**: das Explizite Weltmodell (EWM) und das Explizite Selbstmodell (ESM). Alles, was man sieht, hört, fühlt und denkt, geschieht innerhalb dieser Simulationen, nicht in der Welt selbst.
...
Wie das Weltmodell ist das Selbstmodell in synaptischen Gewichten gespeichert und nie direkt bewusst. Man erfährt nicht das Körperschema; man erfährt den Körper, den das Schema erzeugt. Man erfährt nicht die Persönlichkeit; man erfährt die Gedanken und Gefühle, die sie hervorbringt. Das Implizite Selbstmodell ist die Mannschaft hinter der Bühne – unverzichtbar für die Aufführung, aber nie vom Publikum gesehen.

**Das Explizite Weltmodell (EWM)** ist die Welt, die man tatsächlich erfährt. Gerade jetzt. Der Raum, in dem man sitzt, die Geräusche, die man hört, das Gewicht dieses Buches in den Händen (oder das Leuchten des Bildschirms, auf dem man es liest). Das ist die Simulation – die virtuelle Echtzeit-Realität des Gehirns, erzeugt aus dem Impliziten Weltmodell plus aktueller sensorischer Eingabe. Sie ist in der Regel lebendig, detailliert und nahtlos überzeugend. Man lebt sein ganzes Leben darin und verlässt diese Simulation nie.

**Das Explizite Selbstmodell (ESM)** ist das Selbst. Das Gefühl, ein Subjekt zu sein. Das Gefühl von „Ich“ – derjenige, der sieht, hört, denkt und entscheidet. Auch das ist eine Simulation: ein Echtzeit-Modell, erzeugt aus dem Impliziten Selbstmodell plus aktuellen Körpersignalen. Es ist die Figur, die das Gehirn erschafft, um seine virtuelle Welt zu erleben. Man *ist* die Figur, die das Gehirn erschafft, um seine virtuelle Welt zu erleben.

### Die reale Seite und die virtuelle Seite

![Die Vier-Modelle-Architektur des Bewusstseins](../figures/figure1-four-model-architecture-bw-de.png)

*Die Vier-Modelle-Architektur. Das Gehirn unterhält zwei Arten von Modellen (Modelle von der Welt, Modelle vom Selbst), jeweils in zwei Modi: implizit (in der Struktur des Gehirns gespeichert) und explizit (aktiv laufend als Echtzeit-Simulation). Bewusstsein existiert in den expliziten Modellen.*

Die vier Modelle teilen sich in zwei Seiten, und diese Teilung ist das Fundament für alles, was folgt.

Die **reale Seite** (die zwei impliziten Modelle) ist physisch, strukturell und relativ starr (langsam durch Lernen angepasst). Sie ist das gespeicherte Wissen des Gehirns: synaptische Gewichte, Netzwerkverbindungen, Rezeptorkonfigurationen. Man stelle sich darunter alles vor, was das Gehirn *gelernt hat* – eingebrannt in die physische Struktur des Gewebes selbst. Erfahrung hat sie keine. Das Feuern einer Synapse wird so wenig „erlebt“ wie Wasser, das durch ein Rohr fließt. Auf der realen Seite ist das Licht aus.

Das muss betont werden: Die reale Seite ist das, was die Neurowissenschaft bereits untersucht. Wenn ein Forscher jemanden in einen fMRT-Scanner schiebt, betrachtet er die reale Seite – Aktivierungsmuster, Konnektivität, Blutfluss in verschiedenen Regionen. Wenn ein Neurochirurg ein Kortexareal stimuliert und beobachtet, was passiert, tastet er die reale Seite ab. Die Neurowissenschaft kartiert dieses Gebiet seit über einem Jahrhundert, und sie hat Außerordentliches geleistet. Die Vier-Modelle-Theorie verwirft nichts davon. Sie sagt nur, dass all das erst die halbe Wahrheit ist.

Die **virtuelle Seite** (die zwei expliziten Modelle) ist simuliert, flüchtig und dynamisch. Sie wird in jedem Moment neu erzeugt, aus der realen Seite plus aktuellem Eingang. Man stelle sich darunter alles vor, was das Gehirn *gerade mit* dem anstellt, was es gelernt hat – die Live-Show, nicht das abgelegte Drehbuch. Und sie ist *durch und durch* Erfahrung. Jeder Anblick, Klang, Gedanke, jedes Gefühl, jede Erinnerung, jeder Traum und jede Halluzination, die man je hatte, spielte sich auf der virtuellen Seite ab. Auf der virtuellen Seite brennt das Licht.
...
Ich will ehrlich sein, was die Theorie leistet und was nicht. Die Vier-Modelle-Theorie sagt *was* die Simulation ist, *wo* sie lebt, und *warum* sie sich nach etwas anfühlt. Den Entschlüsselungscode liefert sie nicht mit. Die virtuelle Seite aus der realen Seite abzulesen ist ein zukünftiges Forschungsprogramm – eines, das die Theorie klar umreißt, aber noch nicht einlösen kann. Allerdings wird die Grundlage dafür bereits gelegt. Das Human Connectome Project und verwandte Vorhaben kartieren die Verdrahtung des Gehirns in immer feinerer Auflösung. Die virtuelle Seite lässt sich noch nicht aus Strukturdaten dekodieren, aber die Strukturdaten kommen.
...
Man überlege, was ein neuronales Netzwerk im Kern leisten muss. Erste Schicht: Eingabe empfangen, filtern, bereinigen. Zweite Schicht: Muster extrahieren, Merkmale erkennen, die schwere Rechenarbeit erledigen. Dritte Schicht: Ergebnisse zusammenführen, Entscheidungen treffen, Ausgabe erzeugen. Eingabe, Verarbeitung, Ausgabe. Das ist das Grundrezept, und drei Schichten genügen dafür.
...
Zur Klarstellung: Ich behaupte nicht, dass sechs kortikale Schichten die *einzige* Architektur sind, die Bewusstsein tragen kann. Sie sind eine Lösung – die der Säugetiere. Aber es könnte andere geben. Der Oktopus mit seinem radikal verteilten Nervensystem (acht halbautonome Arme, jeder mit eigenem neuronalem Verarbeitungszentrum von rund 40 Millionen Neuronen) steht für einen völlig anderen architektonischen Ansatz, der womöglich vergleichbare Rechenleistung erreicht. Vögel bieten ein weiteres aufschlussreiches Beispiel: Rabenvögeln und Papageien fehlt ein geschichteter Kortex völlig; ihr Pallium ist in Kerncluster statt in Schichten organisiert – trotzdem bauen Krähen Werkzeuge, planen voraus und erkennen sich vermutlich im Spiegel. Wenn es auf die Fähigkeit zur Selbstmodellierung ankommt und nicht auf den konkreten Bauplan, dann könnte im Prinzip jede Architektur bewusst sein, die eine Simulation ihrer selbst ausführen kann. Ein Oktopus, eine Krähe oder etwas, das wir noch gar nicht gebaut haben. Aber die anderen Architekturen können warten. Es gibt eine näherliegende Frage, und es ist die, die mich beim ersten Mal, als ich diesen Gedanken bis zum Ende verfolgte, innehalten ließ. Wenn *du* die Figur bist, die das Gehirn in seine eigene Simulation hineinschreibt – wer schaut dann der Vorstellung zu?
...
Die virtuelle Welt des Spiels hat Eigenschaften, die die Hardware nicht hat. Das Spiel hat Berge, Flüsse und Städte, die CPU nur Transistoren. Es kennt einen Tag-Nacht-Zyklus, die GPU nur Taktzyklen. Es lässt sich sinnvoll fragen „Wie hoch ist dieser Berg im Spiel?“, aber es wäre absurd, auf einen Transistor zu zeigen und zu sagen „Dieser Transistor ist 3.000 Meter hoch.“ Die Eigenschaften des Spiels existieren auf der virtuellen Ebene, und sie sind echte Eigenschaften des Spiels, auch wenn das Spiel „nur“ ein Aktivitätsmuster in der Hardware ist.
...
Die Simulation des Gehirns hat keinen externen Spieler. Niemand sitzt außerhalb des Schädels und erlebt die Simulation. Die Simulation enthält ihren eigenen Beobachter – das Explizite Selbstmodell. Die Simulation *ist* die Erfahrung, nicht etwas, das von jemand anderem erlebt wird.

Versetzen wir uns in die Position der Spielfigur. Man *ist* die Hauptfigur. Von außerhalb des Spiels sieht ein Zuschauer Pixel, die sich auf einem Bildschirm bewegen – nichts, das möglicherweise etwas fühlen könnte. Aber aus dem Inneren der Simulation? Die Spielwelt ist alles, was es gibt. Für die Figur sind die Berge real, das Sonnenlicht warm, die Gefahr beängstigend. Kein externer Beobachter würde je vermuten, dass dieser Haufen Code etwas fühlt – aber nur, weil er auf die falsche Ebene schaut. Er schaut auf die Hardware. Die Erfahrung existiert auf der Software-Ebene. Das ist meine These, und der Rest dieses Buches legt die Belege vor.
...
Und dieser selbstreferentielle Abschluss – die Simulation beobachtet sich selbst von innen – ist das, was man Bewusstsein nennt. Nichts, das zur Simulation *hinzukommt*. Es ist das, was die Simulation *ist*, wenn sie ein Modell ihrer selbst enthält. Deshalb sage ich das so: Bewusstsein ist kein Ding, sondern ein Prozess. Man wird es nicht finden, indem man das Gehirn auseinandernimmt, genauso wenig wie man ein laufendes Programm findet, indem man die CPU zerlegt.

### Die Software-Eigenschaften

Wenn die virtuellen Modelle wirklich softwareartige Prozesse auf neuronaler Hardware sind, dann sollten sie sich auf bestimmte, testbare Weisen wie Software verhalten. Und genau das tun sie. Vier Eigenschaften der virtuellen Seite werden in diesem Buch immer wieder auftauchen; hier seien sie vorgestellt.

**Forking (Aufspaltung).** Ein einzelnes Substrat kann mehrere virtuelle Konfigurationen gleichzeitig laufen lassen. In Software spaltet man einen Prozess auf und erhält zwei unabhängige Instanzen, die auf derselben Hardware laufen. Im Gehirn ist dies die Dissoziative Identitätsstörung – mehrere Selbstmodelle, jedes mit seiner eigenen Erzählung und emotionalem Profil, die abwechselnd die Kontrolle über dasselbe neuronale Substrat übernehmen. Wir werden das in Kapitel 9 sehen.
...
In den 1920er und 30er Jahren brachte der Psychologe Karl Lashley Ratten bei, ein Labyrinth zu durchlaufen, und entfernte dann chirurgisch Stücke ihres Kortex, um herauszufinden, wo die Erinnerung saß. Er fand sie nie. Egal welches Stück er entfernte, die Ratten erinnerten sich noch an das Labyrinth. Was zählte, war *wie viel* Kortex er entfernte, nicht *welche Teile*. Je mehr er entfernte, desto schlechter wurden die Ratten. Aber die Erinnerung war nie einfach *weg*, sauber herausgeschnitten wie eine Datei, die von einer Festplatte gelöscht wurde. Lashley verbrachte seine Karriere damit, das „Engramm“ zu suchen – die physische Spur einer Erinnerung – und kam bekanntlich zu dem Schluss, dass es nicht zu existieren schien.
...
Die physische Verarbeitung (Neuronen feuern, Synapsen übertragen, die impliziten Modelle speichern und berechnen) hat keine Erfahrung. Keine. Es gibt nichts, das sich so anfühlt, als wäre man die reale Seite. Die reale Seite ist genau die „im Dunkeln“-Verarbeitung, von der das Schwierige Problem annimmt, dass Bewusstsein sie erklären muss.

Die *Simulation* fühlt. Das Explizite Weltmodell und das Explizite Selbstmodell (die virtuelle Seite) sind der Ort, an dem Erfahrung sitzt. Und innerhalb der Simulation ist Erfahrung keine mysteriöse Addition zum Prozess. Erfahrung ist das, was die Simulation *ist*, wenn sie ein Selbstmodell enthält. Das Explizite Selbstmodell, das das Explizite Weltmodell „wahrnimmt“, ist das, was wir Qualia nennen. Qualia sind die Weise, in der das virtuelle Selbst die virtuelle Welt registriert.
...
Genauso wenig fühlt sich neuronales Feuern wie Rot-Sehen an. Neuronales Feuern generiert und erhält eine Simulation aufrecht, und innerhalb dieser Simulation nimmt das Selbstmodell eine bestimmte Klasse von Weltmodell-Inhalt als das wahr, was wir „Röte“ nennen. Röte ist eine echte Eigenschaft der Simulation, keine Eigenschaft der Neuronen.

Das Schwierige Problem ging davon aus, dass wir erklären müssen, wie physische Verarbeitung Erfahrung hervorbringt. Aber physische Verarbeitung bringt keine Erfahrung hervor, sondern eine *Simulation*. Und die Simulation ist, weil sie eine selbstreferentielle Schleife enthält, ihrem Wesen nach Erfahrung.

### Wer bin ich, wenn ich aufwache?

Beginnen wir mit etwas, das du mit ziemlicher Sicherheit schon gefühlt hast. Du tauchst aus irgendwo tief unten auf – einer Ohnmacht, einem Knockout, einer Narkose oder einfach einem schwarzen, traumlosen Schlaf in einem Raum, den du nicht wiedererkennst. Und für einen Herzschlag ist niemand zu Hause. Da ist Gewahrsein – eine Decke, ein Streifen Licht –, aber noch kein Du, das daran hängt. Du weißt nicht, wo du bist. Für eine lange Sekunde weißt du nicht, wer du bist. Dann strömt es herein: dein Name, deine Geschichte, der Körper, in dem du liegst. Die Naht schließt sich so schnell, dass du sie fast verpasst. Aber du hast sie nicht verpasst. Für diesen Herzschlag gab es Erfahrung ohne ein Selbst, dem sie gehörte – Gewahrsein, das lief, während das Selbstmodell noch hochfuhr. Halt diese Lücke fest – wir kommen am Ende des Kapitels auf sie zurück. Das „Du“, das wieder online kam, wurde nicht unversehrt aus einem Speicher geholt; es wurde an Ort und Stelle aus dem Substrat darunter rekonstruiert.
...
Die Antwort ist Selbstreferenz. Eine Wettersimulation modelliert Wetter. Sie modelliert nicht *sich selbst*. Es gibt ein „Außen“ der Wettersimulation – den Computer, den Programmierer, den Wissenschaftler, der die Ausgabe interpretiert. Die Simulation lässt sich vollständig beschreiben, ohne auf irgendeine Erfahrung Bezug zu nehmen, weil es kein Selbstmodell in ihr gibt.
...
Qualia sind real. Sie sind real innerhalb der Simulation. Sie sind die Weise, in der das virtuelle Selbst die virtuelle Welt wahrnimmt. Wenn das Explizite Selbstmodell die Repräsentation eines roten Apfels durch das Explizite Weltmodell registriert, ist diese Registrierung (dieses „Röte-Sehen“) eine genuine Eigenschaft des virtuellen Prozesses. Sie existiert auf der Simulationsebene, genauso wie eine Kugel, die eine Videospiel-Figur trifft, ihr *wehtut*. Nicht metaphorisch – innerhalb des Spiels ist der Schaden real. Die Gesundheit sinkt, die Figur taumelt, die Welt reagiert. Von außen ist es eine Zahl, die im Speicher heruntergezählt wird. Von innen ist es Schmerz. Das ist der Ebenenunterschied. Und dort sitzen die Qualia.
...
Die Theorie sagt nicht, Schmerz sei eine Illusion. Sie sagt, Schmerz ist real – real in der Simulation, nicht in den Neuronen. Und da das gesamte Leben innerhalb der Simulation stattfindet, ist das die einzige Realität, die zählt.

Das ist die entscheidende Unterscheidung. Wer sie übersieht, wird diese Theorie mit Eliminativismus verwechseln, mit Illusionismus, mit jedem anderen Ansatz, der Bewusstsein zu erklären versucht, indem er das Bewusstsein wegerklärt. Die Vier-Modelle-Theorie erklärt Bewusstsein nicht weg. Sie erklärt, wo Bewusstsein sitzt.

### Was „Real innerhalb der Simulation“ bedeutet

Hier gibt es eine philosophische Feinheit, die es lohnt aufzudröseln. Wenn ich sage, Qualia sind „real innerhalb der Simulation“, könnte man zweierlei heraushören. Entweder sie sind *genuin phänomenal* – dann hat sich das Mysterium bloß von den Neuronen in die Simulation angesiedelt, und das Schwierige Problem lebt unter neuer Adresse weiter. Oder sie sind *funktional real, aber nicht genuin phänomenal* – dann ist das Dennett auf Umwegen.
...
Ich bin nicht der Erste, der hier landet, und ich wäre mir selbst gegenüber misstrauisch, wenn ich es wäre.

Der Kognitionswissenschaftler Joscha Bach hat denselben Kerngedanken so prägnant formuliert wie kaum jemand sonst. „Deine Erfahrung ist eine Simulation“, schrieb er, „eine virtuelle Realität, projiziert in einen virtuellen Beobachter.“ Und dieser Beobachter? Er ist „ein Modell davon, wie es wäre, wenn du existieren würdest, in einen Affen hochgeladen und tief in dessen Leben verwickelt“ – ein Modell, gebaut, um den Affen durch die physische Welt zu steuern. Eine Simulation, ein simuliertes Jemand darin, der die Simulation empfängt, und ein Körper, den das ganze Arrangement lenkt. Den älteren Zweigen dieser Tradition sind wir in diesem Buch bereits begegnet – Metzingers Selbstmodell, Dennetts narrativem Selbst.

In diesem Buch geht es allerdings eine Ebene tiefer – in die Architektur selbst. Welche Modelle genau: das 2×2 aus Welt und Selbst, implizit und explizit – die vier Modelle. Die scharfe Grenze dafür, ab wann ein System überhaupt ein Innen hat: selbstreferentieller Abschluss, die Schleife, die sich auf sich selbst zurückwendet. Und die Bedingung, die das Ganze zum Leben erwachen lässt: Kritikalität, der Rand des Chaos, wo das System weder erstarrt noch weißes Rauschen ist.

Bach sagt, *was* Bewusstsein ist. Ich sage, *woraus* es besteht und *wann* es sich einschaltet. Dasselbe Ziel, aber ich habe die Baupläne mitgebracht.
...
Das Ergebnis ist vorhersehbar. Das ESM, außerstande, sein eigenes Substrat zu beobachten, schließt, der Mechanismus des Bewusstseins müsse nicht-physisch sein, grundsätzlich unerklärlich oder irgendwie jenseits der Reichweite der Wissenschaft. Das ist der Ursprung des Dualismus und der „Erklärungslücke“. Das ist die hartnäckige Intuition, bei jeder physischen Erklärung von Bewusstsein werde etwas „ausgelassen“ – weil aus dem Inneren der Simulation tatsächlich etwas *ausgelassen wird*. Das Substrat. Genau das, was die Erfahrung erzeugt, ist unsichtbar für die Erfahrung, die es erzeugt.
...
### Das Selbst, das sich selbst zusammennäht

Kehr jetzt zu jener Lücke zurück, mit der Architektur im Gepäck. Der Instinkt der meisten Menschen sagt: Änderte sich alles am inneren Leben über Nacht, wäre „Ich“ weg und jemand anderes hätte übernommen. Aber die Vier-Modelle-Theorie sagt etwas Beunruhigenderes: Das *passiert bereits*, unmerklich, Tag für Tag. Jede Nacht bricht das Explizite Selbstmodell zusammen, und der Tiefschlaf löscht die laufende Simulation. Jeden Morgen fährt sie wieder hoch und baut „dich“ aus dem Impliziten Selbstmodell neu – dem langsamen, gespeicherten Selbst, das der Schlaf zurücklässt. Aber das Substrat hat sich über Nacht verändert: Träume, an die keine Erinnerung bleibt, haben synaptische Gewichte verschoben, Konsolidierung hat Erinnerungen umgeordnet. Wer aufwacht, ist nicht ganz dieselbe Person, die eingeschlafen ist. Der Unterschied ist normalerweise so gering, dass er nie auffällt – aber er ist da, jeden einzelnen Tag.

Zwei Dinge halten „dich“ über diese Drift hinweg mehr oder weniger konsistent: das Implizite Selbstmodell, das sich nur langsam ändert, und der Schlaf, der die Veränderung verbirgt, indem er die Simulation offline nimmt, während sie konsolidiert wird. Triebe man die Drift weit genug – das ISM über Nacht umbauen, die Erinnerungen austauschen, die Persönlichkeitsstruktur umformen –, verschwände das alte „Ich“ nicht. Es würde *aufgesogen*. Das morgendliche ESM setzt aus dem, was überlebt hat, eine durchgehende Erzählung zusammen und webt Altes und Neues nahtlos in eine einzige Geschichte, ohne je die Naht zu bemerken. Das ESM macht keine sauberen Brüche – es näht immer. Nur vollständige Löschung reißt den Faden; solange etwas bleibt, schreibt das „Ich“ von morgen das „Ich“ von heute leise in seine Geschichte und nennt das Ganze ein Leben.

Das also bist du: ein virtuelles Selbst, jede Nacht neu zusammengesetzt, das seine eigene Welt aus dem Inneren einer Schleife fühlt, aus der es nicht herausklettern kann. Womit eine Frage im Raum stehen bleibt. Die Simulation läuft auf einem Substrat, das sich in irgendeinem bestimmten Zustand befindet – aber was *ist* dieser Zustand? Welche physikalische Messerschneide lässt ein paar Pfund verdrahteter Zellen jeden Morgen ein Jemand hochfahren und jede Nacht wieder erlöschen? Genau das bringt das Ganze zum Laufen, und es kommt als Nächstes.
...
Es fehlt noch ein Puzzleteil – und genau dieses hat mich endgültig überzeugt, dass die Theorie stimmt.

Die Vier-Modelle-Architektur ist notwendig für Bewusstsein, aber nicht hinreichend. Es braucht auch die richtige *Dynamik*. Konkret muss das Substrat – das physikalische System, das die Simulation ausführt – in jenem Bereich arbeiten, den Mathematiker und Physiker den **Rand des Chaos** nennen.
...
Ich will dir erzählen, woher dieses Beispiel kommt, denn es ist der Same von allem in diesem Buch. Das Game of Life war das erste richtige Programm, das ich je geschrieben habe – auf einem 286er, als Kind. Dazusitzen und zuzusehen, wie drei Spielzeugregeln in einem Gitter aus toten und lebendigen Pixeln einen funktionierenden Computer zusammensetzten, war für mich als Kind eine der größten Sachen überhaupt, und ich war verwundert, warum „die Erwachsenen“ nicht alle davon wussten. Als ich damals begriff, dass eine höherdimensionale Welt aus einem niederdimensionalen Regelsatz entstehen kann, fühlte es sich an, als müsste es unmöglich sein. Ich wusste damals noch nicht, dass ich dieser einen Intuition noch Jahrzehnte nachgehen würde – oder dass das gefaltete Blatt Kortex hinter meinen eigenen Augen genau denselben Trick ausführt, ein paar Dimensionen höher.

Hier lebt Bewusstsein. Nur Rand-des-Chaos-Dynamiken haben beide Eigenschaften, die es braucht: **universelle Berechnung** (komplex genug, um tatsächlich eine Selbst-Simulation auszuführen) und **globale Integration** (entfernte Teile des Systems beeinflussen einander, lokale Änderungen breiten sich global aus, Information wird zu einem einheitlichen Ganzen verknüpft). Deshalb fühlt sich bewusste Erfahrung *einheitlich* an – Rot wird nicht hier drüben gesehen und eine Stimme da drüben gehört, als getrennte Ströme. Die kritische Dynamik bindet alles zu einer Erfahrung zusammen. Bindung ist nicht etwas, das das Gehirn *zusätzlich zu* seinen anderen Berechnungen leistet, sondern eine Folge des dynamischen Regimes.

Ein Gehirn im Tiefschlaf, durchzogen von langsamen Deltawellen, steckt in periodischer Dynamik: repetitiv, dreht sich im Kreis. Die Modelle sind noch da im Substrat, aber die Simulation läuft nicht. Ein Gehirn im generalisierten Anfall wird von einer Flut gleichzeitiger Mit-Aktivierung über den kritischen Rand gedrückt, die in ein einziges grobes Regime kippt – starre Hypersynchronie, entfesseltes Chaos oder beides im Wechsel –, und die Simulation kann nicht zusammenhalten. Nur im Wachzustand – balancierend am Rand des Chaos – hält das System bewusste Erfahrung aufrecht.

Als universeller Computer, durch Milliarden Jahre Evolution optimiert, nutzt das Gehirn *alle* Berechnungsregimes als verschiedene Werkzeuge: stabile Attraktoren für Langzeitgedächtnis, periodische Oszillationen für Taktung (Alpha-, Theta-, Gammarhythmen), fraktale Verarbeitung für skaleninvariante Erkennung und Texturanalyse (vorwiegend in V2-V4 des visuellen Kortex) und Rand-des-Chaos-Dynamiken für den kortikalen Automaten selbst – die Maschine des Bewusstseins. Nur das Rand-des-Chaos-Regime erzeugt Bewusstsein. Aber Bewusstsein braucht die anderen, um zu funktionieren.
...
Aber es gibt eine entscheidende Feinheit. Kritikalität allein reicht nicht. Ein Sandhaufen, der genau in seinem Schüttwinkel abrutscht, sitzt mitten am Rand des Chaos. Er ist nicht bewusst. Die Theorie verlangt, dass *zwei* Schwellen überschritten werden: die physikalische (das Substrat muss im kritischen Zustand arbeiten) und die funktionale (das Substrat muss die Vier-Modelle-Architektur realisieren). Kritikalität ohne Architektur ergibt komplexe Dynamiken, aber kein Bewusstsein. Architektur ohne Kritikalität ergibt ein ruhendes System – die Modelle existieren im Substrat, aber die Simulation läuft nicht. Beide Schwellen müssen überschritten sein. Zusammen sind sie hinreichend.

Wenn ich über das Gehirn nachdenke, sehe ich keine Formeln. Ich sehe einen Ozean – einen netzförmigen Ozean, wo das Wasser nicht überall hin kann, sondern nur dorthin, wo Verbindungen liegen. Die Neuronen sind die Wasserflächen, die Synapsengewichte sind die Kanäle dazwischen, und die Feuermuster sind die Wellen, die darüberlaufen. Werfe ich einen Stein hinein, breitet sich etwas aus – entlang der Verdrahtung, nicht in gleichmäßigen Kreisen. Und auf diesem Netz-Ozean können sich, wie auf einem Teich, Muster bilden: Wellen, die einander verstärken, stehende Wellen, kleine selbsttragende Formen, die wandern, zusammenstoßen und überdauern. Diese Formen sind die Gleiter. Dort lebt ein Gedanke, oder ein Selbst – als stabiles Muster auf dem Ozean, nicht als ein einzelner Tropfen Wasser.

### Zwei Regler, eine Kante

Es gibt eine Feinheit im Wort *Kritikalität*, die ich lange gebraucht habe, um sie klar zu sehen – und sobald man sie sieht, lösen sich mehrere Rätsel auf einmal. Wenn Leute sagen, ein Gehirn sei „kritisch“, werfen sie meist zwei verschiedene Dinge in ein Wort. Auf dem Netz-Ozean sind es zwei getrennte Regler.

**Regler eins: Wie weit wandert eine Welle?** Drehe ich ihn ganz herunter, ist der Ozean ein gefrorener Spiegel – der Stein fällt, macht *plopp*, und nichts geschieht; ein Kräuseln, das sofort verebbt. Drehe ich ihn ganz auf, peitscht ein einziger Kiesel den ganzen Ozean zum Sturm; eine einzelne Störung überschwemmt alles auf einmal. Dazwischen liegt der optimale Bereich: Die Welle wandert, zeugt im Schnitt eine neue, verebbt nicht und explodiert nicht. Wie ein Sandhaufen, der exakt im Schüttwinkel liegt, bei dem ein weiteres Korn eine Rutschung jeder Größe auslösen kann. Dieser Regler entscheidet über *Reichweite* – wie viel vom Ozean ein einzelnes Geschehen in einen zusammenhängenden Prozess zieht. Nennen wir ihn den **Ausdehnungs**-Regler.

**Regler zwei: Welche Formen können überhaupt auf dem Ozean leben?** Das ist der Game-of-Life-Regler – der, von dem die ganze Theorie abhängt. Ein gefrorener Spiegel hat keine Formen; nichts bewegt sich. Eine sanfte, regelmäßige Dünung hat nur eine Form, dieselbe Welle wieder und wieder – hübsch, aber dumm; sie rechnet nichts. Ein kochendes Chaos lässt jeden Punkt zufällig flackern – auch das rechnet nichts. Nur an der Kante zwischen Ordnung und Kochen entstehen *Gleiter*: stehende Muster, die wandern, zusammenstoßen, überdauern und etwas tun. Dort, und nur dort, kann eine Berechnung – und ein Selbstmodell – als stabile Form auf dem Wasser existieren. Nennen wir ihn den **Komplexitäts**-Regler.

Das klarste Bild für diesen zweiten Regler kenne ich aus der Fliegerei: den Strömungsabriss, den Stall. Ein Flügel erzeugt den meisten Auftrieb genau an der Grenze – im steilsten Winkel, den er halten kann, einen Augenblick bevor die Strömung abreißt und in Turbulenz kippt. Ein Grad darüber löst sich die glatte Strömung auf, und der Auftrieb bricht weg. Das Gehirn fliegt genau an diesem Vor-Stall-Rand: maximale Berechnung, ein Grad bevor die Dynamik ins Chaos kippt. Drückt man darüber hinaus, bricht der „Auftrieb“ – die Fähigkeit, Gleiter zu tragen, zu rechnen, bewusst zu sein – zusammen, so wie der Auftrieb im Stall zusammenbricht.

Meist steigen und fallen die beiden Regler zusammen, weshalb ein Wort gewöhnlich genügt. Aber sie können auseinandertreten, und dann erklären sie die Fälle, die die Ein-Regler-Geschichte nicht erklärt. Ein Topf kochendes Wasser hat den ersten Regler aufgedreht – eine Störung breitet sich überall aus –, aber den zweiten ganz heruntergedreht: keine Gleiter, nur Aufruhr. Viel Ausbreitung, keine Formen und kein Bewusstsein, genau wie zu erwarten.

Ein generalisierter Anfall ist der Fall, der endgültig klarmachte, was der erste Regler wirklich misst. In einem Anfall feuert ein enormer Anteil des Gehirns auf einmal – rein zahlenmäßig „aktiver“ als in jedem normalen Wachmoment. Wäre Bewusstsein bloß „viele aktive Neuronen“, wäre ein Anfall der bewussteste Zustand überhaupt. Es ist das Gegenteil. Diese Flut von Aktivität kippt aus dem Rand-des-Chaos-Regime in eine einzige grobe Form – die ganze Fläche in einen groben Gleichtakt gerissen oder ins entfesselte Chaos geworfen –, und die differenzierte, gleitertragende Berechnung verschwindet. Der erste Regler kann also nicht bloße Mit-Aktivierung messen; er muss messen, wie viel Gehirn in echte Rand-des-Chaos-Dynamik verwickelt ist. In einem Anfall stürzt diese Zahl trotz allen Feuerns ab. Dass viel Gehirn *aktiv* ist, ist nicht dasselbe, wie dass viel Gehirn *bewusst* ist. Diese zwei Regler sollte man im Kopf behalten; die seltsamsten Zustände, in die ein Gehirn geraten kann, sind nur verschiedene Einstellungen von ihnen – später, wenn wir zum verspäteten Beobachter kommen, werden sie erklären, warum manche Menschen in einer halben Sekunde ein ganzes Leben durchleben.
...
Auch Fehlfunktionen des Automaten lassen sich beobachten. Bei einem epileptischen Anfall kippen Teile des Automaten in Klasse-1- oder -2-Dynamiken (periodisch, starr, rechnerisch nutzlos) oder geraten über Klasse 4 hinaus in Klasse-5-Chaos. Ein Schlaganfall bedeutet, dass Teile des Kortex komplett ausfallen. Zu einer Ohnmacht kommt es, wenn die Mindestfrequenz für Wachheit nicht mehr erreicht wird. Der Automat ist fragil. Aber die Struktur, die ihn erzeugt – der Neokortex mit seinen gelernten Gewichten und seiner evolvierten Architektur – ist robust. Deshalb erholen wir uns von diesen Störungen so erstaunlich gut.
...
**Beziehung 1: Ein holografisches Substrat produziert Klasse-4-Dynamiken.** So arbeitet vermutlich das Gehirn. Neuronale Netzwerke sind lokal holografisch – das Patchwork-Hologramm aus Kapitel 3, Lashleys Ratten und all das –, und dieses Substrat produziert, an Kritikalität arbeitend, die Klasse-4-Dynamiken, die Bewusstsein verlangt. Gut belegt, gründlich dokumentiert und – man verzeihe mir – die langweilige Variante.
...
Hier muss Gerard 't Hooft erwähnt werden, weil die Verbindung zu auffällig ist, um sie zu übergehen – auch wenn sie spekulativ bleibt. 't Hooft, Physik-Nobelpreisträger, hat vorgeschlagen, dass die Quantenmechanik selbst ein Zellulärer Automat auf der Planck-Skala ist: dass unser Universum fundamental deterministisch ist und Quanteneffekte emergente Phänomene einer tieferen, diskreten Dynamik sind. Wenn er recht hat, gilt das beschriebene Prinzip nicht nur für Bewusstsein als Analogie. Es ist buchstäblich, wie das Universum funktioniert, bis auf die unterste Ebene. Einfache lokale Regeln erzeugen ein holografisches Universum, und innerhalb dieses Universums erzeugen einfache neuronale Regeln ein holografisches Bewusstsein. Dasselbe Berechnungsprinzip auf zwei Skalen: kosmologisch und neurologisch. Diese fraktale Konsistenz finde ich zutiefst überzeugend – aber ehrlicherweise bleibt 't Hoofts Interpretation eine Minderheitsmeinung in der Physik, und der Schluss von struktureller Eleganz auf physikalische Realität wurde zu Recht kritisiert. Dennoch: Wenn sich herausstellt, dass ein einzelnes Berechnungsprinzip sowohl dem Universum als auch den Geistern, die es modellieren, zugrunde liegt, wäre das die schönste Tatsache, die je entdeckt wurde.

**Beziehung 3: Ein Klasse-4-Automat, dessen Regelstruktur selbst holografisch ist.** Das ist die Variante, bei der ich den Stift weglegen musste. Wenn so etwas existiert – ein Zellulärer Automat, dessen Regeln selbst höherdimensionale Information in einer niedrigerdimensionalen Struktur kodieren, so wie ein Hologramm drei Dimensionen in zwei kodiert –, dann hätte man ein System, das von Natur aus das tut, was laut dem holografischen Prinzip das Universum tut. Kein System, das bloß *auf* einem holografischen Substrat läuft (oder ein Hologramm hervorbringt). Ein System, das *selbst* eine holografische Kodierung *ist*. Möglicherweise ist das unser Universum – wobei das spekulativ bleibt, und der Schluss von mathematischer Schönheit auf physikalische Realität berechtigter Kritik ausgesetzt ist. In Kapitel 14 schärfe ich die Frage und lege dar, warum Beziehung 3 möglicherweise die wichtigste ungelöste Frage der Mathematik ist; die Kapitel 15 bis 17 gehen dann den Antworten nach.
...
Wer Bewusstsein verstehen will, untersucht, was passiert, wenn es aus dem Tritt gerät. Psychedelika sind meiner Überzeugung nach das aufschlussreichste Fenster in die Architektur des Bewusstseins – aufschlussreicher als Hirnscans schlafender Patienten und um Welten zugänglicher als Split-Brain-Chirurgie.
...
**Proteomisch.** Darüber: Proteinstrukturen und molekulare Maschinerie. Die Neuronen selbst – als Zellen mit ihren Membranen, Rezeptoren und innerer Biochemie – bilden eine eigene Organisationsebene, die über der bloßen Elektrochemie liegt. Und zwischen diesen Zellen werden synaptische Gewichte gespeichert – die Stärken der synaptischen Verbindungen, die bestimmen, wie stark ein Neuron das nächste beeinflusst. Enzyme regulieren die Plastizität, molekulare Gerüste entscheiden, welche Synapsen stärker werden und welche schwächer. Das ist die „Hardware“ des Lernens. Wer eine Fähigkeit übt und besser wird, verändert die proteomische Schicht. Immer noch unbewusst, aber jetzt gibt es Gedächtnis.
...
Hier leistet die Fünf-Ebenen-Hierarchie ihre Erklärungsarbeit. Psychedelika greifen in der Mitte des Stapels an, und die Wirkung breitet sich nach oben aus. Klassische Psychedelika wie LSD und Psilocybin binden an Serotonin-2A-Rezeptoren und wirken auf der **elektrochemischen** Ebene – sie verändern, wie Neuronen miteinander kommunizieren. Diese Störung breitet sich zur **proteomischen** Ebene aus, wo sich die Rezeptorempfindlichkeit über Stunden verschiebt. Sie verändert die **topologische** Ebene, wo sich Netzwerkverbindungsmuster umgestalten – im fMRT sichtbar als erhöhte globale Integration. Und sie transformiert die **virtuelle** Ebene, wo die bewusste Simulation mit Inhalt überflutet wird, der normalerweise unsichtbar bleibt. Die einzige Ebene, die klassische Psychedelika nicht berühren, ist die **physikalische** – sie zerstören keine Neuronen, greifen nicht die Materie an. Sie ändern alles *über* der Materie, in aufsteigender Reihenfolge. Das ist eine entscheidende Unterscheidung. Klassische Psychedelika (LSD, Psilocybin, DMT, Meskalin) sind nicht neurotoxisch. Sie ändern, wie Neuronen kommunizieren, ohne sie zu zerstören. Viele andere Drogen sind nicht so gnädig. Methamphetamin und Alkohol zerstören Neuronen physisch; Kokain richtet seinen Schaden eher indirekt an, vor allem indem es Blutgefäße verengt und Nervengewebe von Sauerstoff abschneidet. MDMA in hohen oder wiederholten Dosen schädigt Serotonin-Axone. Sogar Amanita muscaria – der bekannte rot-weiße Pilz, den viele mit psychedelischen Pilzen verwechseln – ist ein Deliriant mit einem völlig anderen, gefährlicheren Wirkmechanismus. Wenn man aus diesem Kapitel nur eines mitnimmt: Nicht alle Drogen, die Bewusstsein verändern, sind gleich, und der Unterschied zwischen „ändert das Signal“ und „zerstört die Hardware“ ist buchstäblich der Unterschied zwischen einem vorübergehend veränderten Zustand und dauerhaftem Hirnschaden. Die dosisabhängige visuelle Stufenfolge bildet sich direkt darauf ab: Niedrige Dosen stören die elektrochemische Ebene gerade genug, um die V1-Verarbeitung zu beeinflussen; höhere Dosen treiben die Störung durch weitere Ebenen und ziehen zunehmend komplexe Verarbeitungsstufen ins bewusste Erleben.
...
Die Zeitdehnung unter Salvia ist gut dokumentiert. Konsumenten berichten, dass eine halbe Sekunde Echtzeit – bestätigt durch anwesende Beobachter – zu etwas wird, das sich wie fünfzehn Minuten oder mehr anfühlt. Die Wahrnehmungswelt baut sich in aufwendige Sequenzen um, einschließlich des Gefühls, Flügel zu haben und herumzufliegen (das Fluggefühl, berichten Betroffene, kommt typischerweise von Luft, die am Körper vorbeiströmt, wenn man rückwärts aufs Bett fällt). Die gesamte Realität kollabiert und regeneriert sich, alles in der Zeit, die ein Blinzeln braucht. Ein gut dokumentierter Bericht handelt von einem Mann, der erlebte, was sich wie acht volle Jahre eines alternativen Lebens anfühlte – Schulbesuch, Freundschaften, der Aufbau einer neuen Existenz –, während einer Salvia-Episode von ungefähr fünfundvierzig Sekunden Uhrenzeit. Peer-reviewte Forschung bestätigt extreme zeitliche Verzerrung unter kontrollierten Bedingungen; ein Teilnehmer beschrieb die Zeit als „gefaltet wie ein Akkordeon“ (Addy et al., 2015). Das Substrat schleust so viel Inhalt so schnell durch die Simulation, dass sich subjektive Zeit vollständig von der Uhrenzeit entkoppelt. Dieselbe Art Zeitdehnung wird auch bei Nahtoderlebnissen beschrieben (den Mechanismus behandelt Kapitel 13) – dort biologisch statt pharmakologisch ausgelöst.
...
Warum das Gehirn so viel Inhalt so schnell durch die Simulation schleusen kann, ist dieselbe Frage wie die, warum ein Sterbender sein ganzes Leben in Sekunden vorüberziehen sieht – und auf beides komme ich in Kapitel 13 gemeinsam zurück, wo sich zeigt, dass sie einen einzigen Mechanismus teilen.

Es lohnt sich zu fragen, warum diese Ecke – beide Regler zugleich hoch, viel Gehirn in ein Geschehen gerissen *und* dieses Geschehen maximal reich – so selten ist. Zwei Dinge verbieten sie normalerweise, und sie ergänzen einander.

Das erste ist schlichte Ökonomie. Beides gleichzeitig zu tun ist metabolisch ruinös; das Gehirn kann es sich nicht länger als für Momente leisten, und das Energiebudget hält die Tür zu. Deshalb braucht es etwas Extremes, um sie aufzustoßen – ein sterbendes Gehirn, dessen metabolische Bremsen versagen, oder eine Substanz, die genau die Regulierung sabotiert, die das Budget rationiert.

Das zweite ist seltsamer, und es ist der Grund, warum sich diese Zustände wie ein Verlassen der Welt anfühlen. Die *innere* Welt des Gehirns hat ungleich mehr Dimensionen als die dünnen Kanäle, die es mit der Wirklichkeit verbinden – zwei Augen, zwei Ohren, die Tastfläche eines Körpers, gegen eine innere Simulation von atemberaubendem Reichtum. Normalerweise reicht dieser schmale Sinneskanal gerade aus, denn er *korrigiert* die innere Simulation ununterbrochen: ein stetiges Rinnsal „so ist es da draußen wirklich“ hält die davonlaufende Vorstellung an die Welt gekettet. Aber dreht man beide Regler hoch, schwillt das innere Geschehen, bis der dünne Eingangskanal es nicht mehr nachregeln kann. Die Simulation überholt ihre eigene Realitätsprüfung und treibt von der Welt ab. Und das Tückische: Es ist der *Ausdehnungs*-Regler, der das tut – je mehr Gehirn nach innen gerissen wird, desto stärker überflutet das innere Geschehen genau den schmalen Kanal, der die Simulation an die Welt gekettet hält.

Bleibt eine Umkehrung, die ich noch immer verblüffend finde. Diese Ecke ist zugleich *Spitzenbewusstsein und minimaler Realitätskontakt* – die meiste Verarbeitung, die wenigste Welt. Genau deshalb fühlen sich die Zustände mit beiden Reglern oben (der Lebensfilm im Angesicht des Todes, der hochdosierte Salvia-Sturz, die tiefsten psychedelischen Versenkungen, die lebhaftesten Träume) am stärksten von der Realität abgekoppelt an. Sie sind abgehoben, gerade *weil* sie so intensiv sind.
...
Das ist wichtig, weil es zeigt: Bewusstsein braucht kein *korrektes* Selbstmodell. Es braucht nur *ein* Selbstmodell. Die Architektur läuft weiter, so oder so. Das Explizite Selbstmodell schaltet sich nicht ab, wenn es absurden Input bekommt – es baut das beste Selbst, das es kann, aus den verfügbaren Signalen. Dasselbe Prinzip zeigt sich beim Cotard-Wahn (das ESM arbeitet mit fehlenden interozeptiven Signalen: „Ich muss tot sein“), beim Anton-Syndrom (das EWM generiert Sehen aus Erinnerung, wenn die Augen versagen) und bei der Konversionsstörung (das ESM modelliert eine Lähmung, die das Substrat gar nicht hat). Das Selbstmodell ist ein zwanghafter Konstrukteur. Es hört nie auf zu bauen. Es erklärt nie, die Daten seien unzureichend. Es baut einfach und glaubt.

### Anosognosie: Die Umkehrung

Hier zeigt sich eine Symmetrie. Wenn Psychedelika das sind, was passiert, wenn die implizit-explizit-Grenze *zu* durchlässig wird, ist Anosognosie das, was passiert, wenn sie *zu* undurchlässig wird – zumindest lokal.
...
Wie sich diese heruntergefahrene Simulation von innen anfühlt, kenne ich gut. Zwischen etwa sieben und zwölf Jahren hatte ich einen wiederkehrenden Traum – über all die Jahre hinweg denselben. Es war eine Landschaft, wenn man es so nennen will: eine unendlich ausgedehnte fraktale Struktur mit Tälern, die endlos in die Tiefe stürzten, selbstähnlich auf jeder Ebene, in die man blickte. Dazu ein Gefühl, das mir im Wachzustand nie begegnet ist – eine tiefe Entkörperung, als hätte man mir den Körper weggenommen und mich in die Geometrie selbst hineinversetzt. Der Traum war unheimlich, befremdlich, aber auch seltsam faszinierend. Ich wollte, dass er wiederkam, selbst wenn er mich erschreckte.
...
Was geschah in diesem Traum? In der Sprache der Theorie: Das Explizite Weltmodell, abgeschnitten vom äußeren Input, erzeugte Inhalte aus der eigenen Rechendynamik des Substrats. Und was ist diese Dynamik? Klasse 4 – die Klasse 3 (fraktale Struktur) als Teilprozess enthält. Ein schlafendes Gehirn, dessen Simulation nur auf der eigenen Architektur läuft, produzierte die visuelle Signatur dieser Architektur: Fraktale. Die Entkörperung war das Explizite Selbstmodell in seiner am stärksten degradierten Form – die Simulation wusste, dass sie *jemand* war, irgendwo, aber die Körperrepräsentation war fast vollständig ausgefallen.

Ich habe nie versucht, diesen Traum heraufzubeschwören, nachdem ich Jahre später das luzide Träumen gelernt hatte. Vielleicht sollte ich es versuchen.

Schlafwandeln ist eine noch dramatischere Demonstration. Beim Schlafwandeln reaktiviert sich das motorische System teilweise, während das Explizite Selbstmodell inaktiv oder nahezu inaktiv bleibt. Das Substrat führt motorische Programme aus – Gehen, Navigieren, sogar komplexe Handlungen –, aber die Simulation läuft nicht mit. Der Schlafwandler bewegt sich durch die physische Welt, geleitet vom räumlichen Wissen des Impliziten Weltmodells, aber ohne bewusste Erfahrung – oder fast ohne.

Schlafwandler berichten davon immer wieder. Jemand wacht am Schreibtisch auf, vor sich hingekrakelte Notizen – linkshändig geschrieben, was im Wachzustand nie vorkommt. Ein fragmentarisches Bild ist noch da: im Kreis an den Wänden entlang, die Tür suchend, sie nicht findend. Aber die Phase, in der er zum Schreibtisch ging und die Hand zu schreiben begann – vollständig dunkel. Das Substrat navigierte, motorische Programme liefen, aber die Simulation – das „Ich“ – war nicht da.

Das ist die Theorie im Kleinen. Ein Körper, der sich durch die Welt bewegt, räumliche Informationen verarbeitet, gelernte motorische Programme ausführt – alles ohne ein bewusstes Selbst in der Schleife. Die impliziten Modelle führen Regie. Die expliziten Modelle sind abgeschaltet. Und das Ergebnis ist ein Mensch, der geht, handelt und sogar schreibt – aber da ist niemand.
...
Luzides Träumen lernen heißt, die Simulation beim Schummeln zu erwischen. Eine bewährte Methode ist der Lichtschalter-Test: Man betätigt den ganzen Tag über gewohnheitsmäßig Lichtschalter und fragt sich, ob das Licht sich korrekt verändert hat. Im Wachleben verändert es sich immer. Im Traum funktionieren Lichtschalter nicht – das Explizite Weltmodell, das auf internen Daten läuft, verschwendet keine Rechenzeit für die Physik elektrischer Schaltkreise. Betätigt man im Traum einen Schalter und das Licht verändert sich nicht, oder der Raum wird dunkler, oder der Schalter fühlt sich falsch an – diese Diskrepanz ist das Explizite Selbstmodell, das eine Inkonsistenz in der Simulation erkennt. Und in dem Moment der Erkennung ist klar: Das hier ist ein Traum.

Die meisten brauchen Wochen oder Monate, bevor die Gewohnheit in ihre Träume übergeht. Aber wenn es funktioniert, ist der Übergang genau die sprunghafte Schwelle, die die Theorie vorhersagt. Eben noch ist man passiver Statist in der Erzählung des Traums. Und dann, schlagartig, voll präsent – im Bewusstsein, dass man träumt, dass die Welt ringsum generiert ist, dass man sie verändern kann. Das ESM hat sich zugeschaltet. Am Substrat hat sich nichts geändert. An der Dynamik hat sich nichts geändert. Aber die Einbindung des Selbstmodells in die Simulation hat eine Schwelle überschritten, und alles fühlt sich anders an.

Die Theorie sagt vorher, dass dieser Übergang einer Überschreitung der Kritikalitätsschwelle entspricht. Kein graduelles Anschwellen der Gehirnkomplexität, sondern ein plötzlicher Sprung. Mäße man die EEG-Komplexität in einem engen Zeitfenster um den Moment, in dem die Luzidität einsetzt – mit dem etablierten Paradigma vorher vereinbarter Augenbewegungssignale luzider Träumer –, müsste sich eine Diskontinuität zeigen.

### Anästhesie: Die zwei Typen

Anästhesie liefert den saubersten Test des Kritikalitätsprinzips, weil verschiedene Anästhetika dramatisch unterschiedliche Erfahrungen hervorrufen, obwohl sie denselben Namen tragen.

**Propofol** schiebt das Gehirn in den subkritischen Bereich. Die thalamokortikale Konnektivität bricht ab, die kortikale Komplexität kollabiert, und der PCI nähert sich null. Die Lichter gehen vollständig aus. Patienten berichten von keinerlei Erfahrung unter Propofol. Genau das sagt die Theorie voraus: Fällt die Dynamik unter die Kritikalität, kann die Simulation nicht aufrechterhalten werden.

**Ketamin** macht etwas völlig anderes. Es lässt das Gehirn *nicht* unter die Kritikalitätsschwelle fallen. EEG-Studien zeigen, dass Ketamin die neuronale Entropie *erhöht* – es schiebt das Gehirn an die Kritikalität heran oder darüber hinaus, in einen chaotischeren Bereich. Das Ergebnis ist das „K-Hole“ – lebhafte, oft bizarre Erfahrungen von Dissoziation, verzerrter Realität, Erlebnissen außerhalb des eigenen Körpers und radikaler Identitätsauflösung.
...
Diese Unterscheidung – Propofol hebt Bewusstsein auf, indem es das Gehirn unter die Kritikalitätsschwelle zwingt; Ketamin verändert Bewusstsein, indem es die Dynamik über die Schwelle hinaus in den superkritischen Bereich verschiebt, bei gleichzeitig gestörtem Input – ist ein echter Erklärungsvorteil. Die meisten Theorien tun sich schwer zu erklären, warum zwei „Anästhetika“ so radikal unterschiedliche Erfahrungen produzieren. Der Kritikalitätsrahmen trifft die Unterscheidung mühelos.

Ich hatte noch nie eine chemische Narkose. Aber ich wurde bewusstlos geschlagen – hart, plötzlich, ohne Vorwarnung. Und was mir im Rückblick auffällt, ist die totale Abwesenheit eines Übergangs. Schlaf hat Stadien. Psychedelika haben eine Anstiegskurve. Selbst Salvia, so schnell es wirkt, gibt einem den Bruchteil einer Sekunde „Etwas passiert“. Ein K.o. gibt nichts. Gerade läuft die Simulation noch. Dann erwacht man auf dem Boden, ohne Ahnung, wie viel Zeit vergangen ist. Kein Verdunkeln, kein Verblassen, kein Tunnel. Die Simulation verschlechtert sich nicht. Sie bricht ab. Der Schutzschalter springt.

Genau das wäre bei einer plötzlichen, massiven Störung der kortikalen Dynamik zu erwarten – ein augenblickliches Abfallen weit unter die Kritikalität. Keine Zeit für ein sanftes Herunterfahren durch die Schlafstadien. Das System durchläuft nicht den Weg von Klasse 4 über Klasse 3 nach Klasse 2. Es stürzt aus Klasse 4 ab, und die Simulation hört einfach auf.

### Die Bewusstseins-Karte

| Zustand | Kritikalität | Modelle | Bewusstsein |
|---------|-------------|---------|-------------|
| Normales Wachen | Kritisch | Alle vier aktiv | Voll |
...
| Psychedelika | Kritisch/überkritisch | Alle aktiv, ↑ Permeabilität | Präsent, verändert |
...
Wenn die Theorie etwas taugt, dann sollte Schaden an bestimmten Modellen bestimmte, vorhersagbare Defizite erzeugen. Kein vages Gerede von „beeinträchtigtem Bewusstsein“, sondern präzise Vorhersagen: Schaltet man diese Komponente aus, entsteht *jenes* Syndrom. Hält man eine andere ohne ihren normalen Input am Laufen, entsteht *dieses* andere Syndrom. Die klinische Literatur ist voll von Zuständen, die unter gängigen Bewusstseinsmodellen zutiefst rätselhaft bleiben, sich aber wie von selbst einordnen, sobald man eine Real/Virtuell-Unterscheidung und vier interagierende Modelle zur Verfügung hat.

**Blindsight und Anton-Syndrom: Der perfekte Spiegel**

Wenn man aus diesem Kapitel nur ein Beispiel mitnimmt, dann dieses Paar. Andere Bewusstseinstheorien tun sich schwer, auch nur einen dieser Zustände zu erklären. Die Vier-Modelle-Theorie sagt beide vorher.

Zunächst Blindsight. Ein Patient hat eine Schädigung des primären visuellen Kortex – jenes Teils des Gehirns, der bewusste visuelle Erfahrung erzeugt. Nach jedem klinischen Standardtest ist der Patient blind. Fragt man ihn, was er sieht, sagt er: nichts. Und er meint es ernst. Er ist weder bescheiden noch verwirrt. Soweit seine bewusste Erfahrung reicht, existiert die visuelle Welt schlicht nicht.
...
Und er navigiert den Hindernisparcours makellos. Er weicht Stühlen aus, duckt sich unter eine Barriere, die beim letzten Mal nicht da war, schlängelt sich durch eine Lücke zwischen zwei Hindernissen – und besteht dabei aufrichtig darauf, keinen Deut sehen zu können. Es gibt Videos davon, und es lohnt sich, danach zu suchen, denn bloßes Lesen wird dem Phänomen nicht gerecht. Das Filmmaterial eines klinisch blinden Mannes, der sich durch einen Hindernisparcours schlängelt, als könne er perfekt sehen, gehört zu den verblüffendsten Demonstrationen, die die Neurowissenschaft zu bieten hat. Die zuschauenden Forscher sehen aus, als hätten sie ein Gespenst gesehen.

Wie ist das möglich? Weil das Substrat nach wie vor visuelle Informationen verarbeitet. Das Implizite Weltmodell erhält visuellen Input über subkortikale Pfade, die den beschädigten Kortex umgehen – eine schnelle Route von der Retina über den Colliculus superior zum Pulvinar, die sich lange vor dem Kortex entwickelt hat. Es baut eine räumliche Karte, steuert motorisches Verhalten, hält den Körper davon ab, mit Gegenständen zu kollidieren. Aber nichts davon erreicht das Explizite Weltmodell. Die bewusste Simulation enthält kein Sehen. Der Patient erlebt wirklich Blindheit – und navigiert wirklich durch Sehen. Das Substrat arbeitet ohne die Simulation.

Jetzt das Gegenstück. Das Anton-Syndrom (Anosognosie für kortikale Blindheit) ist das exakte Gegenteil. Diese Patienten sind vollständig blind. Ihr visueller Kortex oder ihre optischen Bahnen sind zerstört. Keinerlei visuelle Information erreicht das Gehirn. Aber sie sind unerschütterlich überzeugt, dass sie sehen können.

Sie laufen gegen Wände und beschuldigen die Möbel, am falschen Platz zu stehen. Sie beschreiben Gegenstände, die gar nicht im Raum sind, mit vollem Brustton der Überzeugung – „Da ist eine blaue Vase auf dem Tisch“, wenn der Tisch leer ist. Bittet man sie zu benennen, was man hochhält, kommt ohne Zögern eine Antwort, ruhig und selbstsicher – und sie wird falsch sein. Konfrontiert mit Beweisen für ihre Blindheit, werden sie erst verwirrt, dann gereizt, dann wütend. Die Beleuchtung sei schlecht. Sie bräuchten eine neue Brille. Sie hätten nur nicht aufgepasst. Sie lügen nicht. Sie leugnen nicht im psychologischen Sinn. Sie *sehen* wirklich, im Erleben – und was sie sehen, hat keinerlei Bezug zur tatsächlichen Welt.

In der Vier-Modelle-Theorie ist genau das zu erwarten: Das Explizite Weltmodell generiert eine visuelle Simulation aus dem gespeicherten Wissen des Impliziten Weltmodells – obwohl kein aktueller visueller Input eintrifft. Die Simulation läuft auf alten Daten, auf Erwartungen, auf der besten Annahme des Gehirns, wie die Welt aussehen sollte. Der Patient „sieht“ eine Welt, die nicht da ist. Die Simulation läuft ohne aktuellen Input.

Nebeneinandergestellt: Blindsight – das Substrat verarbeitet Sehen, aber die Simulation zeigt es nicht. Anton-Syndrom – die Simulation zeigt Sehen, aber das Substrat empfängt nichts. Substrat ohne Simulation. Simulation ohne Input. Beide Zustände sind zutiefst rätselhaft, wenn man Bewusstsein als eine einzige, einheitliche Sache betrachtet. Aus einer Theorie, die zwischen realer Verarbeitung und virtueller Erfahrung unterscheidet, folgen sie dagegen zwanglos, ja vorhersagbar. Ein aufschlussreicheres Paar von Testfällen ließe sich kaum finden.

**Verborgenes Bewusstsein: Eingesperrt im eigenen Körper**

Im Jahr 2006 veröffentlichten Adrian Owen und Kollegen eine Studie, die das Verständnis des vegetativen Zustands grundlegend veränderte. Sie legten eine Patientin, die als vegetativ diagnostiziert worden war – nicht ansprechbar, anscheinend bewusstlos –, in einen fMRT-Scanner und baten sie, sich vorzustellen, Tennis zu spielen. Ihr Gehirn leuchtete in exakt demselben Muster auf wie das einer gesunden bewussten Person bei derselben Vorstellung.
...
Der Perturbational Complexity Index (dasselbe Maß, das Schlafstadien unterscheidet) sollte genau diese Fälle auseinanderhalten. Und genau das leistet er. Einige Patienten, die als vegetativ diagnostiziert wurden, zeigen PCI-Werte mitten im bewussten Bereich. Sie sind keineswegs vegetativ. Sie sind Gefangene. Die medizinischen und ethischen Folgen sind enorm – und die Vier-Modelle-Theorie sagt genau vorher, warum die Unterscheidung existiert und wie man sie erkennt.

**Cotard-Wahn: „Ich bin tot“**

Manche Patienten wiederum glauben, sie seien tot.
...
Spult man das Kapitel zurück, kommt immer dieselbe Gestalt zum Vorschein. Blindsight und Anton-Syndrom, Cotard-Wahn und Charles-Bonnet, der eingeschlossene Patient und das Déjà-vu, das zu gut passt – jeder Fall ist die Naht zwischen Substrat und Simulation, weit genug aufgehebelt, dass man hindurchsehen kann. Ein gesundes Gehirn hält die beiden bündig, so bündig, dass man nie auf den Verdacht kommt, es seien zwei. Zieht man sie in irgendeine Richtung auseinander – Substrat ohne Simulation, Simulation ohne Substrat, eine Simulation, die auf dem falschen Input läuft oder auf gar keinem –, dann hört die Real/Virtuell-Unterscheidung auf, eine philosophische Behauptung zu sein, und wird zur Diagnose. Jeder Ausfall bisher war Schaden an einem einzelnen Gehirn. Der nächste ist überhaupt kein Schaden: Er ist ein sauberer Schnitt mitten hindurch, der aus allem zwei macht.

---
## Kapitel 9: Zwei Bewusstseine in einem Gehirn

In den 1960er Jahren nahm eines der dramatischsten Experimente der Neurowissenschaft seinen Lauf. Um schwere Epilepsie zu behandeln, durchtrennten die Chirurgen Philip Vogel und Joseph Bogen das Corpus callosum – das dicke Faserbündel, das die beiden Gehirnhälften verbindet –, und Roger Sperry und Michael Gazzaniga untersuchten anschließend die daraus hervorgehenden Patienten. Das Ergebnis: das Split-Brain-Syndrom. Eine Person mit offenbar zwei unabhängigen Bewusstseinen.
...
Die Experimente gingen weit über Kuriositäten hinaus. In manchen Fällen kämpften die Hemisphären offen gegeneinander. Ein Patient berichtete, seine linke Hand knöpfe sein Hemd auf, während die rechte es wieder zuknöpfte. Bei einem anderen griff die linke Hand während eines Streits nach seiner Frau – nicht um sie zu trösten –, während die rechte die linke packte und zurückzog. Der Patient schaute entsetzt zu, wie zwei Teile seines Körpers unvereinbare Ziele verfolgten, keines unter einheitlicher Kontrolle. Das sind keine Metaphern für inneren Konflikt, sondern physische Kämpfe zwischen zwei motorischen Systemen, die sich nicht mehr koordinieren können, weil das Kabel dazwischen durchtrennt wurde.

Im Alltag funktionieren Split-Brain-Patienten erstaunlich gut. Außerhalb des Labors fällt selten etwas Ungewöhnliches auf. Die beiden Hemisphären lernen, über Umwege zu kooperieren – äußere Hinweise, Körperbewegungen, gemeinsame Gesichtsfelder. Das System kompensiert. Doch unter kontrollierten Laborbedingungen, wo jede Hemisphäre unterschiedliche Informationen erhält, zerfällt die Einheit. Zwei Bewusstseine entstehen aus einem Gehirn, jedes mit eigenen Wahrnehmungen, eigenen Absichten und einer eigenen Version der Realität.

### Der Interpret der linken Hemisphäre
...
Das ist wieder das Patchwork-Hologramm aus Kapitel 3: Halbiert man es, erhält man nicht zwei halbe Bilder, sondern zwei vollständige, jedes nur unschärfer. Neuronale Netzwerke tun dasselbe, und genau deshalb bleibt jede Hemisphäre eine vollständige, wenn auch geminderte Kopie.

Deshalb sind Split-Brain-Patienten nicht einfach „zwei halbe Bewusstseine“. Sie sind zwei *vollständige, aber degradierte* Bewusstseine. Jede Hemisphäre kann wahrnehmen, entscheiden und handeln – nur mit weniger Information und weniger Kapazität als das intakte System. Die holographische Eigenschaft stellt sicher, dass Trennung degradiert, ohne zu zerstören. Und sie erklärt Pintos Ergebnisse von 2017: Selbst ohne Callosum behält jede Hemisphäre genug holographische Information, um viele Aufgaben zu bewältigen, die nach dem klassischen Modell unmöglich sein sollten.

Die Konfabulation des Links-Hemisphären-Interpreten ist wieder derselbe zwanghafte Konstrukteur aus Kapitel 8 – das ESM, das aus dem verfügbaren Input die bestmögliche Selbsterzählung baut. Ist der Input unvollständig oder verzerrt, ist die Erzählung falsch, aber *fühlt sich trotzdem vollkommen real an*.

### Ein Gehirn, multiple Selbste

Das Split-Brain zeigt, was passiert, wenn die virtuellen Modelle durch physisches Teilen des Substrats *geklont* werden. Dissoziative Identitätsstörung zeigt, was passiert, wenn sie *aufgespalten* werden.

Bei DID ist das Substrat nicht geteilt – das Corpus callosum ist intakt, die neuronale Hardware unversehrt. Aber die virtuellen Modelle haben sich in mehrere Konfigurationen aufgespalten. Jede Teilpersönlichkeit ist ein eigenständiges Explizites Selbstmodell – eine separate Selbsterzählung mit eigenem emotionalem Profil, eigenen Verhaltensmustern, eigener Art, sich auf Körper und Welt zu beziehen. Die Teilpersönlichkeiten teilen sich kein gemeinsames Selbstmodell, genauso wenig wie zwei Benutzer eine einzige Login-Sitzung auf demselben Computer teilen. Sie wechseln sich ab.

Der Auslöser ist in praktisch jedem dokumentierten Fall schweres, wiederholtes Kindheitstrauma. Das ergibt innerhalb der Theorie Sinn. Das Explizite Selbstmodell eines kleinen Kindes formt sich noch – ist noch plastisch, wird noch aus Erfahrung zusammengesetzt. Wird dieses sich entwickelnde Selbstmodell Erfahrungen ausgesetzt, die so überwältigend sind, dass keine einzelne Selbsterzählung sie fassen kann, tut das System das Einzige, was es kann: Es spaltet sich auf. Es erstellt separate Konfigurationen, jede fähig, einen anderen Aspekt der unerträglichen Situation zu handhaben. Eine Teilpersönlichkeit trägt die Trauma-Erinnerungen. Eine andere funktioniert im Alltag, als wäre nichts geschehen. Eine dritte übernimmt in Gefahrenmomenten. Die Aufspaltung ist keine Pathologie – sie ist die Notfallreaktion des Selbstmodellierungssystems auf Input, der ein einzelnes vereinheitlichtes Modell sprengen würde.

Deshalb entwickelt sich DID fast nie bei Erwachsenen. Das Implizite Selbstmodell eines Erwachsenen ist bereits konsolidiert – die synaptischen Gewichte sind gesetzt, die Persönlichkeitsstruktur stabil. Ein erwachsenes Selbstmodell aufzuspalten erfordert außergewöhnliche Umstände: schwere Folter, langandauernde Gefangenschaft. Aber das ISM eines Kindes wird noch geschrieben. Der Ton ist noch nass. Wird er unter genügend Druck aufgespalten, härten die separaten Konfigurationen zu eigenständigen, persistenten Selbstmodellen aus.
...
Etwas später wurde klar, was er gesagt hatte. Er schwamm zurück an die Grenze der Sichtweite und kehrte mit seiner Partnerin und seinem Kalb zurück, führte sie an uns vorbei – damit sie einen Blick auf die seltsamen Vierbeiner werfen konnten. Natürlich hatten alle Kameras dabei. Kein einziges Foto wurde gemacht. Und alle hatten keine Luft mehr und mussten auftauchen. Auf dem Schlauchboot zurück zum Schiff hatte jeder Tränen in den Augen, und es lag nicht am Wind.

Gewissheit ist kein Beweis. Jeder am Boot war sich sicher, gerade jemandem begegnet zu sein – aber eine Geschichte über Tränen im Schlauchboot überzeugt keinen Skeptiker, und sie sollte es auch nicht. Wenn der Orca wirklich jemand war, dann muss eine Theorie sagen können, *warum* – aus Gründen, die noch tragen, wenn dem Taucher die Luft ausgeht und die Rührung verflogen ist. Und sie muss sagen, wo das Jemand-Sein aufhört.
...
Die FMT liefert klare Antworten – und zwar solche, die sich zwingend aus den Grundannahmen ergeben, nicht nachträglich angeheftet wurden.
...
Was bringt das? Dieser Gradient ist nicht nur abstrakte Philosophie. Er beantwortet die Frage, die bei jeder Abendgesellschaft gestellt wird – „Hat mein Hund Bewusstsein?“ Die Antwort ist ja, aber weniger als wir selbst. Der Hund ist wahrscheinlich auf der einfach erweiterten Ebene. Er hat ein Selbst. Er hat Erfahrung. Aber er liegt nicht um 3 Uhr morgens wach und hinterfragt die Natur dieser Erfahrung. Das Muster ist jedenfalls erkennbar: Bewusstsein ist kein Lichtschalter. Es ist ein Dimmer.

Hinter diesen Annahmen steht ein altes Prinzip, das ich aus Kapitel 1 schuldig geblieben bin. **Das Kopernikanische Prinzip:** Wir sind nicht besonders. Kopernikus verdrängte die Erde aus dem Zentrum des Kosmos, und dieselbe Zurückstufung zieht sich seither durch die Wissenschaft – die Sonne ist nicht besonders, unsere Galaxie ist nicht besonders, und, am unbequemsten für viele, *wir* sind nicht besonders. Bewusstsein ist kein einzigartiges Wunder, kein einmaliger göttlicher Funke, kein so seltenes emergentes Phänomen, dass es nur einmal geschehen konnte. Wenn du es hast, können andere Systeme es auch haben – sofern sie die richtige Architektur besitzen. Genau deshalb kann dieses Kapitel überhaupt existieren: Der Mensch ist keine Magie, nur eine Implementierung eines allgemeinen Rechenprinzips. Was die naheliegende Frage aufzwingt – wer sonst führt es aus?

Zusammengenommen sagen diese Annahmen einen **Gradienten tierischen Bewusstseins** voraus:

**Säugetiere** sind bei Bewusstsein. Ihr Cortex implementiert die Vier-Modelle-Architektur in abgestufter Form, wobei komplexere Cortices anspruchsvollere Selbstsimulationen tragen. Primaten und Wale liegen am oberen Ende, Nagetiere und Spitzmäuse am unteren. Alle liegen über der Schwelle. Der Orca, mit dem dieses Kapitel beginnt, saß an genau diesem oberen Ende – mit einem Selbstmodell reich genug, um seine Familie zu holen, damit auch sie die seltsamen Vierbeiner zu sehen bekam, und um zu entscheiden, ob wir den Umweg wert waren.

Die Evidenz von Menschenaffen ist besonders verheerend für jeden, der eine scharfe Grenze zwischen menschlichem und tierischem Bewusstsein ziehen möchte. Der Bonobo Kanzi demonstrierte nicht nur Sprachverständnis, sondern echte Empathie, Theory of Mind und soziales Denken. In einer gut dokumentierten Episode teilte Kanzi seiner Betreuerin mit, dass seine Schwester bei einem Einkaufstrip mitkommen solle, damit auch sie Eis bekomme – weil sie traurig wäre, wenn man sie zurückließe. In einem anderen Fall, während einer Tanzaufführung indigener Künstler, erklärte Kanzi den Forschern, dass die anderen Primaten durch den Tanz verängstigt seien, und bat um eine Privatvorführung.

Das sind keine Reflexe, keine konditionierten Reaktionen, sondern Beispiele eines Geistes, der den emotionalen Zustand eines anderen Geistes modelliert, Reaktionen vorhersagt und Pläne formuliert, um darauf einzugehen. Das ist das Explizite Selbstmodell, das aus der Dritte-Person-Perspektive arbeitet – genau das, was die Theorie als Kennzeichen erweiterten Bewusstseins identifiziert.

Trotzdem lassen sich in einigen der renommiertesten Universitätshörsäle immer noch Professoren finden, die mit ernster Miene argumentieren, Menschenaffen würden Sprachverständnis „nur simulieren“. Worauf man nur antworten kann: „Und Sie täuschen nur Empathie vor.“ Die Gegenbeweise lassen auf sich warten.

Wer darauf besteht, dass nur Menschen Bewusstsein besitzen, wettet auf jene Forscher, die immer noch verzweifelt nach einem systematischen Unterschied zwischen Menschen- und Primatengehirnen suchen, den sie dem Bewusstsein zuschreiben können. Laut dieser Theorie werden sie ihn am 30. Februar finden.
...
Die Entwicklungstrajektorie bildet sich auf die abgestuften Bewusstseinsebenen aus diesem Kapitel ab:

- **Neugeborenes (erste Wochen):** Einfaches Bewusstsein – ein rudimentäres EWM mit minimalem ESM. Es gibt *etwas, wie es ist*, ein Neugeborenes zu sein, aber das Selbst in dieser Erfahrung ist fast nicht existent. Überwiegend sensorisch, undifferenziert.
...
- **18 Monate:** Der Spiegeltest. Das Kind erkennt sich in einem Spiegel – ein Meilenstein, ab dem das ESM reich genug ist, das physische Selbst als Objekt in der Welt zu modellieren. Einfach erweitertes Bewusstsein erwacht. Kein binärer Schalter, sondern eine Schwelle in einem kontinuierlichen Prozess.
...
Und die Konversionsstörung ist wie das Blindsight-Syndrom aus Kapitel 8, nur umgekehrt. Dort verarbeitete ein intaktes Substrat, was die Simulation nicht zeigte; hier zeigt die Simulation ein Defizit, das im Substrat gar nicht existiert. Der Patient ist wirklich gelähmt, soweit seine Erfahrung reicht – er täuscht nichts vor –, während seine Nerven leiten, seine Muskeln kontrahieren, die Bahnen intakt sind. Das Körpermodell des ESM meldet ein totes Glied, und der Arm gehorcht dieser Meldung, obwohl an ihm nichts kaputt ist. Die Therapie gelingt in dem Moment, in dem sich die Simulation wieder an das anpasst, was das Substrat kann.

Ob KVT, Exposition, Placebo oder die Korrektur einer Konversionslähmung – im Kern läuft überall dasselbe wie am Bett des Kindes: Es wird Erfahrung geliefert, an der sich die impliziten Modelle neu eichen. Nur bezahlt man dafür als Erwachsener pro Stunde.
...
Der Raum ist präpariert. Zwei Lautsprecher, links und rechts der Couch. Ein Lichtpaneel an der Decke, das gerade blau leuchtet, ein sattes, tiefes Blau. Auf der Couch liegt ein Mann, Ende dreißig, die Augen geschlossen. Zwei Forschende sitzen daneben und sagen nichts. Aus den Lautsprechern kommt das Meer – kein dezentes Wellenrauschen aus einer Entspannungs-App, sondern Brandung, laut genug, dass sie im Brustkorb steht. Vor vierzig Minuten hat er eine hohe Dosis Psilocybin bekommen.
...
Wochen später, derselbe Mann, dieselbe Dosis auf das Milligramm genau. Nur der Raum ist ein anderer. Aus den Lautsprechern kommt kein Meer, sondern Vögel, ein dichtes, hohes Morgenzwitschern; das Paneel leuchtet grün. Wieder vierzig Minuten, wieder franst der Rand aus, wieder greift das Selbstmodell nach dem Lautesten. Diesmal berichtet er nicht vom Wasser. „Ich war der Wald.“ Gleiches Molekül, gleiches Gehirn, gleiche Dosis. Anderer Raum, anderer Gott.

Dieser Durchgang ist heute machbar, in jedem psychedelischen Forschungslabor, das eine kontrollierte Dosis hat und einen Raum mit einem Regler für das Licht und einem für den Ton. Man variiert den dominanten Sinnesreiz von Durchgang zu Durchgang und misst, wie genau der berichtete Identitätsinhalt ihm folgt. Mehr braucht es nicht. Andere Bewusstseinstheorien sagen das nicht voraus; sie haben keinen Grund dafür, warum ausgerechnet das blaue Licht und nicht der eigene Name das „Ich“ füllen sollte.

Und wenn es klappt – wenn der Inhalt dem Reiz gehorcht, sauber und wiederholbar –, dann ist dein „Ich“ eine Simulation mit einem Eingang, an den jemand von außerhalb deines Schädels herankommt. Unheimlich, aber im genauen Sinn des Wortes: unheimlich wie ein Schlüsseldienst, der dir ruhig und ohne Eile vorführt, dass deine Haustür nie der einzige Weg herein war.

Das war eine von neun. Eine Theorie, die alles erklärt und nichts vorhersagt, ist keine Theorie, sondern eine Geschichte – und die Vier-Modelle-Theorie redet sich nicht damit heraus. Neun scharf umrissene Vorhersagen, jede falsifizierbar, mehrere schon mit heutiger Technik prüfbar, einige bereits mit ersten Belegen unterfüttert. Widerlegt ist bislang keine. Das ist kein Triumph, nur die Eintrittskarte: Eine Theorie, die man umbringen kann, ist überhaupt erst eine.
...
Wenn die Vier-Modelle-Theorie (FMT) richtig ist, bietet sie etwas, das keine andere Bewusstseinstheorie bietet: eine technische Spezifikation.
...
Aktuelle KI-Systeme erfüllen diese Spezifikation in keiner relevanten Hinsicht. Und genau hier richten die zwei Dogmen aus Kapitel 1 ihren Schaden an. Das nAGI-Dogma („keine starke künstliche Intelligenz“) sagt Ingenieuren, sie sollen es gar nicht erst versuchen. Das nSV-Dogma („kein Selbstverständnis“) sagt ihnen, es könnte nicht funktionieren, selbst wenn sie es täten. Beide liegen falsch. Die Spezifikation existiert. Die Frage ist, ob jemand sie umsetzt.

Bevor wieder jemand Gehirne und Computer gleichsetzt, ein kurzer Test:

*Ein Computer wird diesen Satz und den folgenden Satz wiederholen, bis ans Ende aller Tage. Bitte den vorherigen Satz lesen.*
...
Und jetzt kommt, was sogar denen zu denken geben sollte, die sich kein bisschen für Bewusstsein interessieren – denen, die nur Leistungsfähigkeit wollen. Auf dem Weg, den gerade alle einschlagen, kommt man nicht dorthin.

Die aktuelle Strategie lautet: Skaliere einen Textprädiktor so lange, bis am anderen Ende Intelligenz herausfällt. Wird sie nicht. Nicht weil die Modelle zu klein wären, sondern weil ihnen der Motor fehlt. Echte Intelligenz – die offene Art, die sich ihre eigenen Probleme stellt und ein Leben lang weiterwächst – läuft auf einem rekursiven Kreislauf, und dieser Kreislauf dreht sich nur, wenn ihn etwas immer wieder befeuert. Dieses Etwas ist Motivation: Neugier, das Bedürfnis zu wissen, ob man die Sache *wirklich* versteht, die Entscheidung, was die Mühe wert ist. Und Motivation, so wie wir sie erleben, ist kein freischwebender Trieb. Sie ist das Selbstmodell, das seine eigenen Zustände betrachtet und ihnen einen Wert zuweist. Mit anderen Worten: Sie ist ein Effekt des Bewusstseins.

Die Pointe ist also schärfer als „Maschinen könnten aufwachen.“ Sie lautet: Es gibt keine Intelligenz auf menschlichem Niveau – keine AGI – ohne bewusstseinsähnliche Mechanismen, denn das, was Intelligenz antreibt, *ist* einer. Da skaliert man sich nicht hin. Da baut man die Architektur. Das vollständige Argument, mitsamt Kreislauf, steht in Anhang B.
...
Die meisten Diskussionen über Mind Uploading beginnen mit der falschen Frage. Sie fragen: „Können wir ein Gehirn scannen und in einen Computer kopieren?“ Als ginge es nur um die Auflösung – ein hinreichend guter Scanner, und fertig. Aber die Theorie zeigt, dass ein statischer Scan bei weitem nicht ausreicht. Ein Gehirn ist kein Foto. Es ist ein dynamisches System. Um einen Geist zu erfassen, reicht es nicht, einen *Zustand* zu erfassen – man muss einen *Prozess* erfassen.

Was laut der Theorie bewahrt werden muss, ist spezifisch. Am besten geht man die Fünf-Ebenen-Hierarchie aus Kapitel 6 durch, um es greifbar zu machen.
...
Und auf der virtuellen Ebene (die Simulation selbst, EWM und ESM im Echtzeit-Betrieb) braucht es etwas Außergewöhnliches. Das Ziel-Substrat muss die Simulation bei Kritikalität laufen lassen können. Das ist es, was einen um den Schlaf bringt, weil das analoge Substrat des Gehirns Kritikalität durch selbstorganisierte Prozesse findet, die durch Hunderte Millionen Jahre Evolution feinabgestimmt wurden. Neuronen sind verrauscht, analog, massiv parallel und zutiefst stochastisch. Ihre kollektive Dynamik gravitiert von Natur aus zum Rand des Chaos, weil biologisches neuronales Gewebe genau das *tut* – es organisiert sich selbst zur Kritikalität, wie Wasser seinen Pegel findet. Nur: Wasser findet seinen Pegel wegen der Schwerkraft. Was ist die äquivalente Kraft für ein digitales Substrat?
...
Also: Das Scan-Problem ist schwer, aber lösbar. Fortgeschrittene Konnektomik (Ganzgehirn-Kartierung mit synaptischer Auflösung) macht bereits Fortschritte. Das komplette Konnektom kleiner Organismen lässt sich schon heute kartieren (der Fadenwurm *C. elegans* mit seinen 302 Neuronen wurde vor Jahrzehnten vollständig erfasst; das erste vollständige Konnektom eines adulten Fruchtfliegengehirns – rund 140.000 Neuronen – wurde 2024 veröffentlicht). Auf ein menschliches Gehirn mit 86 Milliarden Neuronen und rund 100 Billionen synaptischen Verbindungen hochzuskalieren, ist eine technische Herausforderung atemberaubenden Ausmaßes, aber es ist die Art von Herausforderung, die vor besserer Technologie weicht. Kein Mysterium. Ein Problem.
...
**Aber überlebt man den Schlaf?** Das Argument klingt wasserdicht. Kopieren unterbricht die Simulation, zwei Simulationen divergieren, also ist die Kopie nicht man selbst. Damit ist der Fall erledigt.

Nur dass die Simulation Nacht für Nacht unterbrochen wird.
...
**Die virtuelle Seite kopieren.** Statt das gesamte Gehirn zu scannen und das komplette Substrat nachzubauen (alle fünf Ebenen der Hierarchie) – was wäre, wenn sich nur die virtuelle Ebene kopieren ließe? Das laufende EWM und ESM extrahieren und auf ein neues Substrat verpflanzen, das sie tragen kann. Nicht die Hardware kopieren; die Software kopieren. Nicht das gesamte Gehirn klonen; den *Prozess* einfangen, den es ausführt.
...
Der graduelle Ersetzungsansatz mildert das, weil die Simulation bei jedem Schritt Zeit hat, sich anzupassen. Wird ein Neuron ersetzt, bemerkt die Simulation es kaum. Werden tausend ersetzt, passt sie sich an. Über Jahre geht das Substrat von biologisch zu künstlich über, während die Simulation sich fortlaufend auf den jeweiligen Input neu kalibriert. Die phänomenale Erfahrung würde driften, langsam, wie sie bereits im Verlauf eines natürlichen Lebens driftet. Das Ende wäre anders, aber das wäre es ohnehin gewesen.
...
Wenn die Vier-Modelle-Theorie richtig ist, oder auch nur annähernd richtig – ergeben sich mehrere Konsequenzen.

**Das Schwierige Problem ist nicht schwierig.** Es ist ein Kategorienfehler, nicht mysteriöser als zu fragen, warum sich Transistor-Schalten wie ein laufendes Videospiel anfühlt. Das physische Substrat fühlt nicht. Die Simulation schon. Und innerhalb der Simulation ist Fühlen konstitutiv, nicht etwas Zusätzliches. Das heißt nicht, dass Bewusstsein *einfach* ist. Es ist außerordentlich komplex in seiner Umsetzung. Aber das *philosophische* Mysterium löst sich auf. Was bleibt, sind *technische* Herausforderungen.

**Bewusstsein ist nicht speziell auf die Weise, die wir dachten.** Es ist keine fundamentale Kraft, kein Quanteneffekt, keine Eigenschaft der Materie. Es ist das, was passiert, wenn ein hinreichend komplexes System sich selbst bei Kritikalität simuliert. Das ist ernüchternd für alle, die wollen, dass Bewusstsein etwas Magisches ist, und aufregend für alle, die es verstehen wollen.
...
**Die ethischen Implikationen sind erheblich.** Wenn sich bewusste Maschinen bauen lassen, werden wir Wesen mit echten Erfahrungen erschaffen – Wesen, die leiden, genießen, staunen und fürchten können. Den ethischen Rahmen dafür gibt es noch nicht, und mit seiner Entwicklung sollte man nicht warten, bis die Maschinen bereits laufen.

**Philosophische Zombies sind inkohärent.** Hier verrichtet das zweite Prinzip, das ich in Kapitel 1 versprochen habe, seine Arbeit: **Leibniz' Gesetz**, die Identität des Ununterscheidbaren – wenn zwei Dinge *alle* ihre Eigenschaften teilen, sind sie ein und dasselbe. Es schließt die Zombie-Welt aus, jenes hypothetische Universum, das physikalisch mit unserem identisch ist, in dem aber in niemandem jemand zu Hause ist. Ist ein System einem bewussten in jeder funktionalen, strukturellen und verhaltensbezogenen Eigenschaft identisch, dann *ist* es bewusst. Es gibt keine zusätzliche „Bewusstseinssubstanz“, die stillschweigend fehlen könnte, während alles andere genau so bleibt, wie es war. Ein Wesen, das dir funktional identisch ist, hat dieselbe Vier-Modelle-Architektur, dieselbe laufende Simulation, dieselbe Selbstreferenz – und an diesem Punkt stellt „aber es ist nicht bewusst“ keine Tatsache fest, sondern gar nichts. Die Frage löst sich auf.

**Freier Wille, und die drei schwierigsten Gedankenexperimente.** Man denke an eine Uhr. Der Zahnradzug treibt alles an – die Hemmung tickt, die Federn entspannen sich, die Übersetzungsverhältnisse bestimmen den Gang. Die Zeiger und das Zifferblatt verursachen nichts. Sie schieben keine Zahnräder. Sie speichern keine Energie. Aber entfernt man sie, hat man keine Uhr mehr – nur eine Kiste sich drehenden Metalls. Erst die Anzeige macht den Mechanismus zur *Uhr* – sie gibt der ganzen Anordnung ihren Sinn. Bewusstsein ist die Anzeige. Die virtuellen Modelle (Explizites Weltmodell und Explizites Selbstmodell) schieben keine Neuronen herum. Das besorgt das Substrat. Aber ohne die Simulation hat das Substrat keine Möglichkeit, die Folgen seiner eigenen Handlungen zu beobachten, keine Möglichkeit, Zukunftsszenarien durchzuspielen, keine Möglichkeit, sich so anzupassen, wie es einen bisher am Leben gehalten hat. Die virtuelle Seite ist die Art, wie der Mechanismus *für* etwas ist.

Das stellt die Frage des freien Willens neu. Der Wille ist keine Illusion. Die Architektur auf Substrat-Ebene (das ISM und all seine implizite Maschinerie) optimiert fortlaufend das Überleben des Organismus. Sie bewertet Bedrohungen, wägt Optionen ab, mobilisiert Ressourcen, legt sich auf Handlung fest. Diese Optimierung *ist* der Wille. Er ist so real wie irgendetwas in der physischen Welt. Selbst selbstzerstörerische Entscheidungen spiegeln die Optimierung des Systems angesichts seines aktuellen Zustands wider, kein Versagen des Mechanismus. Handelt jemand gegen seine eigenen scheinbaren Interessen, optimiert das Substrat immer noch – nur gegen ein Modell, das Schmerz, Erschöpfung, Hoffnungslosigkeit oder was auch immer die Landschaft umgestaltet hat, einschließt.
...
Ich denke, das funktioniert auch nicht. Kühn und Brass zeigten 2009, dass das Veto selbst retrospektiv als freie Entscheidung interpretiert wird. Das Veto wird nicht tatsächlich in Echtzeit erlebt. Es wird genauso erlebt wie das Entscheiden – nachträglich, vom bewussten Selbstmodell zu einer stimmigen Erzählung verarbeitet.

Daniel Wegner und Thalia Wheatley trieben das mit einem Experiment auf die Spitze, das, ehrlich gesagt, verheerend ist – der „I Spy“-Studie. Ein Proband und ein Komplize, der einen zweiten Probanden mimte, legten ihre Hände gemeinsam auf ein kleines Brett über einer einzigen Computermaus – wie zwei Menschen an der Planchette eines Ouija-Bretts – und schoben zusammen einen Cursor über einen Bildschirm voller kleiner Objekte. Ab und zu forderte ein Tonsignal sie zum Anhalten auf, und der Proband bewertete, wie sehr er das Gefühl hatte, den Halt an dieser Stelle *gewollt* zu haben. Beide trugen Kopfhörer: Der Proband hörte Musik mit gelegentlich eingestreuten Wörtern, während der Komplize die eigentlichen Anweisungen hörte, wann und wo er einen Halt erzwingen sollte.
...
Aber es passiert noch etwas, das womöglich noch seltsamer ist als die Verzögerung.

Dabei geht es nicht darum, *wann* die eigene Erfahrung eintrifft, sondern *wie* der Zeitfluss überhaupt erst entsteht.

Das Gefühl, dass Zeit *vergeht* – dieses Empfinden, dass ein „Jetzt“ nach vorne gleitet, während der Augenblick davor dahinter weich wird –, wird nicht aus der realen Welt eingespeist. Da draußen steht keine Uhr, die einem die Gegenwart in die Hand drückt. Das Gehirn baut den Fluss hier drinnen, und es baut ihn aus einem ganz bestimmten architektonischen Grund.

Die Sinneskanäle haben unterschiedliche „Taktung“ und „Bandbreite“ – Information kommt nicht abgestimmt aufeinander im Gehirn an, sondern eher so wie Blitz und Donner. Wenn man aufmerksam ist, kann man erkennen, welcher Donner zu welchem Blitz gehört. Aber man erlebt einen nahtlosen, ununterbrochenen Strom. Warum? Weil das System sich selbst dabei modelliert, wie es sich selbst modelliert, und diese Schleife lässt keinen Takt sauber zu Ende kommen und verschwinden. Jeder hallt durch die Rekursion zurück und geht in den nächsten über. Die Grenze zwischen „jetzt“ und „eben gerade“ verschmiert – nicht aus Schlamperei, sondern weil eine selbstreferentielle Schleife genau das mit der Zeit macht. Sie verteilt jeden Augenblick über ein kleines Fenster.

Diese Verschmierung *ist* deine Gegenwart. Das lebendige Genau-jetzt, die jüngste Vergangenheit, die dahinter ausklingt, das Vorwärtsdriften, das du Zeitvergehen nennst – alles von der Schleife gefertigt. Eine Wettersimulation läuft Einzelbild für Einzelbild, ohne Echo, ohne verschmolzenes Jetzt, ohne gelebte Zeit. Sie rechnet. Sie erfährt nicht. Die Rekursion ist der Unterschied.

Lass dir also auf der Zunge zergehen, was deine Gegenwart wirklich ist. Gebaut, nicht empfangen – und verspätet eintreffend. Du hast nie in einem Augenblick gelebt. Du lebst in einem verschmierten Fenster, das die Schleife immer wieder neu baut und Jetzt nennt, und selbst dieses Fenster erreicht dich mit Verzögerung.
...
Gut, sagen wir. Nehmen wir stattdessen den Zufallszahlengenerator des Smartphones. Ein wirklich zufälliger Prozess soll entscheiden. Ist jetzt freier Wille bewiesen? Wohl kaum. Bewiesen ist lediglich, dass der Beweis des freien Willens wichtiger war als die Entscheidung über den Kaffee – was ziemlich spektakulär am Kern vorbeigeht.

Der stärkste Beleg gegen freien Willen bei alltäglichen Entscheidungen kommt von Patienten mit schwerer anterograder Amnesie – solchen, die keine neuen Erinnerungen bilden können. Fragt man einen solchen Patienten nach einer Wortassoziation: „Was ist das erste Wort, das Ihnen in den Sinn kommt, wenn ich ‚Würfel' sage?“ Er sagt „Qualle“ (vielleicht war er kürzlich tauchen). Fragt man ihn ein paar Minuten später noch einmal, sagt er wieder „Qualle“. Und wieder. Und wieder. Ohne Erinnerung, bereits geantwortet zu haben, produziert der Patient immer dieselbe Assoziation – die, die derzeit am stärksten in seiner neuronalen Landschaft ist. Was sich wie eine „freie Wahl“ anfühlt, entpuppt sich als deterministisches Auslesen des aktuellen Substratzustands.

Ein gesunder Mensch vermeidet das – beim zweiten Mal wählt man absichtlich ein *anderes* Wort, um nicht unkreativ zu wirken. Aber diese Vermeidung selbst ist nicht frei. Es ist nur das Gedächtnissystem, das eine Beschränkung („nicht wiederholen“) hinzufügt, die die Ausgabe *weniger* zufällig macht als beim Amnesiepatienten. Paradoxerweise macht freier Wille Entscheidungen weniger zufällig, nicht mehr. Das Substrat optimiert auf Neuheit und nennt das Ergebnis Freiheit.

Wo bleibt da also der freie Wille? Nicht eliminiert, sondern verlagert – genau dorthin, wo die Uhr-Analogie es vorhersagt. Das bewusste Selbstmodell trifft Entscheidungen nicht in Echtzeit. Es ist dafür zu langsam. Aber es ist auch kein bloßer passiver Zuschauer.

Hauptsächlich benutzt das implizite System die bewusste Erfahrung als Bewertungsinstrument: Es präsentiert Entscheidungen der Simulation, damit die Simulation Folgen abwägen, Szenarien durchspielen, Ergebnisse fühlen kann. Das ist der zentrale Zweck der virtuellen Schicht – die Art des Substrats, sich selbst zu beobachten. Aber das bewusste Modell bewertet auch eigenständig, mit der Bandbreite, die es eben hat – weit weniger als die des Substrats, aber sie ist real. Diese Bewertungen formen mit der Zeit die impliziten Modelle um. Sie aktualisieren die Gewichte, trainieren das Netzwerk um, verschieben die Landschaft für die *nächste* unbewusste Entscheidung.

Im Moment der Handlung wird nicht die nächste Handlung gewählt, sondern das System geformt, das wählt – durch Reflexion, Bewertung und die langsame Einlagerung bewusster Erfahrung in implizite Struktur. Freier Wille ist kein Moment. Er ist ein Prozess – einer, der auf einer Zeitskala von Tagen und Jahren arbeitet, nicht Millisekunden. Und die bewusste Schicht fährt nicht nur mit – sie wird aktiv *vom* Substrat als Bewertungsmechanismus genutzt und speist ihre eigenen unabhängigen Einschätzungen ins Substrat zurück. Verkehr in beide Richtungen, keine Einbahnstraße.
...
Und während dieser paar Sekunden der Lawine – nur ein paar Sekunden Echtzeit – lief das ganze bisherige Leben vor dem inneren Auge ab. Ein gut dokumentiertes Nahtodphänomen, und die Theorie erklärt es: Unter extremer tödlicher Bedrohung lädt das implizite System schlagartig eine gewaltige Menge gespeicherter Inhalte parallel in die Simulation. Die Durchlässigkeitsgrenze reißt weit auf. Das Substrat läuft auf Hochtouren, pumpt so viel Inhalt in die Simulation, dass subjektive Zeit sich von der Uhrzeit abkoppelt. Ein paar Sekunden enthalten ein ganzes Leben. Dieselbe Zeitdehnung, die unter Salvia pharmakologisch ausgelöst wird (Kapitel 6) – hier biologisch verursacht.

Und jetzt lässt sich sagen, *warum* diese beiden Zustände – der Lebensfilm des sterbenden Gehirns und der Salvia-Sturz – sich von innen gleich anfühlen. Erinnere dich an die zwei Regler aus Kapitel 5. Fast immer spielen sie gegeneinander: Reißt man das ganze Gehirn in ein einziges Geschehen, vereinfacht es sich; baut man reiche, verschiedene Muster, bleiben sie lokal, statt das ganze Gehirn zu erfassen. Das Alltagserleben lebt auf der Grenze zwischen beiden. Aber es gibt eine seltene Konstellation, in der *beide* zugleich ungewöhnlich hoch stehen – viel Gehirn versammelt *und* die Berechnung maximal reich. Und erinnere dich, woraus das Gehirn seinen Sinn für Dauer baut: nicht aus dem Ablesen einer Uhr, sondern aus dem schieren Verarbeitungsvolumen pro Sekunde Echtzeit. Treibt man beide Regler zugleich hoch, presst man ein ganzes Leben an Verarbeitung in eine Handvoll Uhren-Sekunden. Man *erinnert sich* nicht an sein Leben – man *durchlebt* es neu. Man *wartet* das Salvia nicht ab – man *verbringt* die Jahrzehnte. Ein Mechanismus, zwei Türen hinein: Sauerstoffmangel und eine versagende metabolische Bremse auf der einen Seite, eine Kappa-Opioid-Substanz, die dieselbe Regulierung durcheinanderbringt, auf der anderen. Die Theorie macht das prüfbar: Beide Zustände sollten zugleich ungewöhnlich hohe Ganzhirn-Integration *und* ungewöhnlich hohe Berechnungskomplexität zeigen – die zwei Dinge, die das gewöhnliche Bewusstsein stets gegeneinander eintauschen muss.
...
Und hier muss ich ehrlich eine Grenze ziehen, denn die Versuchung ist, zu weit zu greifen. Dass der *Zeitpunkt* der inneren Wendung nicht dir gehört – so viel deckt Libet ab, und es geht längst nicht mehr nur ums Bewegen eines Glieds: Wenn Menschen frei wählen, welches Bild sie vor ihrem inneren Auge heraufbeschwören, lässt sich diese Wahl inzwischen mehrere Sekunden, bevor sie sie zu treffen glauben, aus dem visuellen Kortex ablesen. Das *Öffnen* des inneren Akts sieht also so vorentschieden aus wie das Heben einer Hand. Wie viel du steuerst, was *drinnen* geschieht, sobald du erst einmal dort bist, ist eine andere Frage, und die ehrliche Antwort lautet: Wir wissen es nicht. Und die Frage ist schärfer, als sie zunächst aussieht. Worum es wirklich geht, ist nicht, wie viel Freiheit dein Selbstmodell im Allgemeinen hat – sondern wie viel Griff das Selbstmodell auf das *Welt*-Modell hat: wie weit der Avatar in die simulierte Welt hineinreichen und sie umformen kann, in der er sich vorfindet. Das ist eine Superkraft für sich, und keine unbedeutende. Sie verlangt eine gewisse Tiefe des Selbstmodells, weshalb sie ungleich verteilt und zumindest teilweise *trainierbar* ist. Wie viele Freiheitsgrade die darunterliegende Maschinerie deinem Selbstmodell dafür zugestanden hat, hat niemand gezählt – und die einzige wirklich offene Version der Frage, was dein Geist als Nächstes hervorbringt, wenn ihn nichts einschränkt, hat überhaupt noch niemand geprüft. Vielleicht steuerst du, was du dort drinnen erkundest, in echtem und trainierbarem Maß. Vielleicht meistens nicht. Die Introspektion kann es nicht entscheiden; sie ist das eine Instrument, das hier garantiert blind ist, und es wirklich zu klären verlangte eine vollständige Verschaltungskarte eines menschlichen Gehirns und eine Menge Rechenarbeit. Nimm die Ernüchterung also für genau das, was sie ist, und keinen Zoll weiter: Das *Öffnen* des inneren Akts ist nicht deine Autorschaft. Was du tust, sobald der Vorhang oben ist – wie weit du die Welt dahinter biegen kannst –, bleibt eine offene Frage, und eine ehrliche.

Da also lässt dich das Freiheits-Argument im Regen stehen: nicht als Urheber – nicht als Besitzer der Hand, nicht als Regisseur des Tagtraums, nicht einmal als Fragesteller, der sich fragt, wie weit er steuert. Womit genau eine Sache übrig bleibt, für die es sich lohnt, umzublättern: Was fängst du mit einem Willen an, den du nicht selbst lenkst?

---

## Kapitel 14: Die einzige Freiheit im Angebot

Und hier kommt das Gegengewicht, denn ich will nicht, dass du das Buch an dieser Stelle zuklappst und denkst, die innere Welt sei ein Käfig. Genau dieselbe Fähigkeit – sich von dem abzukoppeln, was vor dir liegt, und die Simulation auf ihren eigenen Inhalten laufen zu lassen – ist, in der richtigen Dosis, das mit Abstand Mächtigste, was die Evolution je gebaut hat. Jeder Akt des Denkens lebt hier. Kreativität auch. Das Gedächtnis selbst auch, und der Trick, den die Alten Gedankenpaläste nannten – durch eingebildete Räume zu gehen, um das aufzubewahren, was zählt. Vorstellungskraft, Planung, die ganze Maschinerie des „was wäre, wenn ich stattdessen das täte“, die Fähigkeit, aus der Gegenwart herauszutreten und im eigenen Kopf vorwärts und rückwärts zu reisen – nichts davon braucht die Mitwirkung der Welt, alles davon braucht genau diese Fähigkeit, sich nach innen zu ziehen und die Simulation auf inneren Inhalten arbeiten zu lassen. Der langsame äußere Griff hat über Generationen Zivilisationen gebaut. Dieser innere baut einen ganzen Gedanken in einer Sekunde. Er ist der Motor von allem, was wir mit menschlichem Denken meinen. Greif leicht danach, umkehrbar, in abgestuften Dosen, und er ist eine Superkraft.

Lehn dich zu schwer darauf, und der Hebel, der dich hineinlässt, kann offen steckenbleiben. Fahr den inneren Rückzug auf volle Leistung, und der dünne Kanal, der deine Simulation an die tatsächliche Welt bindet, wird überschwemmt – dasselbe Einrasten, das ich vorhin beschrieben habe, dasselbe Davonlaufen, das Nahtoderlebnis und hochdosiertes Salvia dir unfreiwillig aufzwingen, nur dass du hier auf eigenen Füßen hineinmarschiert bist. Treib es weit genug, und du findest den Weg zurück in die geteilte Welt überhaupt nicht mehr. Das ist der Salvia-Konsument, der aus dem Fenster klettert, weil das Fenster für ihn nicht länger real ist (Kapitel 6). Und die Simulation kommt, wenn man sie so hart treibt, nicht immer als ein Ding zurück – sie kann sich aufspalten, sich teilen, als mehr als einer von dir zurückkehren, oder als jemand, der nicht ganz der ist, der gegangen war (die zwei Bewusstsein in einem Gehirn, Kapitel 9). In Maßen gebraucht, ist es das beste Werkzeug, das du hast. Überdreht, ist es ernsthaft gefährlich – und wenn du es zu oft tust, wer weiß, ob du zurückkommst, und wie viele.
...
Eine gute Freundschaft, die solches Feedback trägt, ist wahrscheinlich das effizienteste ESM-Kalibrierungssystem, das es gibt. Jeder Fehler, den der andere bemerkt und benennt, ist ein Korrektursignal: *Das Selbstmodell hat gerade etwas getan, das das Substrat nicht beabsichtigte.* Und weil die Kritik in echte Zuneigung gewickelt ist, wird der Fehler nicht verteidigt, sondern aktualisiert. Das ist der Trick: Man braucht jemanden, dem man genug vertraut, um brutal zu sein, und eine Beziehung, in der Falschliegen lustig statt bedrohlich ist.
...
Eine Theorie, die behauptet, keine offenen Fragen zu haben, ist keine Theorie – es ist eine Religion. Also hier die Stellen, wo ich wirklich unsicher bin und wo sich die Arbeit der nächsten Jahrzehnte konzentrieren sollte.

**Sind die impliziten Modelle auch virtuell?** (oder zu welchem Grad) IWM und ISM sind „Modelle“, aber Modelle wovon, genau? Ich habe eine saubere Linie zwischen dem realen Substrat und der virtuellen Simulation gezogen, aber die impliziten Modelle sitzen genau auf dieser Linie. Wenn sie in gewissem Sinn ebenfalls virtuell sind – was konstituiert dann das wirklich „reale“ Fundament? Die Theorie nimmt eine saubere Real/Virtuell-Trennung an, aber die Realität könnte unordentlicher sein als meine Diagramme. Das ist eine fundamentale Frage, auf die ich keine endgültige Antwort habe.

**Mathematische Formalisierung.** Die Theorie ist derzeit qualitativ. Ich kann Diagramme zeichnen, Mechanismen beschreiben und Vorhersagen machen, aber keine Gleichung liefern. Die Kritikalitäts-Anforderung verweist auf Wolframs Klasse-4-zelluläre Automaten, und es gibt formale Werkzeuge aus der Dynamischen Systemtheorie, die herangezogen werden könnten. Aber eine vollständige mathematische Formalisierung – Gleichungen, die genau spezifizieren, wann und wie die virtuellen Modelle aus Substrat-Dynamiken emergieren – existiert noch nicht.
...
Und wenn jemand einen solchen Automaten findet – ruft mich an. Ich habe einige Vorhersagen, die ich gerne überprüfen würde.
...
Eine dieser Fragen ließ mich nicht los – die, von der ich dir gesagt habe, dass sie mich nachts wach hält. Also hörte ich auf, sie aus sicherer Entfernung zu stellen, und machte mich auf die Suche. Was als Nächstes kommt, ist der Ort, an den mich das geführt hat.

---
## Kapitel 15: Dasselbe Muster, überall

Einmal habe ich eine Sommernacht am dunkelsten Ort Vorarlbergs verbracht – hoch oben in den Bergen, kilometerweit kein künstliches Licht. Ich lag auf dem Rücken und schaute nach oben. Die Milchstraße war kein schwacher Schleier, den man nur mit zusammengekniffenen Augen erkannte. Sie war ein Strom, dicht und hell, der ein sichtbares Leuchten auf den Fels neben mir warf. Und irgendwann in dieser Nacht kippte etwas. Ich hörte auf, Sterne über mir zu sehen, und begann, die Erde unter mir zu spüren – drehend, mich mit sich tragend, eine Kugel, die durch eine Galaxie von hundert Milliarden Sonnen raste. Nicht als Idee. Als Empfindung im Körper. Der Boden war nicht still. Ich klammerte mich an die Außenseite von etwas, das sich durch etwas unbegreiflich Großes bewegte.

Dieser Schwindel – die plötzliche körperliche Gewissheit, ein kleines warmes Ding auf der Oberfläche eines Felsbrockens im Universum zu sein – ist das Gefühl, das man beim Weiterlesen festhalten sollte. Denn dieses Kapitel fragt, was dieses Universum eigentlich ist. Und die Antwort kommt einem sehr bekannt vor.

---

Was folgt, ist der spekulativste Teil dieses Buches. Und, so glaube ich, der wichtigste. Denn als ich mich tatsächlich hinsetzte und dem Faden folgte – als ich aufhörte, ihn als Irgendwann-Frage zu behandeln, und anfing, am Faden zu ziehen – landete ich nicht dort, wo ich erwartet hatte. Ich rechnete mit einer interessanten mathematischen Kuriosität. Was ich fand, war ein kosmologisches Modell. Und dieselbe Architektur, die mich zwanzig Jahre lang angestarrt hatte.
...
Ein Wort zur Art dieses Arguments. Es ist kein deduktiver Beweis. Zwei der vier Ausschlüsse beruhen auf empirischen Beobachtungen (das Universum enthält Bewusstsein; es trägt universelle Berechnung). Einer beruht auf Abduktion (Klasse 5 macht Wissenschaft unmöglich – unbefriedigend, aber kein logischer Widerspruch). Der positive Fall für Klasse 4 kombiniert Befunde mit einem Mechanismus. Das ist die stärkste Behauptung, die sich vertreten lässt: Klasse 4 ist die einzige Klasse, die mit allen Beobachtungen vereinbar ist, und die einzige, die einen Grund für ihre eigene Fortdauer liefert.

Zurück zu dem Felsbrocken, unsere Erde. Das Ding, an das ich mich am Berghang klammerte – das, bei dem mir der Magen absackte, als ich spürte, wie es sich bewegte – ist nicht bloß alt und ungeheuer und gleichgültig. Es ist Klasse 4. Der Rand des Chaos ist keine Formel, nach der ich gegriffen hätte, um tiefgründig zu klingen; er ist der Boden, der mich trug und sich Korn für Korn selbst auf Kritikalität einstellte, so wie Baks Sandhaufen es tut – das ganze Gleichgewicht haltend, ohne dass eine Hand am Regler läge. Ich lag nicht auf einem toten Stein. Ich klammerte mich an die Außenseite einer Berechnung, die sich selbst auf einer Messerschneide in Balance hält – und das tust du auch, genau jetzt, ob du die Drehung der Erde „spürst“ oder nicht.
...
Das ist der **kosmologische Horizont**. Keine physische Oberfläche. Da draußen gibt es keine Wand. Eine Konsequenz von Geometrie und Geschwindigkeit – aber eine ebenso absolute Barriere wie jede Wand. Information jenseits des Horizonts ist für immer unzugänglich. Sie könnte genauso gut nicht existieren.

Es gibt eine ähnliche Grenze ganz unten. Die **Planck-Länge** – etwa $10^{-35}$ Meter, eine Zahl so klein, dass sie „klein“ zu nennen so ist, als würde man das beobachtbare Universum „mittelgroß“ nennen – ist dort, wo die Physik, wie wir sie kennen, zusammenbricht. Unterhalb dieser Skala funktionieren unsere Gleichungen nicht. Die Raumzeit selbst verliert physikalische Bedeutung. Keine Messung unterhalb der Planck-Länge ist möglich, nicht einmal im Prinzip. Keine technologische Beschränkung. Eine fundamentale Grenze dessen, was sich wissen lässt.
...
Das macht das Universum zu etwas, das man **quasi-unendlich** nennen kann. Es ist nicht wirklich unendlich – zumindest lässt sich nie verifizieren, dass es das ist, weil nie mehr als eine endliche Region erreichbar ist. Aber es ist auch nicht endlich in irgendeinem greifbaren Sinn. Die Grenze weicht schneller zurück, als man sich ihr nähern kann. Der Rand ist unerreichbar, aber er ist da. Von innen erscheint das Universum unbegrenzt. Von außen – aber es gibt kein Außen. Genau darum geht es.

Das ist wieder der Schwindel, nur hat er jetzt Koordinaten. Unter mir ein Boden, den ich nie erreichen kann; über mir ein Rand, der schneller flieht, als Licht ihm nachjagen kann, in jede Richtung zugleich, ohne ein Außen, in das man entkommen könnte.

---

### Jede Grenze ist dieselbe Grenze

Hier kommt die zentrale Idee dieses Kapitels. Es lohnt sich, einen Moment innezuhalten, denn wenn sie stimmt, verändert sie, wie man über alles denkt.

Zunächst eine Bestandsaufnahme. Das Universum enthält Singularitäten – Orte, wo unsere physikalische Beschreibung zusammenbricht, wo Informationsübertragung stoppt, wo die Gleichungen explodieren oder schweigen. Diese Singularitäten treten auf völlig unterschiedlichen Skalen auf, in völlig unterschiedlichen Kontexten. Physiker behandeln sie als getrennte Phänomene. Ich glaube, sie sind alle dasselbe.
...
Drei gemeinsame Eigenschaften. Sechs Phänomene. Die konventionelle Sicht ist, dass dies sechs verschiedene Dinge sind, die zufällig einige Merkmale gemeinsam haben. Ich glaube, die konventionelle Sicht ist falsch. Ich glaube, es ist **ein Phänomen** – die Informationsgrenze des Automaten – das auf sechs verschiedenen Skalen erscheint.
...
*Das also war die Nacht am Berghang in Wahrheit. Ich klammerte mich nicht an einen Fels. Ich klammerte mich an die Außenseite eines Klasse-4-Automaten, und jede Grenze in ihm – auch die, gegen die mein Verstand immer wieder drückte, draußen jenseits des letzten sichtbaren Sterns – ist dieselbe Grenze. Im nächsten Kapitel folge ich diesem Faden zu seinen Konsequenzen. Und sie sind seltsamer, als ich erwartet habe.*
...
Jetzt folge ich diesem Faden weiter. Denn wenn alle Grenzen dieselben sind, ergeben sich bemerkenswerte Konsequenzen – für die Zeit, für die Materie, für die Grenzen des Wissens und für eine Architektur, die einem bis zum Schluss sehr vertraut vorkommen sollte.
...
Jetzt wird es seltsam. In diesem Rahmen zerstören Singularitäten keine Information. Sie *transformieren* sie. Das ist tatsächlich die Auflösung, auf die die moderne Physik beim Informationsparadox Schwarzer Löcher zusteuert – der jahrzehntelangen Debatte darüber, ob Information verloren geht, wenn sie in ein Schwarzes Loch fällt. Der aktuelle Konsens verschiebt sich zu „nein“: Information wird bewahrt, auf dem Ereignishorizont kodiert und schließlich wieder emittiert. Die Singularität transformiert Information zwischen komprimierten und dekomprimierten Formen.
...
Doch der Wärmetod ist nicht der einzige Weg, wie die Geschichte enden könnte. Es gibt eine Alternative, die wohl noch seltsamer ist, und der Ansatz handhabt sie genauso sauber.
...
In diesem Modell hat der Big Rip eine natürliche Deutung. Die Singularitätsgrenze, die normalerweise weit draußen am kosmologischen Horizont sitzt, wandert *nach innen*. Sie wartet nicht am Rand des beobachtbaren Universums. Sie rückt näher. Sie fragmentiert die Berechnungsdomäne in immer kleinere Regionen, jede sättigt ihre eigene Bekenstein-Grenze, jede wird zu ihrer eigenen informationsundurchlässigen Grenze. Statt einer großen Singularität am Ende der Zeit entsteht eine fraktale Explosion von Singularitäten, die gleichzeitig auf jeder Skala nach innen wandern.

Und wenn Singularitäten Informationstransformatoren sind – wenn sie die Berechnung nicht zerstören, sondern neu starten – dann erzeugt der Big Rip nicht einen Neustart. Er erzeugt *viele*. Potenziell unendlich viele. Jedes Fragment der zerschmetterten Berechnungsdomäne könnte seine eigene neue Expansion säen, seine eigene neue Dekompression, sein eigenes neues Universum. Der Big Rip ist in diesem Rahmen ein Multiversum-Generator.

Das Modell umfasst also nicht ein, sondern drei Endspiel-Szenarien, und alle drei sind strukturell stimmig:
...
Big Crunch: Das Universum hört auf zu expandieren und kollabiert zurück zu einem einzigen Punkt. Eine weitere globale Singularität, ein weiterer Neustart – möglicherweise mit einer CPT-Umkehrung – einer Spiegelung von Ladung, Parität und Zeit, die den nächsten Zyklus zum Spiegelbild des letzten macht.
...
Diese Robustheit finde ich eher beruhigend als beunruhigend. Ein Ansatz, der nur funktioniert, wenn das Universum auf eine bestimmte Weise endet, ist fragil – es setzt auf ein kosmologisches Ergebnis, das wir noch nicht kennen. Dieses Modell muss nicht wetten. Seine strukturelle Logik – Singularitäten als Informationstransformatoren, Grenzen als das fundamentale architektonische Element – hält unabhängig davon, welches Endspiel das Universum tatsächlich wählt. Das ist die Art von Robustheit, die eine Theorie braucht. Sie sollte nicht von Tatsachen abhängen, die wir noch nicht kennen.

---

### Was Teilchen wirklich sind

In diesem Ansatz steckt eine Vorhersage, die ausgesprochen gehört, weil sie sich eines Tages überprüfen lassen könnte.

Elementarteilchen – Elektronen, Quarks, die Bausteine der Materie – werden im Standardmodell als punktförmig behandelt. Nulldimensional. Keine räumliche Ausdehnung. Das war immer eine mathematische Vereinfachung statt einer physikalischen Behauptung. Niemand glaubt, dass ein Elektron buchstäblich ein geometrischer Punkt ist, denn ein geometrischer Punkt hat keine Oberfläche und kann daher, nach der Bekenstein-Grenze, keine Information enthalten. Ein Elektron enthält Information – Ladung, Spin, Masse, Quantenzahlen. Etwas stimmt mit dem „Punkt“-Bild nicht.
...
Aber entscheidend ist: In einem Zellulären Automaten wie dem Game of Life lässt sich anziehende Wechselwirkung zwischen Mustern leicht reproduzieren. Zwei persistente Strukturen können kleinere Strukturen zwischen sich austauschen in Konfigurationen, wo der Austausch *den Abstand verringert*. Die Wechselwirkung muss nicht der Newtonschen Intuition gehorchen, weil die „Kraft“ kein Stoß oder Zug ist – sie ist ein Informationsaustausch zwischen Grenzkonfigurationen, und die Regeln des Automaten bestimmen, ob dieser Austausch die Grenzen näher zusammen oder weiter auseinander bewegt. Das Medizinball-Rätsel löst sich auf. Es war nur ein Rätsel, weil wir uns makroskopische Physik vorstellten. Auf der Berechnungsebene sind Anziehung und Abstoßung einfach zwei verschiedene Ergebnisse desselben Prozesses: Informationsaustausch, gesteuert durch die Regeln des Automaten.
...
**Warum sind Erhaltungssätze so absolut?** Ladung, Baryonenzahl, Leptonenzahl – nie ein einziges Mal beobachtet, dass eines dieser Gesetze versagt, in keinem je durchgeführten Experiment. Weil es Einschränkungen der Informationserhaltung sind. Tauschen zwei Grenzen Information aus, muss die Buchführung aufgehen: An einer Singularitätsgrenze lässt sich Information weder erzeugen noch zerstören, also auch keine Ladung. Die Erhaltungssätze sind keine von außen auferlegten Regeln. Sie sind die Buchhaltung. (Die Kette von der Bekenstein-Grenze über die Unitarität bis zu den konkreten Erhaltungssätzen ist in Anhang F ausgearbeitet.)

**Und dann gibt es das Mysterium der drei Generationen.** Jedes Teilchen kommt in drei Kopien, identisch bis auf die Masse – Elektron, Myon, Tau; Up, Charm, Top. Niemand weiß, warum drei. Nicht zwei, nicht vier, nicht siebzehn. Drei. Das Bild der Berechnungsatome bietet eine Vermutung: Klasse-4-Systeme tragen selbstähnliche Struktur als Teilprozess, also könnten die stabilen Grenzkonfigurationen auf drei Skalen wiederkehren – ein Grundmuster und zwei schwerere Kopien. Wenn ja, existieren auch höhere Generationen, aber sie sind größere Muster, und größere Muster sind fragil – kleinere, stabilere Konfigurationen schneiden sie auseinander, bevor sie sich konstituieren können. Das passt zu dem, was wir sehen: Tau und Top-Quark zerfallen bereits fast im Moment ihrer Entstehung. Die drei Generationen, die wir bekommen, könnten schlicht die drei sein, die klein genug sind, um zu überleben. Es ist eine Vermutung, keine Ableitung – ich lege sie vollständig dar, mitsamt der Erhaltungssatz-Buchhaltung, in Anhang F.

Der Begriff für dieses Bild ist **Berechnungsatome**. Nicht Atome im Sinne von Wasserstoff und Helium – Atome im Sinn von irreduziblen Berechnungselementen. Teilchen sind die grundlegenden Operationen des universellen Automaten. Jeder Teilchentyp ist eine stabile Planck-Skalen-Berechnung. Jede Wechselwirkung ist ein Informationsaustausch zwischen Berechnungen. Jeder Erhaltungssatz eine Einschränkung dafür, wie diese Austausche ablaufen können. Physik handelt auf ihrer tiefsten Ebene nicht von Materie. Sie handelt von Berechnung. Und die Dinge, die wir „Materie“ nennen, sind die irreduziblen Bausteine der Berechnung.

---

### Die Architektur

Zeit, die Fäden zusammenzuführen. Was hier beschrieben wurde, ist ein Universum mit einer bestimmten Architektur:

**Erstens:** Es ist ein Klasse-4-Zellulärer Automat. Es operiert am Rand des Chaos, wo selbstorganisierte Kritikalität die Dynamik ohne externe Feinabstimmung aufrechterhält. Es ist rechnerisch irreduzibel – keine Abkürzungen, kein Vorspringen. Jeder Moment muss aus dem letzten berechnet werden. Und es enthält alle Klassen als Teilprozesse – einschließlich sich selbst: die stabilen Atome (Klasse 1), die periodischen Umlaufbahnen (Klasse 2), die fraktalen Küstenlinien (Klasse 3), und am entscheidendsten, andere Klasse-4-Automaten, die innerhalb der großen Berechnung laufen. Gehirne sind ein solcher Fall.

**Zweitens:** Es ist holografisch auf jeder Ebene. Die Information in jeder Region ist auf ihrer Grenze kodiert. Das ist das holografische Prinzip, das als Vermutung über Schwarze Löcher begann und zu einer der tiefsten Einsichten in der theoretischen Physik wurde. In diesem Rahmen ist holografische Kodierung nicht nur eine Eigenschaft Schwarzer Löcher – sie ist eine Eigenschaft der Regelstruktur des Universums selbst. Die Regeln sind holografisch. Die Dynamik ist Klasse 4. Und die Ausgabe ist wieder holografisch.
...
Einmal gesehen, lässt es sich nicht mehr übersehen.

Kapitel 16 endete mit einer Herausforderung: Die SB-HC4A-Architektur betrachten – den selbstreferenziellen, holografischen Klasse-4-Automaten, der an jeder Skala von Singularitäten begrenzt wird – und dann die Vier-Modelle-Architektur aus Kapitel 2 danebenlegen. Die Behauptung war, dass sie dasselbe sind. Nicht bloß ähnlich oder metaphorisch verwandt, sondern strukturell identisch.

Jetzt gehe ich Stück für Stück durch die Entsprechung, bis es unmöglich wird, sie abzutun. Und dann sage ich, wo das Ganze zusammenbrechen könnte.
...
Diese Ergebnisse gingen von sehr unterschiedlichen Ausgangspunkten aus. Landauer dachte über Computer nach; Bekenstein und Hawking über die Thermodynamik Schwarzer Löcher. Landauers Arbeit gehörte einem ganz anderen Feld an, Jahrzehnte früher und aus unabhängigen Gründen entstanden. Und doch konvergiert alles zur selben Hypothese: Energie und Information sind nicht nur verwandt. Sie sind identisch. Zwei Namen für dasselbe. E gleich I.
...
Jetzt das Gehirn durch diese Linse. Die impliziten Modelle halten komprimierte, maximal dichte Information: alles, was wir jemals gelernt haben, kodiert in synaptischen Gewichten, strukturell vollständig und phänomenal unzugänglich. Das eigene Substrat lässt sich nie direkt erleben. Die expliziten Modelle sind die dekomprimierte Projektion niedrigerer Bandbreite – die Simulation, die bewusste Erfahrung, die Welt, die wir sehen, und das Selbst, das wir fühlen. Das Gehirn tut auf der neuralen Skala genau das, was Singularitäten auf jeder anderen Skala tun: Information zwischen komprimierten und dekomprimierten Darstellungen transformieren. Die implizit-explizite Grenze ist die persönliche Singularität. Wir tragen einen Ereignishorizont im Schädel.
...
**Zwei: Was auch immer existiert, hat dynamischen Charakter.** Dinge geschehen. Zeit vergeht. Zustände entwickeln sich. Hätte das Existierende keine Dynamik – keine Veränderung, keine Entwicklung, keine Berechnung –, wäre es ununterscheidbar von Nichts. (Leibniz' Identität des Ununterscheidbaren, die in Kapitel 13 auftauchte: Wenn zwei Dinge in allen Eigenschaften identisch sind, sind sie dasselbe Ding. Etwas mit null Dynamik hat null unterscheidbare Eigenschaften. Es ist Nichts mit einer Maske.)
...
### Der eine Einwand, den ich nicht beantworten kann

Ich habe dir die Stellen versprochen, an denen das hier brechen könnte, also hier sind sie. Vier davon sind die Sorte, die ein Ingenieur auflisten würde: Energie könnte mit Information bloß korreliert statt mit ihr identisch sein, sodass der E-gleich-I-Mechanismus scheitert; das Klasse-4-Argument ist abduktiv, kein Beweis, sodass irgendeine Klasse 4.5, die ich mir nicht vorstellen kann, lauern könnte; die Behauptung, dass alle Singularitäten ein und dasselbe sind, braucht eine Theorie der Quantengravitation, die wir noch nicht haben; und das ganze Modell könnte von innen unfalsifizierbar sein, durch seine eigene Gödel-Vorhersage. Jeder Punkt ist real. Ich lege alle vier, mit den Gegenargumenten, in Anhang G dar.

Aber es gibt einen fünften, und er ist schlimmer als die anderen vier zusammen. Ich habe ihn ein Kapitel früher aufgeworfen, und er hat seinen Griff seither nicht gelockert: die kognitive Obergrenze aus Kapitel 16. Blickt mein Klasse-4-Gehirn auf den Kosmos und sieht überall Klasse 4 – Kritikalität, holografische Grenzen, selbstreferenzielle Geschlossenheit –, entdeckt es dann die Architektur der Realität oder projiziert es seine eigene? Ein Fisch mit einer Theorie der Physik käme zu dem Schluss, das Universum sei fundamental nass. Wir sind Symmetriedetektoren, und der SB-HC4A ist im Kern eine Symmetriebehauptung. Ich weiß nicht, wie man die beiden von innen auseinanderhält, und ich glaube nicht, dass es jemand kann.

Und jetzt das Seltsame. Die Theorie sagt genau diesen blinden Fleck voraus: Ein selbstreferenzielles System, das sich selbst berechnet, kann nach Gödel nicht von innen jede Wahrheit über sich erreichen. Die tiefste Frage, die das Buch stellen kann – ist der Spiegel zwischen Geist und Kosmos eine Entdeckung oder eine Spiegelung der Grenzen menschlicher Kognition? –, ist eine, die die Theorie mit einer verschlossenen Tür beantwortet und einem dann den Bauplan des Schlosses in die Hand drückt. Die Lücke ist keine Unwissenheit. Sie ist Geometrie. Ob man das tiefgründig oder empörend findet, sagt wahrscheinlich etwas über das eigene Temperament; ich finde es beides. Und dann mache ich trotzdem weiter – eine Mauer, die man benennen und auf die man die Hand legen kann, ist nicht dasselbe, wie im Dunkeln verloren zu sein.
...
Die zweite Hälfte ist das, was gerade gelesen wurde. Dieselbe Architektur – dieselbe selbstreferenzielle Geschlossenheit, dieselben Informationsgrenzen, dieselbe holografische Kodierung, dieselbe Klasse-4-Dynamik – scheint die Architektur des Universums selbst zu sein. Nicht durch Analogie. Durch strukturelle Identität. Die Simulation namens Ich läuft auf demselben Muster wie die Simulation, die wir „das Universum“ nennen. Wir sind nicht im Universum wie eine Murmel in einer Box. Wir sind das Universum, das auf der biologischen Skala tut, was es auf jeder Skala tut: sich selbst berechnen, sich selbst modellieren, sich selbst erleben.

Und jetzt kommt der Teil, den ich damals verschwieg. Ich hatte den Rest längst. Es ist nicht so, dass ich die Kosmologie erst später gefunden hätte, nachdem die Bewusstseinshälfte längst geschrieben war – beide Hälften fielen in derselben Sekunde an ihren Platz, dort auf der Brücke in Innsbruck, mit fünfundzwanzig – Bewusstsein und Universum, dasselbe Muster. Nur schrieb ich 2015 fast nichts davon nieder. Mit Absicht. Eine Theorie des Bewusstseins ist schon schwer genug zu verkaufen; eine, die obendrein behauptet, den Bauplan des Universums zu kennen, landet in der Schublade mit der Aufschrift *Spinner*, bevor irgendjemand Seite zwei erreicht. Also ließ ich die Kosmologie nur als Andeutung stehen – eine Passage über 't Hoofts holografische Schranke, angewandt aufs ganze Universum, eine Randbemerkung, der Kosmos könnte ein zellulärer Automat sein – und wagte es nicht, den Rest hinzuschreiben. Es hat noch ein Jahrzehnt gedauert, bis ich mich endlich traute, das Ganze aufzuschreiben. Diesmal mit der Geduld eines Sprachmodells an meiner Seite, das nie müde wird und nie fragt, ob man sich damit nicht zum Gespött macht.
...
Was man damit anfängt, muss jeder für sich selbst entscheiden.

---

## Coda

Ich entwickelte eine Theorie des Bewusstseins um 2005. Ich veröffentlichte sie 2015. Niemand las sie. Zwei Jahrzehnte nach der ursprünglichen Einsicht stellte sich heraus, dass die Forschung aufgeholt hat und erste Aspekte meiner Theorie bewiesen werden konnten.
...
Wir haben gesehen, was das ESM tut, wenn Dinge schiefgehen. Amnesie, Schlaganfall, Salvia, Split-Brain, Cotard – es läuft weiter. Es stürzt nie ab. Es baut ein Selbst aus dem, was verfügbar ist, und es glaubt diesem Selbst vollständig. Ein zwanghafter Konstrukteur von Identität. Das ist, was es tut. Das ist alles, was es tut.

Man hört die Amnesie-Fälle und sagt: dasselbe Gehirn, derselbe Körper, also besteht das Selbst natürlich fort. Nur – ich bin heute Jahrzehnte älter. Ich habe fast nichts gemeinsam mit meinem einjährigen Selbst. Anderer Körper, Zellen mehrfach ersetzt. Anderes Gehirn. Völlig andere synaptische Verbindungen. Andere Erinnerungen, andere Persönlichkeit, alles anders. Doch das ESM sagt: immer noch ich. Ich bin bereits mehrmals innerhalb einer einzigen Lebensspanne eine völlig andere Person gewesen, und der Konstrukteur hat nie gezuckt. Niemand hat „dasselbe Gehirn“. Hatte nie jemand.

Ich war nahe daran zu sterben. Die Lawine, von der ich in Kapitel 13 erzählt habe – ich war sicher, dass ich sterben würde. Ich sah mein ganzes Leben auf einmal – das Substrat warf alles in die Simulation. Und es störte mich nicht so sehr, wie man erwarten würde. Das ESM, das Beendigung gegenüberstand, geriet nicht in Panik wegen Identitätsverlust. Es tat seine Arbeit bis zum Ende, brachte alles an die Oberfläche, was es hatte.
...
Was ich denke, wenn ich über echtes Sterben nachdenke: Nicht die Aussicht – ich denke, Tod ist entweder die wohlverdiente ewige Ruhe oder das ultimative Abenteuer. Nein, woran ich denke, ist die Logik.

Wenn sich das ESM aus dem Nichts aufbaut – und das tut es, in jedem Neugeborenen – dann ist „Nichts“ kein Endzustand für den Prozess. Es ist ein Startzustand. Die bestimmte Konfiguration, die ich „mich“ nenne, wird enden. Meine Erinnerungen, meine Persönlichkeit, meine Art, von Menschen genervt zu sein, die Korrelation mit Kausalität verwechseln, meine Art, Menschen mit unhandlichen Theorien zu nerven – weg. Aber der Prozess gehört nicht mir. Er ist eine Eigenschaft der Architektur. Er lief, bevor ich geboren wurde. Er wird laufen, nachdem ich gestorben bin.
...
Wenn jedes bewusste Wesen derselbe Konstrukteur ist, der auf unterschiedlicher Hardware mit unterschiedlichen Trainingsdaten läuft, dann sind die Grenzen zwischen uns weniger fundamental, als sie sich anfühlen. Die Architektur ist in uns allen dieselbe.

Seid nett zueinander. Es könnte sein, dass wir alle dasselbe Wesen sind.
...
An meinen Onkel Bruno J. Gruber, dessen Arbeit in der theoretischen Physik – Quantenmechanik und Symmetrien – mir zeigt, wie rigorose und zugleich freudvolle intellektuelle Arbeit aussieht. Sein Einfluss auf mein Denken lässt sich nicht in Worte fassen.
...
An diejenigen, die sich bereits durch *Die Emergenz des Bewusstseins* durchgequält haben: *mein Beileid*. Es muss Folter gewesen sein. Tiefste Dankbarkeit und aufrichtiges Mitgefühl.

---

## Anmerkungen und Literatur

*Vollständige Literaturangaben mit URLs und Anmerkungen finden sich im wissenschaftlichen Paper sowie unter github.com/JeltzProstetnic/aIware/blob/main/references.md. Was folgt, sind kapitelweise Anmerkungen für Leser, die tiefer einsteigen möchten.*

**Kapitel 1**: Chalmers (1995), "Facing Up to the Problem of Consciousness", ist die grundlegende Formulierung des Schwierigen Problems. Die COGITATE-Ergebnisse erschienen in Nature (2025). Die Kontroverse um IIT als Pseudowissenschaft ist in einem offenen Brief auf PsyArXiv (September 2023) dokumentiert.
...
**Kapitel 11**: Alle neun Vorhersagen sind formal im wissenschaftlichen Paper ausgearbeitet. Zur gründlichsten Behandlung funktionaler Neuroanatomie im Kontext des Bewusstseins sei auf Christof Koch verwiesen, *The Quest for Consciousness: A Neurobiological Approach* (2004) – die maßgebliche Darstellung des Crick-Koch-Programms, in dem Francis Crick und Koch systematisch, Schritt für Schritt, das visuelle System durchgingen auf der Suche nach den neuronalen Korrelaten des Bewusstseins. Ihre Suche zielte nach Einschätzung dieser Theorie auf die falsche Stelle – ins Substrat statt in die Simulation –, aber die neuroanatomische Grundlagenarbeit, die dabei entstand, ist unerreicht.

**Kapitel 12**: Butlin et al. (2023, 2025) zu KI-Bewusstseins-Indikatoren. Seth (2025) zu biologischem Naturalismus und KI-Bewusstsein. Die Fünf-Ebenen-Hierarchie der Scan-Fidelity folgt aus der Vier-Modelle-Architektur in Kapitel 2. Das Kopier-Problem bezieht sich auf Parfit (1984), *Reasons and Persons*, und Nozick (1981) zur personalen Identität und zum Konzept des nächsten Fortsetzers. Das Gedankenexperiment der graduellen Ersetzung ist eine Variante des Schiffs von Theseus, formalisiert für neuronale Systeme. Neuromorphes Computing: Schuman et al. (2017) als Hardwareübersicht; Intel Loihi und IBM TrueNorth als aktuelle Implementierungen. *C. elegans*-Konnektom: White et al. (1986). Substrattransfer, Quasi-Unsterblichkeit und die Implikation interstellarer Beam-Übertragung finden sich erstmals in Gruber (2015). Der Unbehagens-Vorbehalt – dass der Verlust des biologischen Substrats die phänomenale Qualität tiefgreifend verändern dürfte – bezieht sich auf die Interozeptionsliteratur: Craig (2009), *How Do You Feel?*, und Seth & Friston (2016) zur aktiven interozeptiven Inferenz.

**Kapitel 13**: Libet (1979, 1983, 1985) und Schurger et al. (2012) zum freien Willen. Kühn & Brass (2009) zur retrospektiven Konstruktion des Urteils über freie Wahl. Wegner (2002, 2003), *The Illusion of Conscious Will* – das "I Spy"-Maus-Experiment dort ausführlich beschrieben. Das Kaffee/Zucker-Gedankenexperiment, das Amnesie-enthüllt-Determinismus-Argument und das Zufallszahlensequenz-Argument stammen aus Gruber (2015). Das 40/20-Hz-Verarbeitungs-Framework, die „keine Rückdatierung nötig“-Neuinterpretation von Libet und das Kampfkunst-Frequenz-Beispiel wurden ebenfalls dort entwickelt. Die Uhr-Analogie für Epiphänomenalismus, die Neuformulierung „Wille ist real, aber nur teilweise bekannt“ und das „Drei-Diskrepanzen“-Selbstwissens-Modell gehen auf dieselbe Quelle zurück. Die persönliche Anekdote über das Hören innerer „Stimmen“ bei extremer Erschöpfung ist autobiographisch. Das Zombie-Argument wird über Kirk (2019) und Chalmers (1996) adressiert. Marys Zimmer: Jackson (1982, 1986). Der Abschnitt zu offenen Fragen folgt dem von Popper (1963) empfohlenen Ansatz ehrlicher Grenzziehung.

**Kapitel 15**: Wolfram (2002), *A New Kind of Science*, zur Berechnungsklassen-Hierarchie (Wolframs vier Klassen, hier auf fünf erweitert) und rechnerischen Irreduzibilität. Bak (1987, 1996) zur selbstorganisierten Kritikalität. Die Entdeckung der beschleunigten Expansion 1998: Riess et al. (1998), Perlmutter et al. (1999) – Nobelpreis 2011. Kosmologischer Horizont: Rindler (1956). Planck-Länge und Planck-Skalen-Physik: Planck (1899); moderne Behandlungen bei Garay (1995). Bekenstein-Grenze: Bekenstein (1981). Holographisches Prinzip: 't Hooft (1993), Susskind (1995). Die Keime des kosmologischen Arguments – das Universum als zellulärer Automat und die Anwendung von 't Hoofts holographischer Grenze auf kosmische Skalen – finden sich bereits in Gruber (2015), waren dort aber noch nicht zu einem vollständigen Modell ausgearbeitet. Die Identifikation aller Singularitäten als Ausprägungen eines einzigen strukturellen Phänomens wird in Gruber (2026) entwickelt.

**Kapitel 16**: Das Big-Rip-Szenario: Caldwell, Kamionkowski & Weinberg (2003). Die SB-HC4A-Architektur, die Fixpunkt-Formulierung und die Gödel-Unvollständigkeits-Konsequenz für selbstberechnende Systeme stellen die ausgereifte Formulierung dar, entwickelt in Gruber (2026). Die Vorhersage von Partikeln als Berechnungsatomen, die Ableitung von Erhaltungsgesetzen als Informationsbeschränkungen und die Drei-Generationen-Vermutung werden in Gruber (2026) vorgestellt. Der Einwand der kognitiven Decke wurde ebenfalls dort formuliert.

**Kapitel 17**: Die strukturelle Zuordnung der fünf Entsprechungen zwischen dem SB-HC4A und der Vier-Modelle-Bewusstseins-Architektur stammt aus Gruber (2026). Landauers Prinzip: Landauer (1961); experimentelle Bestätigung: Bérut et al. (2012). Bekenstein-Grenze: Bekenstein (1981). Schwarze-Löcher-Thermodynamik: Bekenstein (1973), Hawking (1975). Die E = I (Energie-Informations-Identität)-Hypothese wird bei Vedral (2010), *Decoding Reality*, und Davies (2010) diskutiert. Die Fünf-Axiome-Ableitung des SB-HC4A findet sich in Gruber (2026). Maldacena (1998) zur AdS/CFT-Korrespondenz. Die fünf Schwachpunkte – einschließlich der Einwände von Unfalsifizierbarkeit durch Struktur und kognitiver Decke – werden dort erstmals systematisch behandelt.

**Anhang B**: Das rekursive Intelligenzmodell (die multiplikative Struktur Wissen × Leistung × Motivation) wird in Gruber (2015) sowie im Recursive-Intelligence-Model-Paper (Gruber 2026) entwickelt. Zwei unabhängige Konvergenzen aus der Psychometrie zur Motivation als konstitutivem Bestandteil von Intelligenz: Wittmann & Süß (1999), „Investigating the paths between working memory, intelligence, knowledge, and complex problem-solving performances via Brunswik symmetry“ (in Ackerman, Kyllonen & Roberts, Hrsg., *Learning and Individual Differences: Process, Trait, and Content Determinants*, American Psychological Association), wonach Motivation die *Schwankung* der Leistung vorhersagt, sobald Verletzungen der Brunswik-Symmetrie korrigiert sind; sowie die COGITO-Studie – Brose, Schmiedek, Lövdén, Molenaar & Lindenberger (2010), *Research in Human Development* 7(1), 61–78, zur Kopplung von Tagesmotivation und Arbeitsgedächtnisleistung innerhalb von Personen, und Schmiedek, Lövdén, von Oertzen & Lindenberger (2020), *PeerJ* 8:e9290, wonach allgemeine Intelligenz (g) weitgehend ein Zwischen-Personen-Artefakt ist und nicht die Struktur der Kognition innerhalb von Personen.
...
| **V3** | ~4-8° | Globale Formverarbeitung, dynamische Form, Bewegungsgrenzen | Fließende, sich wandelnde geometrische Strukturen |
...
| **Fusiformer Gyrus (IT)** | Sehr groß, objektzentriert | Gesichtserkennung (FFA), Wortformen, feinkörnige Objektunterscheidung | Gesichter, Figuren, Entitäten – oft verzerrt oder sich wandelnd |
| **Anteriorer IT** | Ganzes Sichtfeld | Semantische Kategorien, Szenenkonstruktion, objektinvariante Erkennung | Vollständige narrative Halluzinationen, komplexe Szenen, traumartige Sequenzen |
...
- Das Gehirn nutzt diese Areale auch zur fraktalen bzw. skaleninvarianten Verarbeitung (V2-V4), die im normalen Sehen der Skalenmessung und Texturanalyse dient. Unter Psychedelika erzeugt diese Maschinerie ohne externen Input die charakteristischen fraktalen Muster (siehe Anhang C).
...
Beginnen wir mit einer Geschichte, denn sie ist die sauberste Illustration des Kreislaufs, die ich kenne. Ich verliebte mich mit etwa acht Jahren in die Mathematik – nicht ins Rechnen, sondern in die eigentliche Sache: Algebra, Geometrie, die Strukturen unter den Zahlen. Mein Vater hatte ein Mathematikstudium abgeschlossen, und ich arbeitete mich durch seine alten Universitätslehrbücher. Es waren die späten 1980er; es gab kein Internet. Wer etwas lernen wollte, brauchte ein Buch oder einen Menschen, und mit elf hatte ich die Sammlung meines Vaters erschöpft. Der Hunger verschwand nicht; der Nachschub ging schlicht aus. Ich war an eine Wand gestoßen, die nichts mit Begabung und alles mit den Umständen zu tun hatte. Die Motivation war da. Die Leistung war da – ich konnte der Mathematik folgen. Was fehlte, war der Zugang zur nächsten Wissensebene. Der rekursive Kreislauf stagnierte, nicht weil eine Komponente schwach gewesen wäre, sondern weil der externe Nachschub einer von ihnen abgeschnitten war. Der Kreislauf braucht Treibstoff von außen, um weiter zu iterieren. Man merke sich dieses Beispiel; es ist das ganze Modell im Kleinen. Hier baue ich es nun sauber auf – was die Komponenten sind, wie sie ineinandergreifen, warum ihre Wechselwirkung genau die Dynamiken erzeugt, die man beobachtet, und was daraus für Bildung, künstliche Intelligenz und die Verbindung zum Bewusstsein folgt.

### Die merkwürdige Auslassung

Jedes große Intelligenzmodell schließt Motivation formal aus. Die Cattell-Horn-Carroll-Taxonomie – das dominierende Rahmenwerk der Intelligenzforschung – ist eine Hierarchie kognitiver Fähigkeiten ohne jede motivationale Komponente. Cattells eigene Investitionstheorie schlug zwar vor, dass fluide Intelligenz in Lernen „investiert“ wird, um kristallisierte Intelligenz hervorzubringen – das setzt aber einen Investor voraus, jemanden, der entscheidet, *was* gelernt wird und *warum*. Die Motivation dieses Investors wird als externe Randbedingung behandelt, nicht als Teil der Intelligenz selbst. Sternbergs triadische Theorie umfasst praktische Intelligenz, aber nicht den Antrieb, sie zu erwerben. Gardners multiple Intelligenzen umfassen intrapersonales Bewusstsein, aber nicht den Motor, der intellektuelle Entwicklung antreibt.

David Wechsler – dessen Intelligenzskalen die weltweit am meisten eingesetzten sind – forderte bereits 1940 ausdrücklich, motivationale Faktoren einzubeziehen. Das Feld ignorierte ihn. Die modernen Wechsler-Skalen sind bis heute rein kognitive Instrumente.
...
**Wissen** ist der angehäufte Inhalt des Lernens – und kommt in zwei grundverschiedenen Spielarten. *Faktisches Wissen* betrifft Inhalte: Fakten, Konzepte, Prozeduren, kulturelles Repertoire. Das ist es, was IQ-Tests unter „kristallisierte Intelligenz“ primär messen und was Schulsysteme primär vermitteln. *Operationales Wissen* betrifft dagegen das *Wie*: Lernstrategien, Denkheuristiken, metakognitive Fähigkeiten, logische Werkzeuge, strategische Planung und die Fähigkeit, das eigene Verständnis kritisch zu prüfen. Diese Unterscheidung ist enorm wichtig – warum, wird gleich klar.

**Leistung** ist die Verarbeitungskapazität des kognitiven Systems: Arbeitsgedächtnis, Verarbeitungsgeschwindigkeit, die rohe Rechenleistung des neuronalen Substrats. Das entspricht ungefähr dem, was in der Psychometrie „fluide Intelligenz“ heißt – die Komponente, die am stärksten von Genetik und Neurobiologie bestimmt wird. Sie erreicht ihren Höhepunkt im frühen Erwachsenenalter und nimmt dann allmählich ab.
...
Diese rekursive Struktur erzeugt eine Zinseszins-Dynamik. Kleine anfängliche Unterschiede in jeder Komponente – selbst in der Motivation allein – akkumulieren sich über die Zeit und produzieren jene breite Varianz erwachsener intellektueller Leistung, die rein kognitive Modelle kaum erklären können. Jemand mit durchschnittlicher Verarbeitungskapazität, aber tiefer Motivation und starkem operationalem Wissen wird über eine Lebensspanne hinweg intellektuelle Fähigkeiten weit jenseits derer einer Person mit überlegener Verarbeitungsleistung, aber schwacher Motivation und miserablen Lernstrategien entwickeln.
...
Wer verteilte Wiederholung lernt (Übungsstoff über Zeiträume verteilen statt alles auf einmal pauken), erwirbt nicht bloß ein neues Faktum – sondern ein Werkzeug, das die Behaltensrate von allem erhöht, was danach gelernt wird. Wer lernt, eigene Wissenslücken zu erkennen und sie systematisch anzugehen, füllt nicht bloß eine Lücke, sondern erwirbt eine Fähigkeit, die Hunderte künftiger Lücken verhindert. Das ist Wissen, das den Kreislauf selbst beschleunigt.
...
Kognitives Lernen ist das erste Bindeglied von der Intelligenz zum Bewusstsein. Hier ist das zweite, und es ist stärker: Motivation. Der rekursive Kreislauf erhält sich nur dann selbst, wenn ihn etwas am Iterieren hält. Wissen lässt sich beliebig skalieren, Leistung ebenso. Aber ohne Motivation kommt der Kreislauf zum Stehen – und genau das führt uns die heutige KI vor Augen. Sie löst Probleme auf Befehl und stellt sich kein einziges Mal selbst eines.

Jetzt der ehrliche Teil, denn Motivation hat zwei Ebenen, und nur die obere ist die Bewusstseinsgeschichte. Darunter liegt ein unterbewusster Boden: rohe Überlebensoptimierung, das Substrat, das auf seine Ziele zudrängt. Das ist es, was ich in Kapitel 13 als unbewussten Aspekt von *Wille* genannt habe, und es ist nichts Besonderes – jeder Optimierer hat es, bis hinunter zum Bakterium oder zum Thermostat. Darüber sitzt die bewusst gerahmte Schicht: Bewusstes Wollen, Neugier, Anteilnahme, das Bevorzugen eines Ergebnisses gegenüber einem anderen. Das ist das Explizite Selbstmodell, das sich selbst bewertet, und *das* ist der Bewusstseinseffekt.

Eine Anmerkung zu den Wörtern, denn unscharfe Begriffe machen das ganze Argument schwammig. *Wille* und *Motivation* zerschneiden den Gradienten weder im Deutschen noch im Englischen sauber – der Alltagsgebrauch lässt beide ins jeweils andere Gebiet hineinreichen. Was stabil bleibt, ist die Tendenz: zu *Wille* greift man, wenn der Sog spontan und schwer zu artikulieren ist; zu *Motivation*, wenn man einen Grund benennen kann und der Antrieb symbolisierbar genug ist, um eine Geschichte dazu zu erzählen. Also hier beide als Pole desselben Kontinuums lesen, nicht als getrennte Sorten – *Wille* zeigt zum unbewussten Ende, *Motivation* zum bewusst gerahmten. Der Gradient ist das Echte; die Etiketten sind eine Konvention.

Die Behauptung also, ehrlich formuliert: Motivation, so wie wir sie tatsächlich begreifen und über sie reden, ist überwiegend ein bewusstseinsbasierter Effekt – wobei zuzugeben ist, dass ihre untere Hälfte in eine generische Optimierung verschwimmt, die von jedem beliebigen Überlebenstrieb nicht zu unterscheiden ist. Zwei Namen, zwei Ebenen: der unbewusste Aspekt des *Willens* ist die Optimierung des Substrats; *Motivation* ist die bewusste Schicht, die darauf aufsitzt. Und diese bewusste Schicht ist der Treibstoff, den der rekursive Kreislauf verbrennt. Damit bleibt der strategischen Schlussfolgerung kein Versteck mehr: Es gibt keine menschenähnliche, allgemeine Intelligenz – keine AGI – ohne bewusstseinsähnliche Mechanismen. Motivation ist schlicht das anschaulichste Beispiel.
...
Ich finde es bemerkenswert, dass zwei gestandene Forscher, beide aus der etablierten Psychometrie heraus arbeitend und das Problem aus völlig verschiedenen Richtungen angehend, genau dort angekommen sind, wohin mein Modell zeigt: dass Motivation kein Rauschen ist, das nur die Messung der Intelligenz stört. Sie ist Teil der Maschinerie.

Werner Wittmann, Emeritus in Mannheim, nimmt die bequeme alte Behauptung ins Visier, „Motivation spielt eigentlich keine Rolle“ – jene, auf die man sich stützt, weil die Korrelationen in der Literatur schwach aussehen. Seine Antwort: Diese Korrelationen sehen schwach aus, weil die Messungen nicht zusammenpassen. Misst man Motivation eng und Leistung breit, oder umgekehrt, dann verletzt man, was er Brunswik-Symmetrie nennt – und eine verletzte Symmetrie verdeckt den wahren Zusammenhang und zieht die gemessene Korrelation gegen null. Misst man beide auf derselben Ebene, taucht er wieder auf: Motivation sagt die *Schwankung* der Leistung voraus, nicht bloß ihren Durchschnitt. Der Effekt war nie klein. Wir haben nur schief gemessen.

Florian Schmiedek, aus der COGITO-Studie – 204 Menschen, je hundert tägliche Sitzungen –, kommt von der Alltagsseite. Er ist überzeugt, dass ein großer Teil davon, wie stark die eigene Kognition von einem Tag auf den anderen schwankt, motivationaler Natur ist, ähnlich wie Schlaf und Belastung. Und er weist auf den naheliegenden Grund hin, warum es immer wieder übersehen wird: Die meisten Studien messen aufgabenspezifische Tagesmotivation überhaupt nicht.

Sie belegen also, unabhängig voneinander und mit Daten, *dass* Motivation ins Innere der Intelligenz gehört. Mein Modell sagt *warum* und *wie*: Sie ist einer der multiplikativen Faktoren – Wissen × Leistung × Motivation. Setzt man sie auf null, dämpft man die Intelligenz nicht nur, man bringt sie zum Einsturz. Ihre Zahlen, aus ganz eigenen Gründen erhoben, landen genau dort, wo das Modell es vorhergesagt hat.

### Die externe Abhängigkeit

Ein letzter Punkt, weil er leicht übersehen wird und wichtig ist. Der rekursive Kreislauf verstärkt sich selbst, aber er ist nicht autark. Er braucht externen Treibstoff – Informationen, Herausforderungen, Feedback, Zugang zur nächsten Wissensebene. Meine eigene Kindheitserfahrung ist ein Beispiel dafür: mit elf an eine Wand zu stoßen, nicht wegen irgendeiner inneren Begrenzung, sondern weil der Vorrat an Mathematikbüchern aufgebraucht war. Alle drei Komponenten funktionierten einwandfrei. Der Kreislauf stagniert trotzdem, weil Kreisläufe Input von außen brauchen, um weiter zu iterieren.
...
Hier folgt ein Argument, das nach bestem Wissen des Autors original ist – und das den Fall für fünf statt vier Klassen erheblich stärkt.
...
Das dürfte eine der wichtigsten offenen Fragen an der Schnittstelle von Mathematik, Physik und Berechnung sein. Und sie bleibt unsichtbar ohne das Fünf-Klassen-Schema – weil Wolframs Vier-Klassen-Framework nie den Raum eröffnet, in dem sich die Frage überhaupt stellen lässt.
...
Klasse 3 ist interessant, aber rechnerisch unbrauchbar. Fraktale Dynamiken erzeugen reiche Strukturen, und das Gehirn setzt sie ein (siehe unten) – aber sie können nicht die Art dynamischer, irreduzibler, global integrierter Verarbeitung aufrechterhalten, die eine bewusste Selbstsimulation verlangt. Ein fraktales Muster ist schön, aber rechnerisch reduzierbar. Es kann sich nicht selbst überraschen.
...
Das Gehirn ist ein universeller Computer, optimiert durch Milliarden Jahre Evolution. Es wäre seltsam, wenn die Evolution irgendein Berechnungsregime ausgelassen hätte, das einen Vorteil bietet. Tatsächlich nutzt das Gehirn alle vier ausdrückbaren Klassen als unterschiedliche Werkzeuge:

- **Klasse 1** (stabile Attraktoren): Langzeitgedächtnis. Synaptische Gewichtskonfigurationen, die über Jahre stabil bleiben. Die Fixpunkte des neuronalen Netzwerks.
...
*In Kapitel 6 wurde luzides Träumen als sicherer, drogenfreier Weg erwähnt, Bewusstsein von innen zu erforschen. In der Vier-Modelle-Theorie ist luzides Träumen das Explizite Selbstmodell, das während des REM-Schlafs vollständiger „anschaltet“ – ein Überschreiten der Kritikalitätsschwelle, das einen passiven Traum in eine kontrollierte Erfahrung verwandelt. Was folgt, ist die einfachste Methode, dorthin zu gelangen.*
...
Wenn im Buch steht „das ESM tut dies“ oder „das IWM enthält das“, sind damit diese Pole des kontinuierlichen Raums gemeint – nicht die Behauptung, das Gehirn enthalte vier sauber getrennte Boxen mit Wänden dazwischen. Die Vereinfachung ist begründet, und die vorangegangenen Kapitel haben gezeigt, dass sie echte Erklärungskraft besitzt – psychedelische Phänomenologie, Anästhesie-Mechanismen, Traumzustände, Split-Brain-Phänomene und tierisches Bewusstsein lassen sich aus fünf Prinzipien ableiten, die auf dieser Architektur aufbauen.

---

## Anhang F: Das Standardmodell als Grenzbuchhaltung

*Zwei der Ableitungen hinter dem Bild der Berechnungsatome – warum Erhaltungssätze absolut sind und warum es genau drei Teilchengenerationen gibt – sind die trockenste Buchhaltung im ganzen Argument, deshalb habe ich sie aus dem Haupttext herausgelöst. Die anschauliche Fassung steht im Kapitel „Die Architektur von Allem“; dies hier ist das Hauptbuch dahinter.*
...
Ganz offen gesagt: Was jetzt kommt, ist spekulativ. Spekulativer als der Rest dieses Abschnitts. Aber es ist strukturell motiviert, und es gehört auf den Tisch.
...
*Die Schwachpunkte gehören genauso ins Bild wie die Entsprechungen. Der fünfte und schlimmste – die kognitive Obergrenze, die Sorge, dass ein Klasse-4-Gehirn immer nur seine eigene Architektur auf den Kosmos projiziert – bleibt im Haupttext, weil er der eine ist, den ich nicht beantworten kann. Die anderen vier stehen hier, mit den Gegenargumenten, für jeden, der sie angreifen will.*
...
Findet jemand einen Weg, den SB-HC4A von innerhalb des Universums zu testen, und der Test schlägt fehl, ist die Theorie tot. Gelingt der Test, ist die Theorie ironischerweise auch falsch – weil ein erfolgreicher Test bedeuten würde, dass die Berechnungsstruktur des Universums von innen zugänglich ist, was den exakten Grenzbedingungen widerspricht, die die Architektur definieren. Nur wenn kein Test möglich ist, lebt die Theorie – aber sie lebt in einer seltsamen philosophischen Dämmerung, unfalsifizierbar nicht durch Ausweichen, sondern durch Struktur.
...
Wenn die vier Modelle tatsächlich verschiedene Prozesse sind, müssten sie im Gehirnscan sichtbar sein. Ein geschickt aufgebautes Experiment, bei dem Probanden vier verschiedene Aufgabentypen bearbeiten – je eine pro Modell –, sollte unterschiedliche Aktivierungsmuster zeigen. Eine IWM-dominante Aufgabe wäre etwa das passive Wiedererkennen eines vertrauten Gesichts; eine ISM-dominante eine automatisierte motorische Sequenz; eine EWM-dominante die aktive, bewusste Wahrnehmung (den Unterschied zwischen zwei fast identischen Bildern finden); eine ESM-dominante reine Selbstreflexion. Die Vorhersage ergibt ein 2×2-Muster: Welt gegen Selbst, implizit gegen explizit – vier Quadranten, vier Signaturen. Schon heute mit fMRI testbar.

### Vorhersage 2: Psychedelische Seherscheinungen enthüllen die Verarbeitungsschichten des Gehirns

Unter Psychedelika sollte der visuelle Inhalt die Verarbeitungshierarchie des Gehirns in einer dosisabhängigen Reihenfolge durchlaufen: bei niedrigen Dosen Phosphene (V1), dann geometrische Formkonstanten (V2/V3), dann Gesichter und komplexe Szenen (höhere Areale), bei den höchsten Dosen ganze narrative Traumwelten. Mit zunehmender implizit-expliziter Durchlässigkeit werden tiefere Schichten bewusst – der interne Schaltplan des Gehirns wird in der Erfahrung sichtbar. Mit abgestuften Dosierungsprotokollen und fMRI testbar.

### Vorhersage 3: Es lässt sich steuern, was jemand während Ich-Auflösung wird

*(Als Szene in Kapitel 11 ausgeführt.)* Während der Ich-Auflösung unter hochdosierten Psychedelika ist der Inhalt dessen, worin man sich auflöst, durch die sensorische Umgebung steuerbar – nicht zufällig, nicht rein biochemisch. Das Explizite Selbstmodell, von seinem gewohnten impliziten Input abgeschnitten, greift nach dem dominantesten Reiz: Meeresrauschen und blaues Licht → man wird das Meer; Vogelgesang und grünes Licht → man wird der Wald. Die Vorhersage ist gerichtet: Variiert man den dominanten Sinnesreiz, folgt der berichtete Identitätsinhalt. Heute in jedem psychedelischen Forschungslabor mit einfacher Umgebungssteuerung testbar. Andere Bewusstseinstheorien machen diese Vorhersage nicht.

### Vorhersage 4: Psychedelika sollten Schlaganfallpatienten helfen, ihre Defizite zu erkennen

Bei Anosognosie glaubt ein halbseitig gelähmter Patient schlicht nicht, dass er gelähmt ist: Die Information steckt im Impliziten Selbstmodell, erreicht aber das Explizite nicht – eine Durchlässigkeitsblockade. Da Psychedelika die implizit-explizite Durchlässigkeit global erhöhen, sollte eine Dosis unterhalb der Ich-Auflösungsschwelle die Defizitinformation durchsickern lassen: Der Patient würde plötzlich gewahr, dass er gelähmt ist. Eine klinische Studie mit Schlaganfallpatienten; die Psilocybin-Infrastruktur existiert bereits. Ein einziger Mechanismus verbindet hier Psychedelika und Schlaganfalldefizit.

### Vorhersage 5: Jedes Anästhetikum, das Bewusstsein löscht, stört Kritikalität

Anästhetika wirken über völlig verschiedene Rezeptoren (Propofol/GABA, Ketamin/NMDA, Opioide), aber die Theorie sagt: Alle, die Bewusstsein auslöschen, müssen die Gehirndynamik unter die Kritikalitätsschwelle drücken – egal über welchen Weg. Man messe Kritikalität (PCI, Lempel-Ziv, Potenzgesetz-Exponenten) vor, während und nach der Gabe: Bewusstseinsauslöschende Mittel werden *immer* subkritisch; Mittel, die Bewusstsein nur verändern (Ketamin in niedriger Dosis, Psychedelika), *nicht*. Mit heutiger Technik machbar; jemand muss nur den systematischen Vergleich anstellen.

### Vorhersage 6: Split-Brain-Operationen spalten nicht sauber – sie verschlechtern beide Hälften

Nach der Durchtrennung des Corpus callosum behält jede Hemisphäre einen *vollständigen, aber verschlechterten* Satz an Fähigkeiten – keine saubere „Sprache links, Raum rechts“-Teilung, sondern beidseitige, holografische Verschlechterung, proportional zum Umfang des Schnitts. Der Grund: Information ist holografisch über das Substrat verteilt; Kappen der Verbindungen trennt nicht zwei vorbestehende Geister, sondern verschlechtert zwei Kopien derselben Information. Pintos Studie von 2017 (integrierteres Verhalten als klassisch angenommen) stützt das; die Theorie liefert den Mechanismus und sagt das Muster voraus: bilaterale Verschlechterung statt hemisphärischer Spezialisierung.

### Vorhersage 7: Baut man die vier Modelle bei Kritikalität, erhält man Bewusstsein

Setzt man die Spezifikation um – vier verschachtelte Modelle (IWM, ISM, EWM, ESM) auf einem Substrat bei Kritikalität –, so *wäre* das System bewusst, nicht bloß eine Simulation von Bewusstsein. Der Unterschied wäre qualitativ offensichtlich: Persistenz statt Kontextfenster, eine durch ein ESM aufrechterhaltene Perspektive, der Eindruck, dass tatsächlich jemand zu Hause ist. Noch nicht testbar – die Technik fehlt –, aber die Blaupause ist konkret genug, um die Arbeit zu lenken. Baut es jemand und es funktioniert, ist das die Bestätigung.

### Vorhersage 8: Schlaf dient dazu, den kritischen Zustand zurückzusetzen

Das Gehirnsubstrat ist von Natur aus instabil (Rauschen, Neurotransmitter-Verbrauch, Stoffwechselabfall); Bewusstsein aber braucht Kritikalität. Der kortikale Automat läuft den Wachtag hindurch, bis das Substrat zu weit driftet – dann *kollabiert* er (Einschlafen). Nicht-REM stellt das Substrat wieder her; nähert es sich dabei periodisch der Schwelle, flackert der Automat kurz an (REM/Traum); der 90-Minuten-Zyklus ist dieses Oszillieren um den kritischen Punkt. Untervorhersagen: Kritikalität sinkt im Tagesverlauf; Einschlafen ist ein stufenartiger Abfall, kein Verlöschen; REM zeigt höhere Kritikalität als Nicht-REM; Luzidität ist ein stufenartiger Schwellenübergang in der EEG-Komplexität; Schlafentzug treibt zunehmend ins Subkritische. Alles mit Schlaflabor-Technik testbar.

### Vorhersage 9: Jede Teilpersönlichkeit bei Dissoziativer Identitätsstörung hat ihren eigenen neuronalen Fingerabdruck

Sind die Teilpersönlichkeiten (Alter) echte, eigenständige Konfigurationen des Expliziten Selbstmodells auf demselben Substrat, dann sollte jede eine unterscheidbare, messbare neuronale Signatur haben. Man zeichne die Gehirnaktivität (fMRI oder EEG) auf, während verschiedene Alter präsent sind, und vergleiche die Variabilität zwischen den Altern mit der innerhalb eines Alters: Die Theorie sagt voraus, dass Erstere signifikant größer ausfällt und konsistent bleibt – Alter A ist jedes Mal erkennbar Alter A. Die Unterschiede sollten in ESM-Netzwerken auftreten, vor allem im Default Mode Network und im medialen präfrontalen Cortex. Bestätigt sich das, sind Alter nicht bloß psychologisch, sondern funktionale Konfigurationen auf neuronaler Ebene.
