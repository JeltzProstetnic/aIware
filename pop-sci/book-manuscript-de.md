...
Die Freundschaft zwischen Bernhard und mir ist wahrscheinlich das effizienteste ESM-Kalibrierungssystem, das ich kenne. Jeder Fehler, den der andere bemerkt und benennt, ist ein Korrektursignal: *Das Selbstmodell hat gerade etwas getan, das das Substrat nicht beabsichtigte.* Und weil die Kritik in echte Zuneigung gewickelt ist, verteidigt keiner von uns den Fehler. Wir aktualisieren. Das ist der Trick: Man braucht jemanden, dem man genug vertraut, um brutal zu sein, und eine Beziehung, in der Falschliegen lustig statt bedrohlich ist.
