...
Bruno J. Gruber, Quantenmechaniker und Symmetrieforscher, war eine große Inspiration für die theoretische Arbeit hinter diesem Buch.
...
All das passiert in weniger als einer Sekunde. Und nichts davon ist bewusst. Man spürt nicht Photonen, die auf Zapfenzellen treffen, nicht Signale, die Axone entlangwandern, nicht Merkmalsdetektoren, die feuern. Man erlebt einen Apfel. Ein einheitliches, stabiles, dreidimensionales Objekt in einer kohärenten räumlichen Umgebung, mit einem bestimmten Aussehen, Gefühl und Bedeutung. Was wir erfahren, ist ein Modell – eine Echtzeit-Simulation des Apfels, erzeugt vom Gehirn aus den Rohdaten und allem, was es zuvor über Äpfel, Objekte, Tische und Physik gelernt hat.
...
Die Theorie sagt nicht, Schmerz sei eine Illusion. Sie sagt, Schmerz ist real — real in der Simulation, nicht in den Neuronen. Und da das gesamte Leben innerhalb der Simulation stattfindet, ist das die einzige Art real, die zählt.

Das ist die entscheidende Unterscheidung. Wer sie übersieht, wird diese Theorie mit Eliminativismus verwechseln, mit Illusionismus, mit jedem anderen Rahmenwerk, das Bewusstsein zu erklären versucht, indem es das Bewusstsein wegerklärt. Die Vier-Modelle-Theorie erklärt Bewusstsein nicht weg. Sie erklärt, wo Bewusstsein lebt.

### Was "Real innerhalb der Simulation" bedeutet

Hier gibt es eine philosophische Feinheit, die es lohnt aufzudröseln. Wenn ich sage, Qualia sind „real innerhalb der Simulation", könnte man zweierlei heraushören. Entweder sie sind *genuin phänomenal* – dann hat sich das Mysterium bloß von den Neuronen in die Simulation angesiedelt, und das Schwierige Problem lebt unter neuer Adresse weiter. Oder sie sind *funktional real, aber nicht genuin phänomenal* – dann ist das Dennett mit Extraschritten.
...
Bach sagt dir, *was* Bewusstsein ist. Ich sage dir, *woraus* es besteht und *wann* es sich einschaltet. Dasselbe Ziel, aber ich habe die Baupläne mitgebracht.
...
Ein Gehirn im Tiefschlaf, durchzogen von langsamen Deltawellen, steckt in periodischer Dynamik: repetitiv, kommt nirgendwohin. Die Modelle sind noch da im Substrat, aber die Simulation läuft nicht. Ein Gehirn im generalisierten Anfall wird von einer Flut gleichzeitiger Mit-Aktivierung über den kritischen Rand gedrückt, die in ein einziges grobes Regime kippt — starre Hypersynchronie, davonlaufendes Chaos oder beides im Wechsel —, und die Simulation kann nicht zusammenhalten. Nur im Wachzustand – balancierend am Rand des Chaos – hält das System bewusste Erfahrung aufrecht.
...
**Regler eins fragt: Wie weit wandert eine Welle?** Drehe ich ihn ganz herunter, ist der Ozean ein gefrorener Spiegel — der Stein fällt, macht *plopp*, und nichts geschieht; ein Kräuseln, das sofort stirbt. Drehe ich ihn ganz auf, peitscht ein einziger Kiesel den ganzen Ozean zum Sturm; eine einzelne Störung überschwemmt alles auf einmal. Dazwischen liegt der süße Punkt: Die Welle wandert, zeugt im Schnitt eine neue, stirbt nicht und explodiert nicht. Wie ein Sandhaufen, der exakt im Schüttwinkel liegt, bei dem ein weiteres Korn eine Rutschung jeder Größe auslösen kann. Dieser Regler entscheidet über *Reichweite* — wie viel vom Ozean ein einzelnes Geschehen in einen zusammenhängenden Prozess zieht. Nenn ihn den **Ausdehnungs**-Regler.

**Regler zwei fragt: Welche Formen können überhaupt auf dem Ozean leben?** Das ist der Game-of-Life-Regler — der, auf dem die ganze Theorie reitet. Ein gefrorener Spiegel hat keine Formen; nichts bewegt sich. Eine sanfte, regelmäßige Dünung hat nur eine Form, dieselbe Welle wieder und wieder — hübsch, aber dumm; sie rechnet nichts. Ein kochendes Chaos lässt jeden Punkt zufällig flackern — auch das rechnet nichts. Nur an der Kante zwischen Ordnung und Kochen entstehen *Gleiter*: stehende Muster, die wandern, zusammenstoßen, überdauern und etwas tun. Dort, und nur dort, kann eine Berechnung — und ein Selbstmodell — als stabile Form auf dem Wasser existieren. Nenn ihn den **Komplexitäts**-Regler.

Das sauberste Bild für diesen zweiten Regler kenne ich aus der Fliegerei: den Strömungsabriss, den Stall. Ein Flügel gibt den meisten Auftrieb genau an der Grenze — im steilsten Winkel, den er halten kann, einen Augenblick bevor die Strömung abreißt und in Turbulenz kippt. Ein Grad darüber bricht die glatte Strömung auf, und der Auftrieb bricht weg. Das Gehirn fliegt genau an diesem Vor-Stall-Rand: maximale Berechnung, ein Grad bevor die Dynamik ins Chaos kippt. Drückt man darüber hinaus, bricht der „Auftrieb" — die Fähigkeit, Gleiter zu tragen, zu rechnen, bewusst zu sein — zusammen, so wie der Auftrieb im Stall zusammenbricht.

Meist steigen und fallen die beiden Regler zusammen, weshalb ein Wort gewöhnlich genügt. Aber sie können auseinandertreten, und dann erklären sie die Fälle, die die Ein-Knopf-Geschichte nicht erklärt. Ein Topf kochendes Wasser hat den ersten Regler aufgedreht — eine Störung breitet sich überall aus —, aber den zweiten am Boden: keine Gleiter, nur Aufruhr. Viel Ausbreitung, keine Formen, und kein Bewusstsein, genau wie zu erwarten.

Ein generalisierter Anfall ist der Fall, der endgültig festnagelte, was der erste Regler wirklich misst. In einem Anfall feuert ein enormer Anteil des Gehirns auf einmal — nach roher Zahl „aktiver" als in jedem normalen Wachmoment. Wäre Bewusstsein bloß „viele aktive Neuronen", wäre ein Anfall der bewussteste Zustand überhaupt. Es ist das Gegenteil. Diese Flut von Aktivität kippt aus dem Rand-des-Chaos-Regime in eine einzige grobe Form — die ganze Fläche in einen groben Gleichtakt gerissen oder ins davonlaufende Chaos geworfen —, und die differenzierte, gleitertragende Berechnung verschwindet. Der erste Regler kann also nicht bloße Mit-Aktivierung messen; er muss messen, wie viel Gehirn in echte Rand-des-Chaos-Dynamik verwickelt ist. In einem Anfall stürzt diese Zahl trotz allen Feuerns ab. Dass viel Gehirn *aktiv* ist, ist nicht dasselbe, wie dass viel Gehirn *bewusst* ist. Behalte diese zwei Regler im Kopf; die seltsamsten Zustände, in die ein Gehirn geraten kann, sind nur verschiedene Einstellungen von ihnen — am Ende dieses Buches werden sie erklären, warum manche Menschen in einer halben Sekunde ein ganzes Leben durchleben.
...
Schlafwandler berichten davon immer wieder. Jemand wacht am Schreibtisch auf, vor sich hingekrakelte Notizen – linkshändig geschrieben, was im Wachzustand nie vorkommt. Ein fragmentarisches Bild ist noch da: im Kreis an den Wänden entlang, die Tür suchend, sie nicht findend. Aber der Teil, in dem der Gang zum Schreibtisch stattfand und die Hand zu schreiben begann – vollständig dunkel. Das Substrat navigierte, motorische Programme liefen, aber die Simulation – das „Ich" – war nicht da.

Das ist die Theorie im Kleinen. Ein Körper, der sich durch die Welt bewegt, räumliche Informationen verarbeitet, gelernte motorische Programme ausführt – alles ohne ein bewusstes Selbst in der Schleife. Die impliziten Modelle führen Regie. Die expliziten Modelle sind abgeschaltet. Und das Ergebnis ist ein Mensch, der geht, handelt und sogar schreibt – aber niemand ist zu Hause.
...
Luzides Träumen lernen heißt, die Simulation beim Schummeln zu erwischen. Eine bewährte Methode ist der Lichtschalter-Test: Man betätigt den ganzen Tag über gewohnheitsmäßig Lichtschalter und fragt sich, ob das Licht sich korrekt verändert hat. Im Wachleben tut es das immer. Im Traum funktionieren Lichtschalter nicht – das Explizite Weltmodell, das auf internen Daten läuft, verschwendet keine Rechenzeit auf die Physik elektrischer Schaltkreise. Betätigt man im Traum einen Schalter und das Licht verändert sich nicht, oder der Raum wird dunkler, oder der Schalter fühlt sich falsch an – diese Diskrepanz ist das Explizite Selbstmodell, das eine Inkonsistenz in der Simulation erkennt. Und in dem Moment der Erkennung ist klar: Das hier ist ein Traum.

Die meisten brauchen Wochen oder Monate, bevor die Gewohnheit in ihre Träume übergeht. Aber wenn es funktioniert, ist der Übergang genau die sprunghafte Schwelle, die die Theorie vorhersagt. Einen Moment lang ist man passiver Statist in der Erzählung des Traums. Im nächsten voll präsent – sich bewusst, dass man träumt, sich bewusst, dass die Welt ringsum generiert ist, sich bewusst, dass man sie verändern kann. Das ESM hat sich zugeschaltet. Am Substrat hat sich nichts geändert. An der Dynamik hat sich nichts geändert. Aber die Einbindung des Selbstmodells in die Simulation hat eine Schwelle überschritten, und alles fühlt sich anders an.
...
Diese Unterscheidung – Propofol hebt Bewusstsein auf, indem es das Gehirn unter die Kritikalitätsschwelle zwingt; Ketamin verändert Bewusstsein, indem es die Dynamik über die Schwelle hinaus in den superkritischen Bereich verschiebt, bei gleichzeitig gestörtem Input – ist ein echter Erklärungsvorteil. Die meisten Theorien tun sich schwer zu erklären, warum zwei „Anästhetika" so radikal unterschiedliche Erfahrungen produzieren. Der Kritikalitätsrahmen macht die Unterscheidung ganz natürlich.

Ich hatte noch nie eine chemische Narkose. Aber ich wurde bewusstlos geschlagen – hart, plötzlich, ohne Vorwarnung. Und was mir im Rückblick auffällt, ist die totale Abwesenheit eines Übergangs. Schlaf hat Stadien. Psychedelika haben eine Anstiegskurve. Selbst Salvia, so schnell es wirkt, gibt einem den Bruchteil einer Sekunde „Etwas passiert". Ein K.o. gibt nichts. Einen Moment läuft die Simulation. Im nächsten erwacht man auf dem Boden, ohne Ahnung, wie viel Zeit vergangen ist. Kein Verdunkeln, kein Verblassen, kein Tunnel. Die Simulation verschlechtert sich nicht. Sie bricht ab. Der Schutzschalter springt.

Genau das wäre bei einer plötzlichen, massiven Störung der kortikalen Dynamik zu erwarten – ein augenblickliches Abfallen weit unter die Kritikalität. Keine Zeit für ein sanftes Herunterfahren durch die Schlafstadien. Das System durchläuft nicht den Weg von Klasse 4 über Klasse 3 nach Klasse 2. Es stürzt aus Klasse 4 ab, und die Simulation stoppt einfach.
...
Wer nur eine Sache aus diesem Kapitel behält, sollte sich dieses Paar merken. Jede andere Bewusstseinstheorie hat Mühe, auch nur einen dieser Zustände zu erklären. Die Vier-Modelle-Theorie sagt beide vorher.
...
Der Perturbational Complexity Index (dasselbe Maß, das Schlafstadien unterscheidet) sollte genau diese Fälle auseinanderhalten. Und das tut er. Einige Patienten, die als vegetativ diagnostiziert wurden, zeigen PCI-Werte mitten im bewussten Bereich. Sie sind keineswegs vegetativ. Sie sind Gefangene. Die medizinischen und ethischen Implikationen sind enorm – und die Vier-Modelle-Theorie sagt genau vorher, warum die Unterscheidung existiert und wie man sie erkennt.
...
Das sind keine Reflexe. Keine konditionierten Reaktionen. Das sind Beispiele eines Geistes, der den emotionalen Zustand eines anderen Geistes modelliert, Reaktionen vorhersagt und Pläne formuliert, um darauf einzugehen. Das ist das Explizite Selbstmodell, das aus der Dritte-Person-Perspektive arbeitet — genau das, was die Theorie als Kennzeichen erweiterten Bewusstseins identifiziert.
...
Aber es passiert noch etwas womöglich seltsameres als die Verzögerung.

Dabei geht es nicht darum, *wann* deine Erfahrung eintrifft, sondern *wie* der Zeitfluss überhaupt erst entsteht.

Und hier kommt eine Überraschung: Das Gefühl, dass Zeit *vergeht* — dieses Empfinden, dass ein „Jetzt" nach vorne gleitet, während der Augenblick davor dahinter weich wird —, wird nicht aus der realen Welt eingespeist. Da draußen steht keine Uhr, die dir die Gegenwart in die Hand drückt. Dein Gehirn baut den Fluss hier drinnen, und es baut ihn aus einem ganz bestimmten architektonischen Grund.

Die Sinneskanäle haben unterschiedliche „Taktung" und „Bandbreite" — Information kommt nicht abgestimmt aufeinander im Gehirn an, sondern eher so wie Blitz und Donner. Wenn man aufmerksam ist, kann man erkennen welcher Donner zu welchem Blitz gehört. Aber man erlebt einen glatten, ununterbrochenen Strom. Warum? Weil das System sich selbst dabei modelliert, wie es sich selbst modelliert, und diese Schleife lässt keinen Takt sauber zu Ende kommen und verschwinden. Jeder hallt durch die Rekursion zurück und blutet in den nächsten hinein. Die Grenze zwischen „jetzt" und „eben gerade" verschmiert — nicht aus Schlamperei, sondern weil eine selbstreferentielle Schleife genau das mit der Zeit macht. Sie verteilt jeden Augenblick über ein kleines Fenster.
...
Hier kommt es — denn einmal gesehen, lässt es sich nicht mehr übersehen.
