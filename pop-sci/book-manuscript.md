...
[FIGURE: Simple bubble diagram — based on German book p.64. Five circles: Environment, Sense Organs, World Model, Information Processing, Self Model. No axes, no technical detail. Just "here are the main pieces and how they relate." English version of Umwelt/Sinnesorgan/Metamodell/Wissensverarbeitungssystem/Selbstmodell.]
...
[FIGURE: Five-layer stack — simple vertical diagram. Bottom to top: Physical, Electrochemical, Proteomic, Topological, Virtual. Arrows showing "runs on" / supervenience. Consciousness marked at the Virtual level only.]
...
[FIGURE: Simple Real/Virtual Split — two regions divided by a clear boundary, minimal labels. Real side: "stored, physical, unconscious." Virtual side: "simulated, experienced, conscious." No individual models shown.]
...
[FIGURE: Illustration — first-person view from inside a vivid virtual world, edges dissolving into neural circuitry/code/synaptic patterns, showing the player IS the simulation. The emotional climax of the core claim. (Stable Diffusion generated, Matthias to create.)]
