...
\begin{figure}[htbp]
  ...
  \caption{La séparation réel/\allowbreak{}virtuel. Le substrat (versant réel) stocke le savoir dans les poids synaptiques : physique, structurel, inconscient. La simulation (versant virtuel) engendre l'expérience en temps réel : fugace, dynamique, consciente.}
\end{figure}
...
V5/\allowbreak{}MT & Traitement du mouvement & Rotation et déplacement de motifs \\[4pt]
Fusiform/\allowbreak{}IT & Visages, objets, formes de mots & Visages, figures, entités \\[4pt]
...
Sommeil paradoxal & Proche de la criticalité & EWM/\allowbreak{}ESM sur entrée interne & Dégradée (rêve) \\[4pt]
NREM profond & Sous-critique & EWM/\allowbreak{}ESM effondrés & Absente \\[4pt]
Propofol & Forcé sous-critique & EWM/\allowbreak{}ESM supprimés & Absente \\[4pt]
Kétamine & Au-delà du critique ($\uparrow$ entropie) & EWM/\allowbreak{}ESM sur mauvaise entrée & Présente, déconnectée \\[4pt]
Psychédéliques & À/\allowbreak{}au-delà du critique & Tous actifs, $\uparrow$ perméabilité & Présente, altérée \\[4pt]
...
\textit{Les références complètes, avec URL et annotations, figurent dans l'article scientifique ainsi qu'à l'adresse github.com/\allowbreak{}JeltzProstetnic/\allowbreak{}aIware/\allowbreak{}blob/\allowbreak{}main/\allowbreak{}references.md. Suivent des notes propres à chaque chapitre, destinées aux lecteurs qui souhaitent aller plus loin.}
...
\begin{itemize}
  ...
  \item \textbf{V5/\allowbreak{}MT (aire temporale moyenne)} --- Aire visuelle spécialisée dans le traitement du mouvement. Grands champs récepteurs. Responsable de la rotation et du déplacement des motifs perçus sous psychédéliques (chapitre 6).
...
\midrule\endhead
\textbf{V1} & ~1° & Détection des contours, fréquence spatiale, colonnes d'orientation & Phosphènes, constantes de forme de Klüver, surfaces qui respirent/\allowbreak{}miroitent \\[4pt]
...
\textbf{V4} & ~8-16° & Couleur, courbure, texture complexe, traitement à l'échelle fractale & Fractales colorées, motifs kaléidoscopiques, couleurs saturées/\allowbreak{}impossibles \\[4pt]
\textbf{V5/\allowbreak{}MT} & Grand, accordé au mouvement & Perception du mouvement, flux optique, codage de la vitesse et de la direction & Rotation, dérive et mouvement rythmique de tous les motifs visuels \\[4pt]
...
\textbf{Notes :}
\begin{itemize}
  \item Le gyrus fusiforme chevauche la frontière V4/\allowbreak{}IT et fait partie du cortex inférotemporal (IT). Il contient l'aire fusiforme des visages (FFA), identifiée par Kanwisher et al. (1997), qui est sélectivement activée par les visages.
...
3 & Aléatoire/\allowbreak{}chaotique & Règle 30 & Une apparence d'aléatoire. Aucune structure répétitive évidente. \\[4pt]
...
5 & Inexprimables & Véritablement infinie & \textbf{Inconnue} & N/\allowbreak{}A & N/\allowbreak{}A \\[4pt]
\bottomrule
\end{xltabular}
\normalsize
