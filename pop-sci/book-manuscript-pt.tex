...
\vspace{0.5cm}
\noindent Primeira edição, 2026\par
\vspace{0.5cm}
...
Na Teoria dos Quatro Modelos, isso é uma diminuição local da permeabilidade implícito-explícito. O ISM \textit{tem} a informação da paralisia --- o substrato registra o dano. Mas a fronteira está bloqueada para esse domínio específico, de modo que o EWM nunca inclui o déficit. A simulação do paciente não contém um braço paralisado, então o paciente não experimenta um.
...
Sono REM & Quase crítico & EWM/ESM em input interno & Degradada (sonho) \\[4pt]
NREM profundo & Subcrítico & EWM/ESM colapsados & Ausente \\[4pt]
Propofol & Forçado subcrítico & EWM/ESM suprimidos & Ausente \\[4pt]
Cetamina & Além do crítico ($\uparrow$ entropia) & EWM/ESM em input errado & Presente, desconectada \\[4pt]
...
\textbf{Déjà-vu: o modelo que combina bem demais}
...
\begin{itemize}
  ...
  \item \textbf{PCI (Perturbational Complexity Index)} --- Uma medida da complexidade cerebral desenvolvida por Massimini. Usada para avaliar o nível de consciência.
