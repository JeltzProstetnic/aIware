...
\begin{figure}[htbp]
  ...
  \caption{A divisão real/\allowbreak{}virtual. O substrato (lado real) armazena conhecimento em pesos sinápticos --- físico, estrutural, inconsciente. A simulação (lado virtual) gera experiência em tempo real --- transitória, dinâmica, consciente.}
\end{figure}
...
À medida que a dose aumenta ou a experiência se aprofunda, estágios de processamento mais complexos se tornam visíveis. O processamento no nível de V2/\allowbreak{}V3: padrões geométricos, fractais, tesselações, as famosas ``constantes de forma'' que Heinrich Klüver catalogou na década de 1920. São as representações intermediárias do sistema visual --- os elementos constitutivos que ele normalmente usa para construir sua experiência visual, agora visíveis por si mesmos.
...
V5/\allowbreak{}MT & Processamento de movimento & Rotação e movimento de padrões \\[4pt]
Fusiforme/\allowbreak{}IT & Rostos, objetos, formas de palavras & Rostos, figuras, entidades \\[4pt]
...
Sono REM & Quase crítico & EWM/\allowbreak{}ESM em entrada interna & Degradada (sonho) \\[4pt]
NREM profundo & Subcrítico & EWM/\allowbreak{}ESM colapsados & Ausente \\[4pt]
Propofol & Forçado subcrítico & EWM/\allowbreak{}ESM suprimidos & Ausente \\[4pt]
Cetamina & Além do crítico ($\uparrow$ entropia) & EWM/\allowbreak{}ESM em entrada errada & Presente, desconectada \\[4pt]
Psicodélicos & Na/\allowbreak{}além da criticalidade & Todos ativos, $\uparrow$ permeabilidade & Presente, alterada \\[4pt]
...
\textit{As referências completas, com URLs e anotações, estão disponíveis no artigo científico e em github.com/\allowbreak{}JeltzProstetnic/\allowbreak{}aIware/\allowbreak{}blob/\allowbreak{}main/\allowbreak{}references.md. O que segue são notas específicas de cada capítulo, para quem quiser se aprofundar.}
...
\begin{itemize}
  ...
  \item \textbf{V5/\allowbreak{}MT (área temporal média)} --- Área visual especializada no processamento do movimento. Campos receptivos grandes. Responsável pela rotação e pelo movimento dos padrões vistos sob psicodélicos (Capítulo 6).
...
\midrule\endhead
\textbf{V1} & ~1° & Detecção de bordas, frequência espacial, colunas de orientação & Fosfenos, constantes de forma de Klüver, superfícies que respiram/\allowbreak{}cintilam \\[4pt]
...
\textbf{V4} & ~8--16° & Cor, curvatura, textura complexa, processamento em escala fractal & Fractais coloridos, padrões caleidoscópicos, cores saturadas/\allowbreak{}impossíveis \\[4pt]
\textbf{V5/\allowbreak{}MT} & Grande, sintonizado ao movimento & Percepção de movimento, fluxo óptico, codificação de velocidade e direção & Rotação, deriva e movimento rítmico de todos os padrões visuais \\[4pt]
...
\textbf{Notas:}
\begin{itemize}
  \item O giro fusiforme está a cavalo da fronteira V4/\allowbreak{}IT e faz parte do córtex inferotemporal (IT). Ele contém a Área Facial Fusiforme (FFA), identificada por Kanwisher et al. (1997), que é ativada seletivamente por rostos.
  ...
  \item O cérebro também usa essas áreas para processamento fractal/\allowbreak{}invariante à escala (V2-V4), que serve à medição de escala e à análise de texturas na visão normal. Sob psicodélicos, essa maquinaria funcionando sem entrada externa produz os padrões fractais característicos (ver Apêndice C).
\end{itemize}
...
3 & Aleatório/\allowbreak{}caótico & Regra 30 & Aleatoriedade aparente. Nenhuma estrutura repetitiva óbvia. \\[4pt]
...
5 & Inexprimíveis & Verdadeiramente infinito & \textbf{Desconhecida} & N/\allowbreak{}A & N/\allowbreak{}A \\[4pt]
\bottomrule
\end{xltabular}
\normalsize
...
\begin{itemize}
  ...
  \item \textbf{Classe 3} (processamento fractal/\allowbreak{}invariante à escala): análise de textura, reconhecimento de objetos invariante à escala, codificação neural eficiente. Principalmente o processamento visual em V2--V4, onde a comparação multiescala é a operação central. Sob psicodélicos, quando essa maquinaria roda sem entrada externa, você \textit{vê} o próprio processamento fractal, e é por isso que os padrões fractais estão entre os traços mais consistentes da experiência psicodélica (veja o Capítulo 6).
