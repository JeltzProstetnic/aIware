...
```mermaid
graph LR
    subgraph Priorities["Four Educational Priorities"]
        P1["<b>1. Teach Operational<br/>Knowledge Explicitly</b><br/><i>Strategies, metacognition,<br/>reasoning heuristics</i>"]
        P2["<b>2. Protect Motivation</b><br/><i>Autonomy, competence,<br/>relatedness</i>"]
        P3["<b>3. Growth Feedback</b><br/><i>Specific, actionable,<br/>progress-oriented</i>"]
        P4["<b>4. Average P<br/>Is Sufficient</b><br/><i>Stop treating processing<br/>capacity as the bottleneck</i>"]
    end

    P1 -->|"amplifies K"| LOOP["<b>Recursive Loop</b><br/>Sustained and<br/>compounding"]
    P2 -->|"sustains M"| LOOP
    P3 -->|"feeds loop<br/>not breaks it"| LOOP
    P4 -->|"reframes<br/>the constraint"| LOOP

    style Priorities fill:#264653,color:#fff,stroke:#1d3557
    style P1 fill:#2d6a4f,color:#fff,stroke:#1b4332
    style P2 fill:#9b2226,color:#fff,stroke:#6a040f
    style P3 fill:#e9c46a,color:#000,stroke:#f4a261
    style P4 fill:#264653,color:#fff,stroke:#1d3557
    style LOOP fill:#2d6a4f,color:#fff,stroke:#1b4332
```
