...
graph TD
    ...
    G -->|"communicates<br/>'not good enough'"| M
    M -->|"reduces effort<br/>and engagement"| L
    L -->|"fewer learning<br/>episodes"| K
    K -->|"less capable<br/>on next test"| P
    P -->|"produces another<br/>poor grade"| G

    style G fill:#9b2226,color:#fff,stroke:#6a040f
    style M fill:#9b2226,color:#fff,stroke:#6a040f
    style L fill:#9b2226,color:#fff,stroke:#6a040f
    style K fill:#9b2226,color:#fff,stroke:#6a040f
    style P fill:#9b2226,color:#fff,stroke:#6a040f

    V["<b>VICIOUS CYCLE</b><br/>Self-fulfilling prophecy:<br/>the measurement produces<br/>the outcome it measures"]
    style V fill:#000,color:#ff6b6b,stroke:#9b2226
```
