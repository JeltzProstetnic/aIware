...
title: Anosognosia
section: Basics
description: "Anosognosia is the inability to recognize one's own neurological deficit, revealing how the brain constructs self-awareness."
keywords: [anosognosia, self-awareness, neurological deficit, Babinski, stroke, self-model, confabulation]
---
...
```mermaid
graph TD
    A["Neurological Deficit<br/>(e.g., left hemiplegia)"] --> B["Substrate Registers Deficit<br/>Motor commands fail<br/>No proprioceptive feedback"]
    B --> C{"Self-Monitoring<br/>System"}
    C -->|"Intact pathway"| D["Conscious Awareness<br/>'My arm is paralyzed'"]
    C -->|"Damaged pathway<br/>(anosognosia)"| E["No Deficit Awareness"]
    E --> F["Confabulation<br/>'I just don't feel<br/>like moving it'"]

    style A fill:#8b0000,color:#fff
    style B fill:#4a6785,color:#fff
