---
title: Fluid and Crystallized Intelligence
section: Basics
description: "Fluid intelligence handles novel problems through raw reasoning; crystallized intelligence applies accumulated knowledge and skill."
keywords: [fluid intelligence, crystallized intelligence, Cattell, Horn, Gf, Gc, cognitive aging, intelligence theory]
---
...
```mermaid
graph LR
    subgraph Gf["Fluid Intelligence (Gf)"]
        GF1["Abstract reasoning"]
        GF2["Pattern recognition"]
        GF3["Novel problem-solving"]
    end

    subgraph Gc["Crystallized Intelligence (Gc)"]
        GC1["Vocabulary & knowledge"]
        GC2["Learned procedures"]
        GC3["Domain expertise"]
    end

    AGE["Age →"]
    AGE -.->|"peaks ~25,<br/>then declines"| Gf
    AGE -.->|"grows through<br/>60s-70s"| Gc

    style Gf fill:#1a1a2e,stroke:#e74c3c,color:#fff
    style Gc fill:#1a1a2e,stroke:#2d6a4f,color:#fff
    style AGE fill:#1a1a2e,stroke:#e6b800,color:#fff
```
