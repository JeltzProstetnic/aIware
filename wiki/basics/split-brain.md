---
title: Split-Brain and Callosotomy
section: Basics
description: "Split-brain surgery severs the connection between brain hemispheres, revealing how consciousness handles being cut in half."
keywords: [split-brain, callosotomy, corpus callosum, Sperry, Gazzaniga, hemispheric specialization, confabulation]
---
...
```mermaid
graph TD
    subgraph Intact["Intact Brain"]
        LH1["Left Hemisphere<br/>(language, analysis)"]
        CC["Corpus Callosum<br/>~200 million fibers"]
        RH1["Right Hemisphere<br/>(spatial, holistic)"]
        LH1 <-->|"full integration"| CC
        CC <-->|"full integration"| RH1
    end

    subgraph Split["After Callosotomy"]
        LH2["Left Hemisphere<br/>Can speak, cannot<br/>report right-field input"]
        GAP["  ✂ Severed ✂  "]
        RH2["Right Hemisphere<br/>Perceives left field,<br/>cannot speak"]
        LH2 x--x GAP
        GAP x--x RH2
    end

    Intact -->|"surgery"| Split
