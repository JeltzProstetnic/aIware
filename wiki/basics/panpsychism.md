...
title: Panpsychism
section: Basics
description: "Panpsychism explained: the view that consciousness is a fundamental feature of matter, and why the Combination Problem is its Achilles heel."
keywords: [panpsychism, combination problem, consciousness, Chalmers, IIT, proto-consciousness, philosophy of mind]
---
...
```mermaid
graph BT
    subgraph MICRO["Micro-Experiences"]
        direction LR
        M1["⚛️ Particle A<br/>micro-experience"]
        M2["⚛️ Particle B<br/>micro-experience"]
        M3["⚛️ Particle C<br/>micro-experience"]
        M4["⚛️ ...billions"]
    end

    CP["❓ Combination Problem ❓"]

    subgraph MACRO["Macro-Experience"]
        U["Unified conscious<br/>experience of seeing red"]
    end
    ...
    style MICRO fill:#1a1a2e,stroke:#333,color:#aaa
    style M1 fill:#2c3e50,stroke:#34495e,color:#bbb
    style M2 fill:#2c3e50,stroke:#34495e,color:#bbb
    style M3 fill:#2c3e50,stroke:#34495e,color:#bbb
    style M4 fill:#2c3e50,stroke:#34495e,color:#bbb
    style CP fill:#c0392b,stroke:#e74c3c,color:#fff
    style MACRO fill:#2d1b69,stroke:#9b59b6,color:#fff
    style U fill:#8e44ad,stroke:#9b59b6,color:#fff
```
