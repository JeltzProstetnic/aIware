...
title: Physicalism
section: Basics
description: "Physicalism explained: the view that everything is physical, its varieties, and why it matters for consciousness science."
keywords: [physicalism, materialism, dualism, reductive physicalism, non-reductive physicalism, consciousness, philosophy of mind]
---
...
```mermaid
graph TB
    subgraph DUALISM["Dualism"]
        direction LR
        D_MIND["Mind<br/>(non-physical)"]
        D_BODY["Body<br/>(physical)"]
        D_MIND <-->|"interaction?"| D_BODY
    end

    subgraph PHYS["Physicalism"]
        direction TB
        P_PHYS["Physical substrate"]
        P_MIND["Mental states"]
        P_PHYS -->|"identical to<br/>(reductive)"| P_MIND
        P_PHYS -->|"determines<br/>(non-reductive)"| P_MIND
    end

    style DUALISM fill:#1a1a2e,stroke:#c0392b,color:#aaa
    style D_MIND fill:#5b2c6f,stroke:#7d3c98,color:#fff
    style D_BODY fill:#2c3e50,stroke:#34495e,color:#bbb

    style PHYS fill:#1a1a2e,stroke:#27ae60,color:#aaa
    style P_PHYS fill:#2c3e50,stroke:#34495e,color:#bbb
    style P_MIND fill:#1e8449,stroke:#27ae60,color:#fff
```
