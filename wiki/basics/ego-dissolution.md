...
section: Basics
description: "Ego dissolution is the loss of self-boundaries during psychedelics or meditation, where the sense of being a separate self temporarily disappears."
keywords: [ego dissolution, psychedelics, self-boundaries, psilocybin, meditation, Lebedev, Nour, default mode network]
---
...
```mermaid
graph LR
    subgraph Normal["Normal Self-Experience"]
        SELF["Sense of Self<br/>(bounded, stable)"]
        WORLD["Perception of World"]
        SELF ---|"clear boundary"| WORLD
    end

    subgraph Dissolution["Ego Dissolution"]
        MERGED["Self + World<br/>(boundaries dissolved)"]
    end

    Normal -->|"psychedelics,<br/>meditation,<br/>sensory deprivation"| Dissolution

    style SELF fill:#c9a227,color:#000
    style WORLD fill:#4a6785,color:#fff
    style MERGED fill:#7d6608,color:#ecf0f1
```
