...
article_number: 18
description: "How the Four-Model Theory closes the Explanatory Gap by revealing it as a level distinction, not a gap in knowledge."
keywords: [explanatory gap, Levine, hard problem, level confusion, virtual qualia, two-level ontology, category error]
---
...
graph TB
    ...
    subgraph "The Dissolution"
        C["Substrate Level<br/>IWM + ISM<br/>Synaptic weights, firing patterns<br/><em>No phenomenal properties</em>"] -->|"generates & sustains"| D["Computational Level<br/>EWM + ESM<br/>Running simulation<br/><em>Qualia are constitutive here</em>"]
    end
