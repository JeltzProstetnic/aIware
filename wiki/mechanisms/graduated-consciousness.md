...
```mermaid
graph BT
    Basic["<b>Basic Consciousness</b><br/>Minimal self-simulation<br/>EWM + rudimentary ESM<br/><i>Experience exists, thin self-awareness</i>"]
    Simply["<b>Simply Extended</b><br/>First-order self-observation<br/>ESM models own states<br/><i>Aware that it experiences</i>"]
    Doubly["<b>Doubly Extended</b><br/>Second-order self-observation<br/>ESM models itself modeling<br/><i>Metacognition, self-regulation</i>"]
    Triply["<b>Triply Extended</b><br/>Third-order self-observation<br/>ESM models itself³<br/><i>Philosophical reflection,<br/>the Meta-Problem arises</i>"]

    Basic --> Simply
    Simply --> Doubly
    Doubly --> Triply

    style Basic fill:#4a6785,color:#fff
    style Simply fill:#5a7a95,color:#fff
    style Doubly fill:#8b7518,color:#fff
    style Triply fill:#c9a227,color:#000
```
