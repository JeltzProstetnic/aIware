...
```mermaid
graph TD
    K["<b>Knowledge</b><br/>Factual + Operational"]
    P["<b>Performance</b><br/>Processing Capacity"]
    M["<b>Motivation</b><br/>Wissensdrang + Handlungsdrang"]
    S["<b>Success</b><br/>Achievement, Mastery"]

    K -->|"strategies improve<br/>processing efficiency"| P
    P -->|"greater capacity enables<br/>deeper learning"| K
    M -->|"sustained engagement<br/>drives learning"| K
    M -->|"practice<br/>trains capacity"| P
    K --> S
    P --> S
    S -->|"self-efficacy<br/>positive affect"| M
    ...
    style S fill:#e9c46a,color:#000,stroke:#f4a261
```
