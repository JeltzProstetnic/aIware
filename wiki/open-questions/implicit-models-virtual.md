...
The [real/virtual split](../core-architecture/real-virtual-split.md) is the theory's foundational ontological division: implicit models (IWM, ISM) on the real side, explicit models (EWM, ESM) on the virtual side. The real side is physical, structural, learned, and non-conscious. The virtual side is generated, transient, and phenomenal. The [Hard Problem dissolution](../hard-problem/dissolution.md) rests on this split: qualia exist at the virtual level, and seeking them at the substrate level is a [category error](../hard-problem/category-error.md).
...
- [The Category Error (Level Confusion)](../hard-problem/category-error.md)
