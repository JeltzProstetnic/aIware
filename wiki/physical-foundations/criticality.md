...
article_number: 21
description: "Consciousness requires the substrate to operate at or near the edge of chaos — Wolfram's Class 4 computational regime."
keywords: [criticality, edge of chaos, Class 4, Wolfram, universal computation, neuronal avalanches, phase transition, FMT]
---
...
graph LR
    ...
    C1 -->|"increasing complexity →"| C2
    C2 -->|"increasing complexity →"| C4
    C4 -->|"increasing complexity →"| C3

    style C4 fill:#4CAF50,stroke:#333,stroke-width:3px,color:#fff
    style C1 fill:#9E9E9E,stroke:#333,color:#fff
    style C2 fill:#9E9E9E,stroke:#333,color:#fff
    style C3 fill:#9E9E9E,stroke:#333,color:#fff
```
