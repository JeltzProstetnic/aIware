...
graph TD
    ...
    L3["<b>3. Qualitative</b><br/><i>Not yet quantitative</i>"]
    ...
    style L2 fill:#9b2226,color:#fff,stroke:#6a040f
    style L3 fill:#9b2226,color:#fff,stroke:#6a040f
    style L4 fill:#9b2226,color:#fff,stroke:#6a040f
    style L5 fill:#9b2226,color:#fff,stroke:#6a040f
