---
title: Reading Order Guide
section: Reference
article_number: 100
description: "Recommended paths through the wiki for four audiences: philosopher, neuroscientist, AI researcher, and educator."
keywords: [reading order, guide, philosopher, neuroscientist, AI researcher, educator, recommended path]
---
...
graph LR
    ...
    subgraph "Neuroscientist Path"
        direction LR
        N1["Criticality &<br/>Physical"] --> N2["Architecture &<br/>Mechanisms"] --> N3["Evidence &<br/>Predictions"]
    end

    subgraph "AI Researcher Path"
        direction LR
        A1["AI Diagnostic &<br/>LLM Analysis"] --> A2["Architecture &<br/>Engineering Spec"] --> A3["Substrate &<br/>Welfare"]
    end

    subgraph "Educator Path"
        direction LR
        E1["Intelligence<br/>Is Learnable"] --> E2["Recursive Loop &<br/>Components"] --> E3["Education<br/>Implications"]
    end

    P3 --> ALL["Complete<br/>Reading"]
    N3 --> ALL
    A3 --> ALL
    E3 --> ALL
    ...
    style N1 fill:#2ecc71,stroke:#333,color:#000
    style N2 fill:#2ecc71,stroke:#333,color:#000
    style N3 fill:#2ecc71,stroke:#333,color:#000
    ...
    style E3 fill:#e67e22,stroke:#333,color:#fff
    style ALL fill:#e74c3c,stroke:#333,color:#fff
```
