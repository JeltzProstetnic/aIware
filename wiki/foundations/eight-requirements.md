...
```mermaid
graph LR
    subgraph Ontological["Ontological"]
        R1["1. Hard Problem"]
        R2["2. Explanatory Gap"]
    end

    subgraph Structural["Structural"]
        R3["3. Boundary Problem"]
        R4["4. Structure of Experience"]
        R5["5. Unity & Binding"]
    end

    subgraph Metaphysical["Metaphysical"]
        R6["6. Combination & Emergence"]
        R7["7. Causal Role"]
    end
    ...
    style Ontological fill:#2d1b69,stroke:#8b5cf6,color:#fff
    style Structural fill:#1e3a5f,stroke:#60a5fa,color:#fff
    style Metaphysical fill:#3b1f2b,stroke:#f472b6,color:#fff
    style Epistemic fill:#1a3c34,stroke:#34d399,color:#fff
```
