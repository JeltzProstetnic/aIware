...
**The Standard Model of Consciousness originates in *Die Emergenz des Bewusstseins* ([Gruber, 2015](https://www.amazon.com/Emergenz-Bewusstseins-German-Matthias-Gruber/dp/1326652079)), a German-language monograph that laid out the core architecture, and has been refined through a structured adversarial challenge process in 2026.**
...
```mermaid
timeline
    title Intellectual Lineage and Development
    section Self-Modeling Tradition
        1991 : Dennett — Multiple Drafts Model
        1999 : Damasio — Proto-self, core self framework
        2003 : Metzinger — Self-Model Theory, phenomenal transparency
        2007 : Hofstadter — Strange loops, self-referential identity
    section Computational Foundations
        2002 : Wolfram — Class 4 dynamics, computational universality
        2003 : Beggs & Plenz — Neuronal avalanches, criticality
